...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UFoliageType_Actor_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UFoliageType_Actor_Statics::PropPointers),
		0,
		0x000810A0u,
		METADATA_PARAMS(Z_Construct_UClass_UFoliageType_Actor_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UFoliageType_Actor_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UFoliageType_Actor, 359048953);
