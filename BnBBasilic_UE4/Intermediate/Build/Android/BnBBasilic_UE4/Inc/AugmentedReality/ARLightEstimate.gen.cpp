...
// End Cross Module References
	...
	IMPLEMENT_CLASS(UARLightEstimate, 2253702206);
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UARBasicLightEstimate_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UARBasicLightEstimate_GetAmbientColor, "GetAmbientColor" }, // 2649559712
		{ &Z_Construct_UFunction_UARBasicLightEstimate_GetAmbientColorTemperatureKelvin, "GetAmbientColorTemperatureKelvin" }, // 942500113
		{ &Z_Construct_UFunction_UARBasicLightEstimate_GetAmbientIntensityLumens, "GetAmbientIntensityLumens" }, // 481047924
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UARBasicLightEstimate, 677822003);
