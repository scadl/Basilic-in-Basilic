...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ULocationServicesImpl_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_ULocationServicesImpl_Statics::PropPointers),
		0,
		0x008000A1u,
		METADATA_PARAMS(Z_Construct_UClass_ULocationServicesImpl_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_ULocationServicesImpl_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(ULocationServicesImpl, 2090567845);
