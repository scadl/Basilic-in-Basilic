...
// Cross Module References
	...
	UMG_API UFunction* Z_Construct_UFunction_URichTextBlock_ClearAllDefaultStyleOverrides();
	...
	UMG_API UFunction* Z_Construct_UFunction_URichTextBlock_GetText();
	UMG_API UFunction* Z_Construct_UFunction_URichTextBlock_SetAutoWrapText();
	UMG_API UFunction* Z_Construct_UFunction_URichTextBlock_SetDefaultColorAndOpacity();
	SLATECORE_API UScriptStruct* Z_Construct_UScriptStruct_FSlateColor();
	UMG_API UFunction* Z_Construct_UFunction_URichTextBlock_SetDefaultFont();
	SLATECORE_API UScriptStruct* Z_Construct_UScriptStruct_FSlateFontInfo();
	UMG_API UFunction* Z_Construct_UFunction_URichTextBlock_SetDefaultShadowColorAndOpacity();
	COREUOBJECT_API UScriptStruct* Z_Construct_UScriptStruct_FLinearColor();
	UMG_API UFunction* Z_Construct_UFunction_URichTextBlock_SetDefaultShadowOffset();
	COREUOBJECT_API UScriptStruct* Z_Construct_UScriptStruct_FVector2D();
	UMG_API UFunction* Z_Construct_UFunction_URichTextBlock_SetDefaultStrikeBrush();
	SLATECORE_API UScriptStruct* Z_Construct_UScriptStruct_FSlateBrush();
	UMG_API UFunction* Z_Construct_UFunction_URichTextBlock_SetDefaultTextStyle();
	UMG_API UFunction* Z_Construct_UFunction_URichTextBlock_SetJustification();
	SLATE_API UEnum* Z_Construct_UEnum_Slate_ETextJustify();
	UMG_API UFunction* Z_Construct_UFunction_URichTextBlock_SetMinDesiredWidth();
	UMG_API UFunction* Z_Construct_UFunction_URichTextBlock_SetText();
	UMG_API UFunction* Z_Construct_UFunction_URichTextBlock_SetTextStyleSet();
...
static struct FScriptStruct_UMG_StaticRegisterNativesFRichTextStyleRow
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FRichTextStyleRow_Hash() { return 2411271119U; }
	void URichTextBlock::StaticRegisterNativesURichTextBlock()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "SetJustification", &URichTextBlock::execSetJustification },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_URichTextBlock_GetDecoratorByClass_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URichTextBlock, nullptr, "GetDecoratorByClass", nullptr, nullptr, sizeof(RichTextBlock_eventGetDecoratorByClass_Parms), Z_Construct_UFunction_URichTextBlock_GetDecoratorByClass_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_URichTextBlock_GetDecoratorByClass_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_URichTextBlock_GetDecoratorByClass_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_URichTextBlock_GetDecoratorByClass_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_URichTextBlock_SetAutoWrapText_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URichTextBlock, nullptr, "SetAutoWrapText", nullptr, nullptr, sizeof(RichTextBlock_eventSetAutoWrapText_Parms), Z_Construct_UFunction_URichTextBlock_SetAutoWrapText_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_URichTextBlock_SetAutoWrapText_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_URichTextBlock_SetAutoWrapText_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_URichTextBlock_SetAutoWrapText_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_URichTextBlock_SetDefaultStrikeBrush_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URichTextBlock, nullptr, "SetDefaultStrikeBrush", nullptr, nullptr, sizeof(RichTextBlock_eventSetDefaultStrikeBrush_Parms), Z_Construct_UFunction_URichTextBlock_SetDefaultStrikeBrush_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_URichTextBlock_SetDefaultStrikeBrush_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_URichTextBlock_SetDefaultStrikeBrush_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_URichTextBlock_SetDefaultStrikeBrush_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URichTextBlock_SetDefaultTextStyle_Statics::NewProp_InDefaultTextStyle = { "InDefaultTextStyle", nullptr, (EPropertyFlags)0x0010000008000182, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RichTextBlock_eventSetDefaultTextStyle_Parms, InDefaultTextStyle), Z_Construct_UScriptStruct_FTextBlockStyle, METADATA_PARAMS(Z_Construct_UFunction_URichTextBlock_SetDefaultTextStyle_Statics::NewProp_InDefaultTextStyle_MetaData, ARRAY_COUNT(Z_Construct_UFunction_URichTextBlock_SetDefaultTextStyle_Statics::NewProp_InDefaultTextStyle_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_URichTextBlock_SetDefaultTextStyle_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URichTextBlock, nullptr, "SetDefaultTextStyle", nullptr, nullptr, sizeof(RichTextBlock_eventSetDefaultTextStyle_Parms), Z_Construct_UFunction_URichTextBlock_SetDefaultTextStyle_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_URichTextBlock_SetDefaultTextStyle_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_URichTextBlock_SetDefaultTextStyle_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_URichTextBlock_SetDefaultTextStyle_Statics::Function_MetaDataParams)) };
	...
	struct Z_Construct_UFunction_URichTextBlock_SetJustification_Statics
	{
		struct RichTextBlock_eventSetJustification_Parms
		{
	...
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UFunction_URichTextBlock_SetJustification_Statics::NewProp_InJustification = { "InJustification", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RichTextBlock_eventSetJustification_Parms, InJustification), Z_Construct_UEnum_Slate_ETextJustify, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_URichTextBlock_SetJustification_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_URichTextBlock_SetJustification_Statics::NewProp_InJustification,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_URichTextBlock_SetJustification_Statics::Function_MetaDataParams[] = {
		{ "Category", "Appearance" },
		{ "Comment", "/**\n\x09 *  Set the text justification for this rich text block\n\x09 *  @param InJustification new justification\n\x09 */" },
		{ "ModuleRelativePath", "Public/Components/RichTextBlock.h" },
		{ "ToolTip", "Set the text justification for this rich text block\n@param InJustification new justification" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_URichTextBlock_SetJustification_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URichTextBlock, nullptr, "SetJustification", nullptr, nullptr, sizeof(RichTextBlock_eventSetJustification_Parms), Z_Construct_UFunction_URichTextBlock_SetJustification_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_URichTextBlock_SetJustification_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_URichTextBlock_SetJustification_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_URichTextBlock_SetJustification_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_URichTextBlock_SetJustification()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_URichTextBlock_SetJustification_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_URichTextBlock_SetMinDesiredWidth_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URichTextBlock, nullptr, "SetMinDesiredWidth", nullptr, nullptr, sizeof(RichTextBlock_eventSetMinDesiredWidth_Parms), Z_Construct_UFunction_URichTextBlock_SetMinDesiredWidth_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_URichTextBlock_SetMinDesiredWidth_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_URichTextBlock_SetMinDesiredWidth_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_URichTextBlock_SetMinDesiredWidth_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_URichTextBlock_SetText_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URichTextBlock, nullptr, "SetText", nullptr, nullptr, sizeof(RichTextBlock_eventSetText_Parms), Z_Construct_UFunction_URichTextBlock_SetText_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_URichTextBlock_SetText_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420400, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_URichTextBlock_SetText_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_URichTextBlock_SetText_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_URichTextBlock_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_URichTextBlock_ClearAllDefaultStyleOverrides, "ClearAllDefaultStyleOverrides" }, // 2873653373
		{ &Z_Construct_UFunction_URichTextBlock_GetDecoratorByClass, "GetDecoratorByClass" }, // 1938836097
		{ &Z_Construct_UFunction_URichTextBlock_GetText, "GetText" }, // 4185271235
		{ &Z_Construct_UFunction_URichTextBlock_SetAutoWrapText, "SetAutoWrapText" }, // 4023486533
		{ &Z_Construct_UFunction_URichTextBlock_SetDefaultColorAndOpacity, "SetDefaultColorAndOpacity" }, // 1620383166
		{ &Z_Construct_UFunction_URichTextBlock_SetDefaultFont, "SetDefaultFont" }, // 1146594398
		{ &Z_Construct_UFunction_URichTextBlock_SetDefaultShadowColorAndOpacity, "SetDefaultShadowColorAndOpacity" }, // 3821250872
		{ &Z_Construct_UFunction_URichTextBlock_SetDefaultShadowOffset, "SetDefaultShadowOffset" }, // 3993760991
		{ &Z_Construct_UFunction_URichTextBlock_SetDefaultStrikeBrush, "SetDefaultStrikeBrush" }, // 1995836441
		{ &Z_Construct_UFunction_URichTextBlock_SetDefaultTextStyle, "SetDefaultTextStyle" }, // 2875291425
		{ &Z_Construct_UFunction_URichTextBlock_SetJustification, "SetJustification" }, // 4073560159
		{ &Z_Construct_UFunction_URichTextBlock_SetMinDesiredWidth, "SetMinDesiredWidth" }, // 436026469
		{ &Z_Construct_UFunction_URichTextBlock_SetText, "SetText" }, // 1041048725
		{ &Z_Construct_UFunction_URichTextBlock_SetTextStyleSet, "SetTextStyleSet" }, // 1739685400
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_URichTextBlock_Statics::NewProp_MinDesiredWidth = { "MinDesiredWidth", nullptr, (EPropertyFlags)0x0020080000000015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(URichTextBlock, MinDesiredWidth), METADATA_PARAMS(Z_Construct_UClass_URichTextBlock_Statics::NewProp_MinDesiredWidth_MetaData, ARRAY_COUNT(Z_Construct_UClass_URichTextBlock_Statics::NewProp_MinDesiredWidth_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(URichTextBlock, 1730433580);
