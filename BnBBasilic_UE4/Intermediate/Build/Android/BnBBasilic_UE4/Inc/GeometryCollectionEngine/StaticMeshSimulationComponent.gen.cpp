...
// Cross Module References
	...
	GEOMETRYCOLLECTIONENGINE_API UFunction* Z_Construct_UFunction_UStaticMeshSimulationComponent_ForceRecreatePhysicsState();
	GEOMETRYCOLLECTIONENGINE_API UFunction* Z_Construct_UFunction_UStaticMeshSimulationComponent_ReceivePhysicsCollision();
...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UStaticMeshSimulationComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UStaticMeshSimulationComponent_ForceRecreatePhysicsState, "ForceRecreatePhysicsState" }, // 3682874819
		{ &Z_Construct_UFunction_UStaticMeshSimulationComponent_ReceivePhysicsCollision, "ReceivePhysicsCollision" }, // 534966531
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UStaticMeshSimulationComponent_Statics::NewProp_SimulatedComponents_MetaData[] = {
		{ "Comment", "/** List of component for which this simulation component created a physics object. Parallel array to PhysicsObjects, so PhysicsObjects[i] corresponds to SimulatedComponents[i] */" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/GeometryCollection/StaticMeshSimulationComponent.h" },
		{ "ToolTip", "List of component for which this simulation component created a physics object. Parallel array to PhysicsObjects, so PhysicsObjects[i] corresponds to SimulatedComponents[i]" },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UStaticMeshSimulationComponent_Statics::NewProp_SimulatedComponents = { "SimulatedComponents", nullptr, (EPropertyFlags)0x0040008000000008, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UStaticMeshSimulationComponent, SimulatedComponents), METADATA_PARAMS(Z_Construct_UClass_UStaticMeshSimulationComponent_Statics::NewProp_SimulatedComponents_MetaData, ARRAY_COUNT(Z_Construct_UClass_UStaticMeshSimulationComponent_Statics::NewProp_SimulatedComponents_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UStaticMeshSimulationComponent_Statics::NewProp_MaxLevelSetResolution = { "MaxLevelSetResolution", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UStaticMeshSimulationComponent, MaxLevelSetResolution), METADATA_PARAMS(Z_Construct_UClass_UStaticMeshSimulationComponent_Statics::NewProp_MaxLevelSetResolution_MetaData, ARRAY_COUNT(Z_Construct_UClass_UStaticMeshSimulationComponent_Statics::NewProp_MaxLevelSetResolution_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UStaticMeshSimulationComponent_Statics::NewProp_MinLevelSetResolution = { "MinLevelSetResolution", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UStaticMeshSimulationComponent, MinLevelSetResolution), METADATA_PARAMS(Z_Construct_UClass_UStaticMeshSimulationComponent_Statics::NewProp_MinLevelSetResolution_MetaData, ARRAY_COUNT(Z_Construct_UClass_UStaticMeshSimulationComponent_Statics::NewProp_MinLevelSetResolution_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UStaticMeshSimulationComponent, 576152734);
