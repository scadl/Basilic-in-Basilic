...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_GeometryCollectionEngine_EChaosBreakingSortMethod_Hash() { return 2841683315U; }
...
static struct FScriptStruct_GeometryCollectionEngine_StaticRegisterNativesFChaosBreakingEventRequestSettings
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FChaosBreakingEventRequestSettings_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosBreakingEventRequestSettings_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosBreakingEventRequestSettings_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosBreakingEventRequestSettings_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FChaosBreakingEventRequestSettings_Hash() { return 2564078988U; }
...
static struct FScriptStruct_GeometryCollectionEngine_StaticRegisterNativesFChaosBreakingEventData
{
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FChaosBreakingEventData_Statics::NewProp_ParticleIndex_MetaData[] = {
		{ "Category", "Data" },
		{ "Comment", "// The particle index of the breaking event\n" },
		{ "ModuleRelativePath", "Public/ChaosBreakingEventFilter.h" },
		{ "ToolTip", "The particle index of the breaking event" },
	};
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FChaosBreakingEventData_Statics::NewProp_ParticleIndex = { "ParticleIndex", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FChaosBreakingEventData, ParticleIndex), METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosBreakingEventData_Statics::NewProp_ParticleIndex_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosBreakingEventData_Statics::NewProp_ParticleIndex_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FChaosBreakingEventData_Statics::NewProp_Mass = { "Mass", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FChaosBreakingEventData, Mass), METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosBreakingEventData_Statics::NewProp_Mass_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosBreakingEventData_Statics::NewProp_Mass_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FChaosBreakingEventData_Statics::NewProp_Velocity = { "Velocity", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FChaosBreakingEventData, Velocity), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosBreakingEventData_Statics::NewProp_Velocity_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosBreakingEventData_Statics::NewProp_Velocity_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FChaosBreakingEventData_Statics::NewProp_Location = { "Location", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FChaosBreakingEventData, Location), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosBreakingEventData_Statics::NewProp_Location_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosBreakingEventData_Statics::NewProp_Location_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FChaosBreakingEventData_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FChaosBreakingEventData_Statics::NewProp_ParticleIndex,
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FChaosBreakingEventData_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosBreakingEventData_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosBreakingEventData_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosBreakingEventData_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FChaosBreakingEventData_Hash() { return 1483766831U; }
