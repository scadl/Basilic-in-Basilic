...
// Cross Module References
	...
	GEOMETRYCACHE_API UFunction* Z_Construct_UFunction_UDEPRECATED_GeometryCacheTrack_FlipbookAnimation_AddMeshSample();
...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UDEPRECATED_GeometryCacheTrack_FlipbookAnimation_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UDEPRECATED_GeometryCacheTrack_FlipbookAnimation_AddMeshSample, "AddMeshSample" }, // 170467053
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UDEPRECATED_GeometryCacheTrack_FlipbookAnimation_Statics::ClassParams = {
		...
		ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_GeometryCacheTrack_FlipbookAnimation_Statics::PropPointers),
		0,
		0x021022A0u,
		METADATA_PARAMS(Z_Construct_UClass_UDEPRECATED_GeometryCacheTrack_FlipbookAnimation_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_GeometryCacheTrack_FlipbookAnimation_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UDEPRECATED_GeometryCacheTrack_FlipbookAnimation, 1493782981);
