...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AGeometryCacheActor_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AGeometryCacheActor_GetGeometryCacheComponent, "GetGeometryCacheComponent" }, // 2701604979
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AGeometryCacheActor_Statics::ClassParams = {
		...
		ARRAY_COUNT(Z_Construct_UClass_AGeometryCacheActor_Statics::PropPointers),
		0,
		0x009000A0u,
		METADATA_PARAMS(Z_Construct_UClass_AGeometryCacheActor_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_AGeometryCacheActor_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(AGeometryCacheActor, 1626352818);
