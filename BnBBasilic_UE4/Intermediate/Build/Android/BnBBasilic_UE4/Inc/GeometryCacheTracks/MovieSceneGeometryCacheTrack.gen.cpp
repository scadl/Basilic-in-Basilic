...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMovieSceneGeometryCacheTrack_Statics::NewProp_AnimationSections = { "AnimationSections", nullptr, (EPropertyFlags)0x0040008000000008, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneGeometryCacheTrack, AnimationSections), METADATA_PARAMS(Z_Construct_UClass_UMovieSceneGeometryCacheTrack_Statics::NewProp_AnimationSections_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMovieSceneGeometryCacheTrack_Statics::NewProp_AnimationSections_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneGeometryCacheTrack_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UMovieSceneGeometryCacheTrack_Statics::PropPointers),
		0,
		0x00A800A0u,
		METADATA_PARAMS(Z_Construct_UClass_UMovieSceneGeometryCacheTrack_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UMovieSceneGeometryCacheTrack_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UMovieSceneGeometryCacheTrack, 2190669474);
