...
// Cross Module References
	...
	APPLEIMAGEUTILS_API UFunction* Z_Construct_UFunction_UAppleImageUtilsBaseAsyncTaskBlueprintProxy_CreateProxyObjectForConvertToHEIF();
	APPLEIMAGEUTILS_API UEnum* Z_Construct_UEnum_AppleImageUtils_ETextureRotationDirection();
	ENGINE_API UClass* Z_Construct_UClass_UTexture_NoRegister();
	APPLEIMAGEUTILS_API UFunction* Z_Construct_UFunction_UAppleImageUtilsBaseAsyncTaskBlueprintProxy_CreateProxyObjectForConvertToJPEG();
	APPLEIMAGEUTILS_API UFunction* Z_Construct_UFunction_UAppleImageUtilsBaseAsyncTaskBlueprintProxy_CreateProxyObjectForConvertToPNG();
	APPLEIMAGEUTILS_API UFunction* Z_Construct_UFunction_UAppleImageUtilsBaseAsyncTaskBlueprintProxy_CreateProxyObjectForConvertToTIFF();
...
static struct FScriptStruct_AppleImageUtils_StaticRegisterNativesFAppleImageUtilsImageConversionResult
{
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FAppleImageUtilsImageConversionResult_Statics::NewProp_Error = { "Error", nullptr, (EPropertyFlags)0x0010000000000014, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAppleImageUtilsImageConversionResult, Error), METADATA_PARAMS(Z_Construct_UScriptStruct_FAppleImageUtilsImageConversionResult_Statics::NewProp_Error_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FAppleImageUtilsImageConversionResult_Statics::NewProp_Error_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FAppleImageUtilsImageConversionResult_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FAppleImageUtilsImageConversionResult_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FAppleImageUtilsImageConversionResult_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FAppleImageUtilsImageConversionResult_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FAppleImageUtilsImageConversionResult_Hash() { return 3307734755U; }
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UAppleImageUtilsBaseAsyncTaskBlueprintProxy_CreateProxyObjectForConvertToTIFF_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAppleImageUtilsBaseAsyncTaskBlueprintProxy, nullptr, "CreateProxyObjectForConvertToTIFF", nullptr, nullptr, sizeof(AppleImageUtilsBaseAsyncTaskBlueprintProxy_eventCreateProxyObjectForConvertToTIFF_Parms), Z_Construct_UFunction_UAppleImageUtilsBaseAsyncTaskBlueprintProxy_CreateProxyObjectForConvertToTIFF_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UAppleImageUtilsBaseAsyncTaskBlueprintProxy_CreateProxyObjectForConvertToTIFF_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UAppleImageUtilsBaseAsyncTaskBlueprintProxy_CreateProxyObjectForConvertToTIFF_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UAppleImageUtilsBaseAsyncTaskBlueprintProxy_CreateProxyObjectForConvertToTIFF_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAppleImageUtilsBaseAsyncTaskBlueprintProxy_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAppleImageUtilsBaseAsyncTaskBlueprintProxy_CreateProxyObjectForConvertToHEIF, "CreateProxyObjectForConvertToHEIF" }, // 2957286494
		{ &Z_Construct_UFunction_UAppleImageUtilsBaseAsyncTaskBlueprintProxy_CreateProxyObjectForConvertToJPEG, "CreateProxyObjectForConvertToJPEG" }, // 2110244744
		{ &Z_Construct_UFunction_UAppleImageUtilsBaseAsyncTaskBlueprintProxy_CreateProxyObjectForConvertToPNG, "CreateProxyObjectForConvertToPNG" }, // 2703624571
		{ &Z_Construct_UFunction_UAppleImageUtilsBaseAsyncTaskBlueprintProxy_CreateProxyObjectForConvertToTIFF, "CreateProxyObjectForConvertToTIFF" }, // 1083585934
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAppleImageUtilsBaseAsyncTaskBlueprintProxy_Statics::ClassParams = {
		...
		ARRAY_COUNT(Z_Construct_UClass_UAppleImageUtilsBaseAsyncTaskBlueprintProxy_Statics::PropPointers),
		0,
		0x008800A0u,
		METADATA_PARAMS(Z_Construct_UClass_UAppleImageUtilsBaseAsyncTaskBlueprintProxy_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UAppleImageUtilsBaseAsyncTaskBlueprintProxy_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UAppleImageUtilsBaseAsyncTaskBlueprintProxy, 79498093);
