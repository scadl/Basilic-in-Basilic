...
#define Engine_Source_Runtime_AnimGraphRuntime_Public_KismetAnimationLibrary_h_20_RPC_WRAPPERS \
 \
	...
	{ \
		...
		P_GET_PROPERTY(UStrProperty,Z_Param_LogPrefix); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
 ...
 \
	...
	{ \
		...
		P_GET_PROPERTY(UNameProperty,Z_Param_SocketOrBoneName); \
		P_GET_PROPERTY(UNameProperty,Z_Param_ReferenceSocketOrBone); \
		P_GET_PROPERTY(UByteProperty,Z_Param_SocketSpace); \
		P_GET_STRUCT(FVector,Z_Param_OffsetInBoneSpace); \
		P_GET_STRUCT_REF(FPositionHistory,Z_Param_Out_History); \
		P_GET_PROPERTY(UIntProperty,Z_Param_NumberOfSamples); \
		P_GET_PROPERTY(UFloatProperty,Z_Param_VelocityMin); \
		P_GET_PROPERTY(UFloatProperty,Z_Param_VelocityMax); \
