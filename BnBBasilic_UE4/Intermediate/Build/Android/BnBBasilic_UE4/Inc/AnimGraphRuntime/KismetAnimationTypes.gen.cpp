...
static struct FScriptStruct_AnimGraphRuntime_StaticRegisterNativesFPositionHistory
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FPositionHistory_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FPositionHistory_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FPositionHistory_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FPositionHistory_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FPositionHistory_Hash() { return 724154711U; }
