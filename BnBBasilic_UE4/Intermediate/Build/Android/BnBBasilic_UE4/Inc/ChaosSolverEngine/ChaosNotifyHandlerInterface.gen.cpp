...
// Cross Module References
	...
	CHAOSSOLVERENGINE_API UFunction* Z_Construct_UFunction_UChaosSolverEngineBlueprintLibrary_ConvertPhysicsCollisionToHitResult();
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_ChaosSolverEngine_OnChaosPhysicsCollision__DelegateSignature_Statics::NewProp_CollisionInfo = { "CollisionInfo", nullptr, (EPropertyFlags)0x0010008008000182, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_ChaosSolverEngine_eventOnChaosPhysicsCollision_Parms, CollisionInfo), Z_Construct_UScriptStruct_FChaosPhysicsCollisionInfo, METADATA_PARAMS(Z_Construct_UDelegateFunction_ChaosSolverEngine_OnChaosPhysicsCollision__DelegateSignature_Statics::NewProp_CollisionInfo_MetaData, ARRAY_COUNT(Z_Construct_UDelegateFunction_ChaosSolverEngine_OnChaosPhysicsCollision__DelegateSignature_Statics::NewProp_CollisionInfo_MetaData)) };
...
static struct FScriptStruct_ChaosSolverEngine_StaticRegisterNativesFChaosPhysicsCollisionInfo
{
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FChaosPhysicsCollisionInfo_Statics::NewProp_OtherMass = { "OtherMass", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FChaosPhysicsCollisionInfo, OtherMass), METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosPhysicsCollisionInfo_Statics::NewProp_OtherMass_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosPhysicsCollisionInfo_Statics::NewProp_OtherMass_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FChaosPhysicsCollisionInfo_Statics::NewProp_Velocity = { "Velocity", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FChaosPhysicsCollisionInfo, Velocity), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosPhysicsCollisionInfo_Statics::NewProp_Velocity_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosPhysicsCollisionInfo_Statics::NewProp_Velocity_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FChaosPhysicsCollisionInfo_Statics::NewProp_Location = { "Location", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FChaosPhysicsCollisionInfo, Location), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosPhysicsCollisionInfo_Statics::NewProp_Location_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosPhysicsCollisionInfo_Statics::NewProp_Location_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FChaosPhysicsCollisionInfo_Statics::NewProp_Component = { "Component", nullptr, (EPropertyFlags)0x001000000008000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FChaosPhysicsCollisionInfo, Component), Z_Construct_UClass_UPrimitiveComponent_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosPhysicsCollisionInfo_Statics::NewProp_Component_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosPhysicsCollisionInfo_Statics::NewProp_Component_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FChaosPhysicsCollisionInfo_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosPhysicsCollisionInfo_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000205),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosPhysicsCollisionInfo_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosPhysicsCollisionInfo_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FChaosPhysicsCollisionInfo_Hash() { return 2771814285U; }
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UChaosNotifyHandlerInterface_Statics::ClassParams = {
		...
		0,
		0x001040A1u,
		METADATA_PARAMS(Z_Construct_UClass_UChaosNotifyHandlerInterface_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UChaosNotifyHandlerInterface_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UChaosNotifyHandlerInterface, 407861908);
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UChaosSolverEngineBlueprintLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UChaosSolverEngineBlueprintLibrary_ConvertPhysicsCollisionToHitResult, "ConvertPhysicsCollisionToHitResult" }, // 828804884
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UChaosSolverEngineBlueprintLibrary_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UChaosSolverEngineBlueprintLibrary_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UChaosSolverEngineBlueprintLibrary_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UChaosSolverEngineBlueprintLibrary, 108985477);
