...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UChaosSolverSettings_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UChaosSolverSettings_Statics::PropPointers),
		0,
		0x001000A6u,
		METADATA_PARAMS(Z_Construct_UClass_UChaosSolverSettings_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UChaosSolverSettings_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UChaosSolverSettings, 1613622164);
