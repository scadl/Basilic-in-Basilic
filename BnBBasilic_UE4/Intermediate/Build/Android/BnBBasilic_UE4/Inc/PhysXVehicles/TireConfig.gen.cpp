...
static struct FScriptStruct_PhysXVehicles_StaticRegisterNativesFTireConfigMaterialFriction
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FTireConfigMaterialFriction_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FTireConfigMaterialFriction_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FTireConfigMaterialFriction_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FTireConfigMaterialFriction_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FTireConfigMaterialFriction_Hash() { return 736275267U; }
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UTireConfig_Statics::NewProp_TireFrictionScales = { "TireFrictionScales", nullptr, (EPropertyFlags)0x0040000000000001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UTireConfig, TireFrictionScales), METADATA_PARAMS(Z_Construct_UClass_UTireConfig_Statics::NewProp_TireFrictionScales_MetaData, ARRAY_COUNT(Z_Construct_UClass_UTireConfig_Statics::NewProp_TireFrictionScales_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UTireConfig_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UTireConfig_Statics::PropPointers),
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UTireConfig_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UTireConfig_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UTireConfig, 994186683);
