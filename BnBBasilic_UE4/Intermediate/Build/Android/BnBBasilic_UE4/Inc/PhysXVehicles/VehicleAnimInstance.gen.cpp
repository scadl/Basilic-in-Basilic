...
// Cross Module References
	...
	PHYSXVEHICLES_API UFunction* Z_Construct_UFunction_UVehicleAnimInstance_GetVehicle();
...
static struct FScriptStruct_PhysXVehicles_StaticRegisterNativesFVehicleAnimInstanceProxy
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FVehicleAnimInstanceProxy_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(Z_Construct_UScriptStruct_FVehicleAnimInstanceProxy_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FVehicleAnimInstanceProxy_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FVehicleAnimInstanceProxy_Hash() { return 900911718U; }
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UVehicleAnimInstance_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UVehicleAnimInstance_GetVehicle, "GetVehicle" }, // 3480590137
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UVehicleAnimInstance_Statics::ClassParams = {
		...
		ARRAY_COUNT(Z_Construct_UClass_UVehicleAnimInstance_Statics::PropPointers),
		0,
		0x009000A8u,
		METADATA_PARAMS(Z_Construct_UClass_UVehicleAnimInstance_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UVehicleAnimInstance_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UVehicleAnimInstance, 1814183892);
