...
// Cross Module References
	...
	ANIMATIONSHARING_API UFunction* Z_Construct_UFunction_UAnimationSharingManager_AnimationSharingEnabled();
	ANIMATIONSHARING_API UFunction* Z_Construct_UFunction_UAnimationSharingManager_CreateAnimationSharingManager();
	ANIMATIONSHARING_API UClass* Z_Construct_UClass_UAnimationSharingSetup_NoRegister();
	COREUOBJECT_API UClass* Z_Construct_UClass_UObject_NoRegister();
	ANIMATIONSHARING_API UFunction* Z_Construct_UFunction_UAnimationSharingManager_GetAnimationSharingManager();
	ANIMATIONSHARING_API UFunction* Z_Construct_UFunction_UAnimationSharingManager_RegisterActorWithSkeletonBP();
...
static struct FScriptStruct_AnimationSharing_StaticRegisterNativesFTickAnimationSharingFunction
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FTickAnimationSharingFunction_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(Z_Construct_UScriptStruct_FTickAnimationSharingFunction_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FTickAnimationSharingFunction_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FTickAnimationSharingFunction_Hash() { return 4005961521U; }
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAnimSharingInstance_Statics::NewProp_RegisteredActors = { "RegisteredActors", nullptr, (EPropertyFlags)0x0010000000022001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimSharingInstance, RegisteredActors), METADATA_PARAMS(Z_Construct_UClass_UAnimSharingInstance_Statics::NewProp_RegisteredActors_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAnimSharingInstance_Statics::NewProp_RegisteredActors_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAnimSharingInstance_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UAnimSharingInstance_Statics::PropPointers),
		0,
		0x000000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UAnimSharingInstance_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UAnimSharingInstance_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UAnimSharingInstance, 436132378);
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UAnimationSharingManager_CreateAnimationSharingManager_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAnimationSharingManager, nullptr, "CreateAnimationSharingManager", nullptr, nullptr, sizeof(AnimationSharingManager_eventCreateAnimationSharingManager_Parms), Z_Construct_UFunction_UAnimationSharingManager_CreateAnimationSharingManager_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UAnimationSharingManager_CreateAnimationSharingManager_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UAnimationSharingManager_CreateAnimationSharingManager_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UAnimationSharingManager_CreateAnimationSharingManager_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAnimationSharingManager_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAnimationSharingManager_AnimationSharingEnabled, "AnimationSharingEnabled" }, // 3855891852
		{ &Z_Construct_UFunction_UAnimationSharingManager_CreateAnimationSharingManager, "CreateAnimationSharingManager" }, // 2303499854
		{ &Z_Construct_UFunction_UAnimationSharingManager_GetAnimationSharingManager, "GetAnimationSharingManager" }, // 607241418
		{ &Z_Construct_UFunction_UAnimationSharingManager_RegisterActorWithSkeletonBP, "RegisterActorWithSkeletonBP" }, // 1064765347
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAnimationSharingManager_Statics::ClassParams = {
		...
		ARRAY_COUNT(Z_Construct_UClass_UAnimationSharingManager_Statics::PropPointers),
		0,
		0x001000A2u,
		METADATA_PARAMS(Z_Construct_UClass_UAnimationSharingManager_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UAnimationSharingManager_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UAnimationSharingManager, 1098167305);
