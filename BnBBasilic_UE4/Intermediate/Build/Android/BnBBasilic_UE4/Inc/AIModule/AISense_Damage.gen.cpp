...
static struct FScriptStruct_AIModule_StaticRegisterNativesFAIDamageEvent
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FAIDamageEvent_Hash() { return 1161126691U; }
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAISense_Damage_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAISense_Damage_ReportDamageEvent, "ReportDamageEvent" }, // 2170064190
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UAISense_Damage, 2058070973);
