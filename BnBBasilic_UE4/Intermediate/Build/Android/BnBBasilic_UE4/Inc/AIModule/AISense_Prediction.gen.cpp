...
static struct FScriptStruct_AIModule_StaticRegisterNativesFAIPredictionEvent
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAISense_Prediction_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAISense_Prediction_RequestControllerPredictionEvent, "RequestControllerPredictionEvent" }, // 4032249614
		{ &Z_Construct_UFunction_UAISense_Prediction_RequestPawnPredictionEvent, "RequestPawnPredictionEvent" }, // 1610211199
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UAISense_Prediction, 4132770926);
