...
// Cross Module References
	...
	LEVELSEQUENCE_API UFunction* Z_Construct_UFunction_ALevelSequenceActor_HideBurnin();
	...
	LEVELSEQUENCE_API UFunction* Z_Construct_UFunction_ALevelSequenceActor_ShowBurnin();
...
static struct FScriptStruct_LevelSequence_StaticRegisterNativesFBoundActorProxy
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FBoundActorProxy_Hash() { return 1346927545U; }
	...
	IMPLEMENT_CLASS(ULevelSequenceBurnInInitSettings, 1131065974);
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ULevelSequenceBurnInOptions_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ULevelSequenceBurnInOptions_SetBurnIn, "SetBurnIn" }, // 1970033164
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ULevelSequenceBurnInOptions, 256125818);
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ALevelSequenceActor_AddBinding_Statics::Function_MetaDataParams[] = {
		...
		{ "Comment", "/** Adds the specified actor to the overridden bindings for the specified binding ID, optionally still allowing the bindings defined in the Level Sequence asset\n\x09 *\n\x09 * @param Binding Binding to modify\n\x09 * @param Actor Actor to bind\n\x09 * @param bAllowBindingsFromAsset Allow bindings from the level sequence asset\n\x09 */" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ALevelSequenceActor_AddBinding_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ALevelSequenceActor, nullptr, "AddBinding", nullptr, nullptr, sizeof(LevelSequenceActor_eventAddBinding_Parms), Z_Construct_UFunction_ALevelSequenceActor_AddBinding_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_ALevelSequenceActor_AddBinding_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ALevelSequenceActor_AddBinding_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_ALevelSequenceActor_AddBinding_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ALevelSequenceActor_GetSequence_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ALevelSequenceActor, nullptr, "GetSequence", nullptr, nullptr, sizeof(LevelSequenceActor_eventGetSequence_Parms), Z_Construct_UFunction_ALevelSequenceActor_GetSequence_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_ALevelSequenceActor_GetSequence_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ALevelSequenceActor_GetSequence_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_ALevelSequenceActor_GetSequence_Statics::Function_MetaDataParams)) };
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ALevelSequenceActor_RemoveBinding_Statics::Function_MetaDataParams[] = {
		{ "Category", "Game|Cinematic|Bindings" },
		{ "Comment", "/** Removes the specified actor from the specified binding's actor array */" },
		{ "ModuleRelativePath", "Public/LevelSequenceActor.h" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ALevelSequenceActor_ResetBinding_Statics::Function_MetaDataParams[] = {
		{ "Category", "Game|Cinematic|Bindings" },
		{ "Comment", "/** Resets the specified binding back to the defaults defined by the Level Sequence asset */" },
		{ "ModuleRelativePath", "Public/LevelSequenceActor.h" },
		{ "ToolTip", "Resets the specified binding back to the defaults defined by the Level Sequence asset" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ALevelSequenceActor_ResetBinding_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ALevelSequenceActor, nullptr, "ResetBinding", nullptr, nullptr, sizeof(LevelSequenceActor_eventResetBinding_Parms), Z_Construct_UFunction_ALevelSequenceActor_ResetBinding_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_ALevelSequenceActor_ResetBinding_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ALevelSequenceActor_ResetBinding_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_ALevelSequenceActor_ResetBinding_Statics::Function_MetaDataParams)) };
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ALevelSequenceActor_ResetBindings_Statics::Function_MetaDataParams[] = {
		{ "Category", "Game|Cinematic|Bindings" },
		{ "Comment", "/** Resets all overridden bindings back to the defaults defined by the Level Sequence asset */" },
		{ "ModuleRelativePath", "Public/LevelSequenceActor.h" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ALevelSequenceActor_SetBinding_Statics::Function_MetaDataParams[] = {
		{ "Category", "Game|Cinematic|Bindings" },
		{ "Comment", "/** Overrides the specified binding with the specified actors, optionally still allowing the bindings defined in the Level Sequence asset\n\x09 *\n\x09 * @param Binding Binding to modify\n\x09 * @param Actors Actors to bind\n\x09 * @param bAllowBindingsFromAsset Allow bindings from the level sequence asset\n\x09 */" },
		{ "CPP_Default_bAllowBindingsFromAsset", "false" },
		{ "ModuleRelativePath", "Public/LevelSequenceActor.h" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ALevelSequenceActor_SetBinding_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ALevelSequenceActor, nullptr, "SetBinding", nullptr, nullptr, sizeof(LevelSequenceActor_eventSetBinding_Parms), Z_Construct_UFunction_ALevelSequenceActor_SetBinding_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_ALevelSequenceActor_SetBinding_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ALevelSequenceActor_SetBinding_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_ALevelSequenceActor_SetBinding_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ALevelSequenceActor_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ALevelSequenceActor_AddBinding, "AddBinding" }, // 3751443033
		{ &Z_Construct_UFunction_ALevelSequenceActor_GetSequence, "GetSequence" }, // 2903502028
		{ &Z_Construct_UFunction_ALevelSequenceActor_GetSequencePlayer, "GetSequencePlayer" }, // 3521280814
		{ &Z_Construct_UFunction_ALevelSequenceActor_HideBurnin, "HideBurnin" }, // 1692287903
		{ &Z_Construct_UFunction_ALevelSequenceActor_LoadSequence, "LoadSequence" }, // 345653510
		{ &Z_Construct_UDelegateFunction_ALevelSequenceActor_OnLevelSequenceLoaded__DelegateSignature, "OnLevelSequenceLoaded__DelegateSignature" }, // 681766044
		{ &Z_Construct_UFunction_ALevelSequenceActor_RemoveBinding, "RemoveBinding" }, // 2332308032
		{ &Z_Construct_UFunction_ALevelSequenceActor_ResetBinding, "ResetBinding" }, // 1442888785
		{ &Z_Construct_UFunction_ALevelSequenceActor_ResetBindings, "ResetBindings" }, // 3930586755
		{ &Z_Construct_UFunction_ALevelSequenceActor_SetBinding, "SetBinding" }, // 4093583932
		{ &Z_Construct_UFunction_ALevelSequenceActor_SetEventReceivers, "SetEventReceivers" }, // 1645102554
		{ &Z_Construct_UFunction_ALevelSequenceActor_SetReplicatePlayback, "SetReplicatePlayback" }, // 1432073113
		{ &Z_Construct_UFunction_ALevelSequenceActor_SetSequence, "SetSequence" }, // 1013016102
		{ &Z_Construct_UFunction_ALevelSequenceActor_ShowBurnin, "ShowBurnin" }, // 2657375091
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ALevelSequenceActor_Statics::NewProp_bShowBurnin = { "bShowBurnin", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(ALevelSequenceActor), &Z_Construct_UClass_ALevelSequenceActor_Statics::NewProp_bShowBurnin_SetBit, METADATA_PARAMS(Z_Construct_UClass_ALevelSequenceActor_Statics::NewProp_bShowBurnin_MetaData, ARRAY_COUNT(Z_Construct_UClass_ALevelSequenceActor_Statics::NewProp_bShowBurnin_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ALevelSequenceActor_Statics::NewProp_bOverrideInstanceData = { "bOverrideInstanceData", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(ALevelSequenceActor), &Z_Construct_UClass_ALevelSequenceActor_Statics::NewProp_bOverrideInstanceData_SetBit, METADATA_PARAMS(Z_Construct_UClass_ALevelSequenceActor_Statics::NewProp_bOverrideInstanceData_MetaData, ARRAY_COUNT(Z_Construct_UClass_ALevelSequenceActor_Statics::NewProp_bOverrideInstanceData_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ALevelSequenceActor, 2482337631);
