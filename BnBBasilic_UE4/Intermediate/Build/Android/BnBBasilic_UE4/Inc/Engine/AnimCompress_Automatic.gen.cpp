...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAnimCompress_Automatic_Statics::NewProp_bTryExhaustiveSearch_MetaData[] = {
		...
		{ "Comment", "/** If true, then an exhaustive search is used otherwise only a short list of the best methods is tried */" },
		{ "ModuleRelativePath", "Classes/Animation/AnimCompress_Automatic.h" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAnimCompress_Automatic_Statics::NewProp_bRaiseMaxErrorToExisting_MetaData[] = {
		{ "Category", "AnimationCompressionAlgorithm_Automatic" },
		{ "Comment", "/** If true and the existing compression error is greater than Max End Effector Error, then Max End Effector Error will be effectively raised to the existing error level */" },
		{ "ModuleRelativePath", "Classes/Animation/AnimCompress_Automatic.h" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAnimCompress_Automatic_Statics::NewProp_bAutoReplaceIfExistingErrorTooGreat_MetaData[] = {
		{ "Category", "AnimationCompressionAlgorithm_Automatic" },
		{ "Comment", "/** If true and the existing compression error is greater than Max End Effector Error, then any compression technique (even one that increases the size) with a lower error will be used until it falls below the threshold\n\x09* Also known as \"force below threshold\"\n\x09*/" },
		{ "ModuleRelativePath", "Classes/Animation/AnimCompress_Automatic.h" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAnimCompress_Automatic_Statics::NewProp_MaxEndEffectorError_MetaData[] = {
		{ "Category", "AnimationCompressionAlgorithm_Automatic" },
		{ "Comment", "/** Maximum amount of error that a compression technique can introduce in an end effector \n\x09* Determines the current setting for world - space error tolerance in the animation compressor.\n\x09* When requested, animation being compressed will also consider an alternative compression\n\x09* method if the end result of that method produces less error than the AlternativeCompressionThreshold.\n\x09* Also known as \"Alternative Compression Threshold\"\n\x09*/" },
		{ "ModuleRelativePath", "Classes/Animation/AnimCompress_Automatic.h" },
	...
	IMPLEMENT_CLASS(UAnimCompress_Automatic, 3017693994);
