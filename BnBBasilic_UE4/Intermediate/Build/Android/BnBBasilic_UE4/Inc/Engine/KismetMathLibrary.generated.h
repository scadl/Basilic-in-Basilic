...
#define Engine_Source_Runtime_Engine_Classes_Kismet_KismetMathLibrary_h_134_RPC_WRAPPERS \
 \
	...
	{ \
		...
		P_GET_PROPERTY(UFloatProperty,Z_Param_MinWeight); \
		P_GET_PROPERTY(UFloatProperty,Z_Param_MaxWeight); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
 ...
 \
	...
	{ \
		P_GET_PROPERTY(UFloatProperty,Z_Param_CurrentSample); \
		P_GET_PROPERTY(UFloatProperty,Z_Param_PreviousSample); \
		P_GET_PROPERTY(UFloatProperty,Z_Param_MaxDistance); \
		P_GET_PROPERTY(UFloatProperty,Z_Param_MinWeight); \
		P_GET_PROPERTY(UFloatProperty,Z_Param_MaxWeight); \
		P_FINISH; \
 ...
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(float*)Z_Param__Result=UKismetMathLibrary::DegAtan2(Z_Param_Y,Z_Param_X); \
		P_NATIVE_END; \
	} \
 \
 ...
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(float*)Z_Param__Result=UKismetMathLibrary::Atan2(Z_Param_Y,Z_Param_X); \
		P_NATIVE_END; \
	} \
 \
