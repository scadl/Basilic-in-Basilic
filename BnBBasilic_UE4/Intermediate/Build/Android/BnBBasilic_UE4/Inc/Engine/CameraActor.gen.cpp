...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ACameraActor_GetAutoActivatePlayerIndex_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ACameraActor, nullptr, "GetAutoActivatePlayerIndex", nullptr, nullptr, sizeof(CameraActor_eventGetAutoActivatePlayerIndex_Parms), Z_Construct_UFunction_ACameraActor_GetAutoActivatePlayerIndex_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_ACameraActor_GetAutoActivatePlayerIndex_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ACameraActor_GetAutoActivatePlayerIndex_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_ACameraActor_GetAutoActivatePlayerIndex_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ACameraActor_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ACameraActor_GetAutoActivatePlayerIndex, "GetAutoActivatePlayerIndex" }, // 2564570078
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ACameraActor, 3723962180);
