...
// Cross Module References
	...
	ENGINE_API UFunction* Z_Construct_UFunction_UAsyncActionHandleSaveGame_AsyncLoadGameFromSlot();
	COREUOBJECT_API UClass* Z_Construct_UClass_UObject_NoRegister();
	ENGINE_API UFunction* Z_Construct_UFunction_UAsyncActionHandleSaveGame_AsyncSaveGameToSlot();
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UAsyncActionHandleSaveGame_AsyncLoadGameFromSlot_Statics::NewProp_UserIndex = { "UserIndex", nullptr, (EPropertyFlags)0x0010000000000082, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AsyncActionHandleSaveGame_eventAsyncLoadGameFromSlot_Parms, UserIndex), METADATA_PARAMS(Z_Construct_UFunction_UAsyncActionHandleSaveGame_AsyncLoadGameFromSlot_Statics::NewProp_UserIndex_MetaData, ARRAY_COUNT(Z_Construct_UFunction_UAsyncActionHandleSaveGame_AsyncLoadGameFromSlot_Statics::NewProp_UserIndex_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UAsyncActionHandleSaveGame_AsyncLoadGameFromSlot_Statics::NewProp_SlotName = { "SlotName", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AsyncActionHandleSaveGame_eventAsyncLoadGameFromSlot_Parms, SlotName), METADATA_PARAMS(Z_Construct_UFunction_UAsyncActionHandleSaveGame_AsyncLoadGameFromSlot_Statics::NewProp_SlotName_MetaData, ARRAY_COUNT(Z_Construct_UFunction_UAsyncActionHandleSaveGame_AsyncLoadGameFromSlot_Statics::NewProp_SlotName_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UAsyncActionHandleSaveGame_AsyncLoadGameFromSlot_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAsyncActionHandleSaveGame, nullptr, "AsyncLoadGameFromSlot", nullptr, nullptr, sizeof(AsyncActionHandleSaveGame_eventAsyncLoadGameFromSlot_Parms), Z_Construct_UFunction_UAsyncActionHandleSaveGame_AsyncLoadGameFromSlot_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UAsyncActionHandleSaveGame_AsyncLoadGameFromSlot_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UAsyncActionHandleSaveGame_AsyncLoadGameFromSlot_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UAsyncActionHandleSaveGame_AsyncLoadGameFromSlot_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UAsyncActionHandleSaveGame_AsyncSaveGameToSlot_Statics::NewProp_SlotName = { "SlotName", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AsyncActionHandleSaveGame_eventAsyncSaveGameToSlot_Parms, SlotName), METADATA_PARAMS(Z_Construct_UFunction_UAsyncActionHandleSaveGame_AsyncSaveGameToSlot_Statics::NewProp_SlotName_MetaData, ARRAY_COUNT(Z_Construct_UFunction_UAsyncActionHandleSaveGame_AsyncSaveGameToSlot_Statics::NewProp_SlotName_MetaData)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAsyncActionHandleSaveGame_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAsyncActionHandleSaveGame_AsyncLoadGameFromSlot, "AsyncLoadGameFromSlot" }, // 2061811773
		{ &Z_Construct_UFunction_UAsyncActionHandleSaveGame_AsyncSaveGameToSlot, "AsyncSaveGameToSlot" }, // 2497125880
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAsyncActionHandleSaveGame_Statics::ClassParams = {
		...
		ARRAY_COUNT(Z_Construct_UClass_UAsyncActionHandleSaveGame_Statics::PropPointers),
		0,
		0x009000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UAsyncActionHandleSaveGame_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UAsyncActionHandleSaveGame_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UAsyncActionHandleSaveGame, 4128348825);
