...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UStreamableRenderAsset_Statics::NewProp_bIgnoreStreamingMipBias_MetaData[] = {
		{ "Comment", "/** Ignores the streaming mip bias used to accommodate memory constraints. */" },
		{ "ModuleRelativePath", "Classes/Engine/StreamableRenderAsset.h" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UStreamableRenderAsset_Statics::NewProp_bCachedReadyForStreaming = { "bCachedReadyForStreaming", nullptr, (EPropertyFlags)0x0020080000002000, UE4CodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UStreamableRenderAsset), &Z_Construct_UClass_UStreamableRenderAsset_Statics::NewProp_bCachedReadyForStreaming_SetBit, METADATA_PARAMS(Z_Construct_UClass_UStreamableRenderAsset_Statics::NewProp_bCachedReadyForStreaming_MetaData, ARRAY_COUNT(Z_Construct_UClass_UStreamableRenderAsset_Statics::NewProp_bCachedReadyForStreaming_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UStreamableRenderAsset_Statics::NewProp_CachedNumResidentLODs = { "CachedNumResidentLODs", nullptr, (EPropertyFlags)0x0020080000002000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UStreamableRenderAsset, CachedNumResidentLODs), nullptr, METADATA_PARAMS(Z_Construct_UClass_UStreamableRenderAsset_Statics::NewProp_CachedNumResidentLODs_MetaData, ARRAY_COUNT(Z_Construct_UClass_UStreamableRenderAsset_Statics::NewProp_CachedNumResidentLODs_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UStreamableRenderAsset_Statics::NewProp_CachedCombinedLODBias = { "CachedCombinedLODBias", nullptr, (EPropertyFlags)0x0020080000002000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UStreamableRenderAsset, CachedCombinedLODBias), METADATA_PARAMS(Z_Construct_UClass_UStreamableRenderAsset_Statics::NewProp_CachedCombinedLODBias_MetaData, ARRAY_COUNT(Z_Construct_UClass_UStreamableRenderAsset_Statics::NewProp_CachedCombinedLODBias_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UStreamableRenderAsset_Statics::NewProp_StreamingIndex = { "StreamingIndex", nullptr, (EPropertyFlags)0x0020080400202000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UStreamableRenderAsset, StreamingIndex), METADATA_PARAMS(Z_Construct_UClass_UStreamableRenderAsset_Statics::NewProp_StreamingIndex_MetaData, ARRAY_COUNT(Z_Construct_UClass_UStreamableRenderAsset_Statics::NewProp_StreamingIndex_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UStreamableRenderAsset_Statics::NewProp_NumCinematicMipLevels = { "NumCinematicMipLevels", nullptr, (EPropertyFlags)0x0010040000000005, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UStreamableRenderAsset, NumCinematicMipLevels), METADATA_PARAMS(Z_Construct_UClass_UStreamableRenderAsset_Statics::NewProp_NumCinematicMipLevels_MetaData, ARRAY_COUNT(Z_Construct_UClass_UStreamableRenderAsset_Statics::NewProp_NumCinematicMipLevels_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FDoublePropertyParams Z_Construct_UClass_UStreamableRenderAsset_Statics::NewProp_ForceMipLevelsToBeResidentTimestamp = { "ForceMipLevelsToBeResidentTimestamp", nullptr, (EPropertyFlags)0x0020080000002000, UE4CodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UStreamableRenderAsset, ForceMipLevelsToBeResidentTimestamp), METADATA_PARAMS(Z_Construct_UClass_UStreamableRenderAsset_Statics::NewProp_ForceMipLevelsToBeResidentTimestamp_MetaData, ARRAY_COUNT(Z_Construct_UClass_UStreamableRenderAsset_Statics::NewProp_ForceMipLevelsToBeResidentTimestamp_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UStreamableRenderAsset_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UStreamableRenderAsset_Statics::PropPointers),
		0,
		0x000800A1u,
		METADATA_PARAMS(Z_Construct_UClass_UStreamableRenderAsset_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UStreamableRenderAsset_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UStreamableRenderAsset, 3512215625);
