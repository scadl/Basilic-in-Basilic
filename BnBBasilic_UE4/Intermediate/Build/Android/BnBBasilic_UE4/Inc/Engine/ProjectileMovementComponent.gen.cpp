...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_UProjectileMovementComponent_OnProjectileStopDelegate__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UProjectileMovementComponent, nullptr, "OnProjectileStopDelegate__DelegateSignature", nullptr, nullptr, sizeof(ProjectileMovementComponent_eventOnProjectileStopDelegate_Parms), Z_Construct_UDelegateFunction_UProjectileMovementComponent_OnProjectileStopDelegate__DelegateSignature_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UDelegateFunction_UProjectileMovementComponent_OnProjectileStopDelegate__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00530000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_UProjectileMovementComponent_OnProjectileStopDelegate__DelegateSignature_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UDelegateFunction_UProjectileMovementComponent_OnProjectileStopDelegate__DelegateSignature_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UProjectileMovementComponent_LimitVelocity_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UProjectileMovementComponent, nullptr, "LimitVelocity", nullptr, nullptr, sizeof(ProjectileMovementComponent_eventLimitVelocity_Parms), Z_Construct_UFunction_UProjectileMovementComponent_LimitVelocity_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UProjectileMovementComponent_LimitVelocity_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54820401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UProjectileMovementComponent_LimitVelocity_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UProjectileMovementComponent_LimitVelocity_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UProjectileMovementComponent_SetInterpolatedComponent_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UProjectileMovementComponent, nullptr, "SetInterpolatedComponent", nullptr, nullptr, sizeof(ProjectileMovementComponent_eventSetInterpolatedComponent_Parms), Z_Construct_UFunction_UProjectileMovementComponent_SetInterpolatedComponent_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UProjectileMovementComponent_SetInterpolatedComponent_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020400, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UProjectileMovementComponent_SetInterpolatedComponent_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UProjectileMovementComponent_SetInterpolatedComponent_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UProjectileMovementComponent_StopSimulating_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UProjectileMovementComponent, nullptr, "StopSimulating", nullptr, nullptr, sizeof(ProjectileMovementComponent_eventStopSimulating_Parms), Z_Construct_UFunction_UProjectileMovementComponent_StopSimulating_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UProjectileMovementComponent_StopSimulating_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420400, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UProjectileMovementComponent_StopSimulating_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UProjectileMovementComponent_StopSimulating_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UProjectileMovementComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UProjectileMovementComponent_IsInterpolationComplete, "IsInterpolationComplete" }, // 3439277065
		{ &Z_Construct_UFunction_UProjectileMovementComponent_IsVelocityUnderSimulationThreshold, "IsVelocityUnderSimulationThreshold" }, // 4226944679
		{ &Z_Construct_UFunction_UProjectileMovementComponent_LimitVelocity, "LimitVelocity" }, // 3607123528
		{ &Z_Construct_UFunction_UProjectileMovementComponent_MoveInterpolationTarget, "MoveInterpolationTarget" }, // 12463401
		{ &Z_Construct_UDelegateFunction_UProjectileMovementComponent_OnProjectileBounceDelegate__DelegateSignature, "OnProjectileBounceDelegate__DelegateSignature" }, // 2366083673
		{ &Z_Construct_UDelegateFunction_UProjectileMovementComponent_OnProjectileStopDelegate__DelegateSignature, "OnProjectileStopDelegate__DelegateSignature" }, // 3830117679
		{ &Z_Construct_UFunction_UProjectileMovementComponent_ResetInterpolation, "ResetInterpolation" }, // 2589639145
		{ &Z_Construct_UFunction_UProjectileMovementComponent_SetInterpolatedComponent, "SetInterpolatedComponent" }, // 1387965589
		{ &Z_Construct_UFunction_UProjectileMovementComponent_SetVelocityInLocalSpace, "SetVelocityInLocalSpace" }, // 863792318
		{ &Z_Construct_UFunction_UProjectileMovementComponent_StopSimulating, "StopSimulating" }, // 3440388883
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UProjectileMovementComponent, 3295916078);
