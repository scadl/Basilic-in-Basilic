...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UMaterialExpressionVectorParameter_Statics::NewProp_PrimitiveDataIndex = { "PrimitiveDataIndex", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionVectorParameter, PrimitiveDataIndex), nullptr, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionVectorParameter_Statics::NewProp_PrimitiveDataIndex_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionVectorParameter_Statics::NewProp_PrimitiveDataIndex_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UMaterialExpressionVectorParameter, 2404295530);
