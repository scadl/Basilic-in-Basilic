...
static struct FScriptStruct_Engine_StaticRegisterNativesFSoundNodeEditorData
{
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_USoundCue_Statics::NewProp_bHasPlayWhenSilent = { "bHasPlayWhenSilent", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(USoundCue), &Z_Construct_UClass_USoundCue_Statics::NewProp_bHasPlayWhenSilent_SetBit, METADATA_PARAMS(Z_Construct_UClass_USoundCue_Statics::NewProp_bHasPlayWhenSilent_MetaData, ARRAY_COUNT(Z_Construct_UClass_USoundCue_Statics::NewProp_bHasPlayWhenSilent_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(USoundCue, 2307138050);
