...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_Engine_ParticleDeathSignature__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_Engine, nullptr, "ParticleDeathSignature__DelegateSignature", nullptr, nullptr, sizeof(_Script_Engine_eventParticleDeathSignature_Parms), Z_Construct_UDelegateFunction_Engine_ParticleDeathSignature__DelegateSignature_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UDelegateFunction_Engine_ParticleDeathSignature__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_Engine_ParticleDeathSignature__DelegateSignature_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UDelegateFunction_Engine_ParticleDeathSignature__DelegateSignature_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AEmitter_IsActive_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AEmitter, nullptr, "IsActive", nullptr, nullptr, sizeof(Emitter_eventIsActive_Parms), Z_Construct_UFunction_AEmitter_IsActive_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AEmitter_IsActive_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AEmitter_IsActive_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AEmitter_IsActive_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AEmitter_SetColorParameter_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AEmitter, nullptr, "SetColorParameter", nullptr, nullptr, sizeof(Emitter_eventSetColorParameter_Parms), Z_Construct_UFunction_AEmitter_SetColorParameter_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AEmitter_SetColorParameter_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04820401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AEmitter_SetColorParameter_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AEmitter_SetColorParameter_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AEmitter_SetTemplate_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AEmitter, nullptr, "SetTemplate", nullptr, nullptr, sizeof(Emitter_eventSetTemplate_Parms), Z_Construct_UFunction_AEmitter_SetTemplate_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AEmitter_SetTemplate_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020400, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AEmitter_SetTemplate_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AEmitter_SetTemplate_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AEmitter_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AEmitter_Activate, "Activate" }, // 759006549
		{ &Z_Construct_UFunction_AEmitter_Deactivate, "Deactivate" }, // 2023269474
		{ &Z_Construct_UFunction_AEmitter_IsActive, "IsActive" }, // 1966818463
		{ &Z_Construct_UFunction_AEmitter_OnParticleSystemFinished, "OnParticleSystemFinished" }, // 117518166
		{ &Z_Construct_UFunction_AEmitter_OnRep_bCurrentlyActive, "OnRep_bCurrentlyActive" }, // 3057461121
		{ &Z_Construct_UFunction_AEmitter_SetActorParameter, "SetActorParameter" }, // 1791734462
		{ &Z_Construct_UFunction_AEmitter_SetColorParameter, "SetColorParameter" }, // 1486978335
		{ &Z_Construct_UFunction_AEmitter_SetFloatParameter, "SetFloatParameter" }, // 1764201696
		{ &Z_Construct_UFunction_AEmitter_SetMaterialParameter, "SetMaterialParameter" }, // 2779892175
		{ &Z_Construct_UFunction_AEmitter_SetTemplate, "SetTemplate" }, // 304984153
		{ &Z_Construct_UFunction_AEmitter_SetVectorParameter, "SetVectorParameter" }, // 1783032661
		{ &Z_Construct_UFunction_AEmitter_ToggleActive, "ToggleActive" }, // 3307683545
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_AEmitter_Statics::NewProp_OnParticleSpawn = { "OnParticleSpawn", nullptr, (EPropertyFlags)0x0010000010080000, UE4CodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AEmitter, OnParticleSpawn), Z_Construct_UDelegateFunction_Engine_ParticleSpawnSignature__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_AEmitter_Statics::NewProp_OnParticleSpawn_MetaData, ARRAY_COUNT(Z_Construct_UClass_AEmitter_Statics::NewProp_OnParticleSpawn_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AEmitter, 2064431235);
