...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAnimCompress_RemoveLinearKeys_Statics::NewProp_bUseMultithreading_MetaData[] = {
		...
		{ "Comment", "/**\n\x09 * Whether or not to use multiple threads during compression.\n\x09 */" },
		{ "ModuleRelativePath", "Classes/Animation/AnimCompress_RemoveLinearKeys.h" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAnimCompress_RemoveLinearKeys_Statics::NewProp_bUseDecompression_MetaData[] = {
		{ "Category", "LinearKeyRemoval" },
		{ "Comment", "/**\n\x09 * Whether to use the legacy behavior that compressed and decompressed the whole sequence whenever a key was removed.\n\x09 * This is left in for now in order to debug the code if issues arise with the new stateless version.\n\x09 * The legacy behavior to compress the whole sequence constantly makes it impossible to compress segments\n\x09 * in parallel safely. The new code samples the sequence without the compression step in order to make it\n\x09 * thread safe.\n\x09 * Once the stateless code is robust, this can be safely removed. It should never be used.\n\x09 */" },
		{ "ModuleRelativePath", "Classes/Animation/AnimCompress_RemoveLinearKeys.h" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAnimCompress_RemoveLinearKeys_Statics::NewProp_bOptimizeForForwardPlayback_MetaData[] = {
		{ "Comment", "//UPROPERTY(EditAnywhere, Category = LinearKeyRemoval, meta = (EditCondition=\"bEnableSegmenting\"))\n" },
		{ "ModuleRelativePath", "Classes/Animation/AnimCompress_RemoveLinearKeys.h" },
	...
	IMPLEMENT_CLASS(UAnimCompress_RemoveLinearKeys, 210150087);
