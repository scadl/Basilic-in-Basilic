...
static struct FScriptStruct_Engine_StaticRegisterNativesFAssetImportInfo
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FAssetImportInfo_Hash() { return 1593114578U; }
...
#if WITH_EDITOR
		{ &Z_Construct_UFunction_UAssetImportData_K2_ExtractFilenames, "K2_ExtractFilenames" }, // 738272657
#endif //WITH_EDITOR
#if WITH_EDITOR
		{ &Z_Construct_UFunction_UAssetImportData_K2_GetFirstFilename, "K2_GetFirstFilename" }, // 168618839
#endif //WITH_EDITOR
	};
#endif //WITH_EDITOR
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UAssetImportData, 1435101690);
