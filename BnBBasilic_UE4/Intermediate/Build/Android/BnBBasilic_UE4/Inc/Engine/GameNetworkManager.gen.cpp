...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_EStandbyType_Hash() { return 1294578460U; }
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AGameNetworkManager_Statics::NewProp_ClientNetCamUpdateDeltaTime = { "ClientNetCamUpdateDeltaTime", nullptr, (EPropertyFlags)0x0010000000044000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AGameNetworkManager, ClientNetCamUpdateDeltaTime), METADATA_PARAMS(Z_Construct_UClass_AGameNetworkManager_Statics::NewProp_ClientNetCamUpdateDeltaTime_MetaData, ARRAY_COUNT(Z_Construct_UClass_AGameNetworkManager_Statics::NewProp_ClientNetCamUpdateDeltaTime_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AGameNetworkManager_Statics::NewProp_ServerForcedUpdateHitchCooldown = { "ServerForcedUpdateHitchCooldown", nullptr, (EPropertyFlags)0x0010000000044000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AGameNetworkManager, ServerForcedUpdateHitchCooldown), METADATA_PARAMS(Z_Construct_UClass_AGameNetworkManager_Statics::NewProp_ServerForcedUpdateHitchCooldown_MetaData, ARRAY_COUNT(Z_Construct_UClass_AGameNetworkManager_Statics::NewProp_ServerForcedUpdateHitchCooldown_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AGameNetworkManager_Statics::NewProp_ServerForcedUpdateHitchThreshold = { "ServerForcedUpdateHitchThreshold", nullptr, (EPropertyFlags)0x0010000000044000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AGameNetworkManager, ServerForcedUpdateHitchThreshold), METADATA_PARAMS(Z_Construct_UClass_AGameNetworkManager_Statics::NewProp_ServerForcedUpdateHitchThreshold_MetaData, ARRAY_COUNT(Z_Construct_UClass_AGameNetworkManager_Statics::NewProp_ServerForcedUpdateHitchThreshold_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_AGameNetworkManager_Statics::NewProp_BadPingThreshold = { "BadPingThreshold", nullptr, (EPropertyFlags)0x0010000000044000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AGameNetworkManager, BadPingThreshold), METADATA_PARAMS(Z_Construct_UClass_AGameNetworkManager_Statics::NewProp_BadPingThreshold_MetaData, ARRAY_COUNT(Z_Construct_UClass_AGameNetworkManager_Statics::NewProp_BadPingThreshold_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AGameNetworkManager_Statics::NewProp_SeverePacketLossThreshold = { "SeverePacketLossThreshold", nullptr, (EPropertyFlags)0x0010000000044000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AGameNetworkManager, SeverePacketLossThreshold), METADATA_PARAMS(Z_Construct_UClass_AGameNetworkManager_Statics::NewProp_SeverePacketLossThreshold_MetaData, ARRAY_COUNT(Z_Construct_UClass_AGameNetworkManager_Statics::NewProp_SeverePacketLossThreshold_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AGameNetworkManager, 3666213478);
