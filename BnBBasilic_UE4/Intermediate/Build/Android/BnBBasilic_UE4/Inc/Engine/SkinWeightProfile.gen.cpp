...
static struct FScriptStruct_Engine_StaticRegisterNativesFSkinWeightProfileInfo
{
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSkinWeightProfileInfo_Statics::NewProp_DefaultProfile = { "DefaultProfile", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSkinWeightProfileInfo, DefaultProfile), Z_Construct_UScriptStruct_FPerPlatformBool, METADATA_PARAMS(Z_Construct_UScriptStruct_FSkinWeightProfileInfo_Statics::NewProp_DefaultProfile_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FSkinWeightProfileInfo_Statics::NewProp_DefaultProfile_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FSkinWeightProfileInfo_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FSkinWeightProfileInfo_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FSkinWeightProfileInfo_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FSkinWeightProfileInfo_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FSkinWeightProfileInfo_Hash() { return 3054898039U; }
