...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMaterialExpressionShadingModel_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionShadingModel_Statics::PropPointers),
		0,
		0x000820A0u,
		METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionShadingModel_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionShadingModel_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UMaterialExpressionShadingModel, 1217129169);
