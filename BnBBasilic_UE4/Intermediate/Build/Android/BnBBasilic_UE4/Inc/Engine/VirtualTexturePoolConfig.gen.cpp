...
static struct FScriptStruct_Engine_StaticRegisterNativesFVirtualTextureSpacePoolConfig
{
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FVirtualTextureSpacePoolConfig_Statics::NewProp_Format_MetaData[] = {
		{ "Comment", "// This is *including* any filtering borders\n" },
		{ "ModuleRelativePath", "Classes/VT/VirtualTexturePoolConfig.h" },
		{ "ToolTip", "This is *including* any filtering borders" },
	};
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FVirtualTextureSpacePoolConfig_Statics::NewProp_Format = { "Format", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FVirtualTextureSpacePoolConfig, Format), Z_Construct_UEnum_CoreUObject_EPixelFormat, METADATA_PARAMS(Z_Construct_UScriptStruct_FVirtualTextureSpacePoolConfig_Statics::NewProp_Format_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FVirtualTextureSpacePoolConfig_Statics::NewProp_Format_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FVirtualTextureSpacePoolConfig_Statics::NewProp_TileSize_MetaData[] = {
		{ "Comment", "// Size counted in tiles of the pool\n" },
		{ "ModuleRelativePath", "Classes/VT/VirtualTexturePoolConfig.h" },
		{ "ToolTip", "Size counted in tiles of the pool" },
	};
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FVirtualTextureSpacePoolConfig_Statics::NewProp_TileSize = { "TileSize", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FVirtualTextureSpacePoolConfig, TileSize), METADATA_PARAMS(Z_Construct_UScriptStruct_FVirtualTextureSpacePoolConfig_Statics::NewProp_TileSize_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FVirtualTextureSpacePoolConfig_Statics::NewProp_TileSize_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FVirtualTextureSpacePoolConfig_Statics::NewProp_SizeInMegabyte = { "SizeInMegabyte", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FVirtualTextureSpacePoolConfig, SizeInMegabyte), METADATA_PARAMS(Z_Construct_UScriptStruct_FVirtualTextureSpacePoolConfig_Statics::NewProp_SizeInMegabyte_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FVirtualTextureSpacePoolConfig_Statics::NewProp_SizeInMegabyte_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FVirtualTextureSpacePoolConfig_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FVirtualTextureSpacePoolConfig_Statics::NewProp_Format,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FVirtualTextureSpacePoolConfig_Statics::NewProp_TileSize,
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FVirtualTextureSpacePoolConfig_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FVirtualTextureSpacePoolConfig_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FVirtualTextureSpacePoolConfig_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FVirtualTextureSpacePoolConfig_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FVirtualTextureSpacePoolConfig_Hash() { return 2260836166U; }
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UVirtualTexturePoolConfig_Statics::NewProp_Pools = { "Pools", nullptr, (EPropertyFlags)0x0010000000004000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UVirtualTexturePoolConfig, Pools), METADATA_PARAMS(Z_Construct_UClass_UVirtualTexturePoolConfig_Statics::NewProp_Pools_MetaData, ARRAY_COUNT(Z_Construct_UClass_UVirtualTexturePoolConfig_Statics::NewProp_Pools_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UVirtualTexturePoolConfig_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UVirtualTexturePoolConfig_Statics::PropPointers),
		0,
		0x001000ACu,
		METADATA_PARAMS(Z_Construct_UClass_UVirtualTexturePoolConfig_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UVirtualTexturePoolConfig_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UVirtualTexturePoolConfig, 3287035529);
