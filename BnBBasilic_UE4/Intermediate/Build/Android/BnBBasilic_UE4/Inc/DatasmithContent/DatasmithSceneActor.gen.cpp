...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UClass_ADatasmithSceneActor_Statics::NewProp_RelatedActors = { "RelatedActors", nullptr, (EPropertyFlags)0x0014040000020001, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ADatasmithSceneActor, RelatedActors), METADATA_PARAMS(Z_Construct_UClass_ADatasmithSceneActor_Statics::NewProp_RelatedActors_MetaData, ARRAY_COUNT(Z_Construct_UClass_ADatasmithSceneActor_Statics::NewProp_RelatedActors_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ADatasmithSceneActor_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_ADatasmithSceneActor_Statics::PropPointers),
		0,
		0x009000A0u,
		METADATA_PARAMS(Z_Construct_UClass_ADatasmithSceneActor_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_ADatasmithSceneActor_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(ADatasmithSceneActor, 1160723564);
