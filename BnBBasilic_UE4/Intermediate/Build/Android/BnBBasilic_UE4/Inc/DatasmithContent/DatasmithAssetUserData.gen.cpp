...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UClass_UDatasmithAssetUserData_Statics::NewProp_ObjectTemplates = { "ObjectTemplates", nullptr, (EPropertyFlags)0x0010000800000000, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDatasmithAssetUserData, ObjectTemplates), METADATA_PARAMS(Z_Construct_UClass_UDatasmithAssetUserData_Statics::NewProp_ObjectTemplates_MetaData, ARRAY_COUNT(Z_Construct_UClass_UDatasmithAssetUserData_Statics::NewProp_ObjectTemplates_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UClass_UDatasmithAssetUserData_Statics::NewProp_MetaData = { "MetaData", nullptr, (EPropertyFlags)0x0010040000020005, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDatasmithAssetUserData, MetaData), METADATA_PARAMS(Z_Construct_UClass_UDatasmithAssetUserData_Statics::NewProp_MetaData_MetaData, ARRAY_COUNT(Z_Construct_UClass_UDatasmithAssetUserData_Statics::NewProp_MetaData_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UDatasmithAssetUserData_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UDatasmithAssetUserData_Statics::PropPointers),
		0,
		0x003010A0u,
		METADATA_PARAMS(Z_Construct_UClass_UDatasmithAssetUserData_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UDatasmithAssetUserData_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UDatasmithAssetUserData, 1597289584);
