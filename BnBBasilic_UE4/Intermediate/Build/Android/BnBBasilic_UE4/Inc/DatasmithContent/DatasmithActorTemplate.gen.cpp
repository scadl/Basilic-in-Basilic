...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FSetPropertyParams Z_Construct_UClass_UDatasmithActorTemplate_Statics::NewProp_Tags = { "Tags", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Set, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDatasmithActorTemplate, Tags), METADATA_PARAMS(Z_Construct_UClass_UDatasmithActorTemplate_Statics::NewProp_Tags_MetaData, ARRAY_COUNT(Z_Construct_UClass_UDatasmithActorTemplate_Statics::NewProp_Tags_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UDatasmithActorTemplate_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UDatasmithActorTemplate_Statics::PropPointers),
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UDatasmithActorTemplate_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UDatasmithActorTemplate_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UDatasmithActorTemplate, 520648503);
