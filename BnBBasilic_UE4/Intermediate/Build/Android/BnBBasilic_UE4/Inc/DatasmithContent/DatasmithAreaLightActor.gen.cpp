...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_DatasmithContent_EDatasmithAreaLightActorType_Hash() { return 498353592U; }
	...
	uint32 Get_Z_Construct_UEnum_DatasmithContent_EDatasmithAreaLightActorShape_Hash() { return 1465217803U; }
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ADatasmithAreaLightActor_Statics::NewProp_SpotlightOuterAngle = { "SpotlightOuterAngle", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ADatasmithAreaLightActor, SpotlightOuterAngle), METADATA_PARAMS(Z_Construct_UClass_ADatasmithAreaLightActor_Statics::NewProp_SpotlightOuterAngle_MetaData, ARRAY_COUNT(Z_Construct_UClass_ADatasmithAreaLightActor_Statics::NewProp_SpotlightOuterAngle_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ADatasmithAreaLightActor_Statics::NewProp_AttenuationRadius = { "AttenuationRadius", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ADatasmithAreaLightActor, AttenuationRadius), METADATA_PARAMS(Z_Construct_UClass_ADatasmithAreaLightActor_Statics::NewProp_AttenuationRadius_MetaData, ARRAY_COUNT(Z_Construct_UClass_ADatasmithAreaLightActor_Statics::NewProp_AttenuationRadius_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ADatasmithAreaLightActor_Statics::NewProp_Intensity = { "Intensity", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ADatasmithAreaLightActor, Intensity), METADATA_PARAMS(Z_Construct_UClass_ADatasmithAreaLightActor_Statics::NewProp_Intensity_MetaData, ARRAY_COUNT(Z_Construct_UClass_ADatasmithAreaLightActor_Statics::NewProp_Intensity_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_ADatasmithAreaLightActor_Statics::NewProp_LightShape = { "LightShape", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ADatasmithAreaLightActor, LightShape), Z_Construct_UEnum_DatasmithContent_EDatasmithAreaLightActorShape, METADATA_PARAMS(Z_Construct_UClass_ADatasmithAreaLightActor_Statics::NewProp_LightShape_MetaData, ARRAY_COUNT(Z_Construct_UClass_ADatasmithAreaLightActor_Statics::NewProp_LightShape_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_ADatasmithAreaLightActor_Statics::NewProp_LightType = { "LightType", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ADatasmithAreaLightActor, LightType), Z_Construct_UEnum_DatasmithContent_EDatasmithAreaLightActorType, METADATA_PARAMS(Z_Construct_UClass_ADatasmithAreaLightActor_Statics::NewProp_LightType_MetaData, ARRAY_COUNT(Z_Construct_UClass_ADatasmithAreaLightActor_Statics::NewProp_LightType_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ADatasmithAreaLightActor_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_ADatasmithAreaLightActor_Statics::PropPointers),
		0,
		0x008800A0u,
		METADATA_PARAMS(Z_Construct_UClass_ADatasmithAreaLightActor_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_ADatasmithAreaLightActor_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(ADatasmithAreaLightActor, 3319907716);
