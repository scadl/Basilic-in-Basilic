...
static struct FScriptStruct_DatasmithContent_StaticRegisterNativesFDatasmithStaticParameterSetTemplate
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDatasmithStaticParameterSetTemplate_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FDatasmithStaticParameterSetTemplate_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FDatasmithStaticParameterSetTemplate_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FDatasmithStaticParameterSetTemplate_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FDatasmithStaticParameterSetTemplate_Hash() { return 542965407U; }
...
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UClass_UDatasmithMaterialInstanceTemplate_Statics::NewProp_TextureParameterValues = { "TextureParameterValues", nullptr, (EPropertyFlags)0x0014000000000000, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDatasmithMaterialInstanceTemplate, TextureParameterValues), METADATA_PARAMS(Z_Construct_UClass_UDatasmithMaterialInstanceTemplate_Statics::NewProp_TextureParameterValues_MetaData, ARRAY_COUNT(Z_Construct_UClass_UDatasmithMaterialInstanceTemplate_Statics::NewProp_TextureParameterValues_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UClass_UDatasmithMaterialInstanceTemplate_Statics::NewProp_VectorParameterValues = { "VectorParameterValues", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDatasmithMaterialInstanceTemplate, VectorParameterValues), METADATA_PARAMS(Z_Construct_UClass_UDatasmithMaterialInstanceTemplate_Statics::NewProp_VectorParameterValues_MetaData, ARRAY_COUNT(Z_Construct_UClass_UDatasmithMaterialInstanceTemplate_Statics::NewProp_VectorParameterValues_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UClass_UDatasmithMaterialInstanceTemplate_Statics::NewProp_ScalarParameterValues = { "ScalarParameterValues", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDatasmithMaterialInstanceTemplate, ScalarParameterValues), METADATA_PARAMS(Z_Construct_UClass_UDatasmithMaterialInstanceTemplate_Statics::NewProp_ScalarParameterValues_MetaData, ARRAY_COUNT(Z_Construct_UClass_UDatasmithMaterialInstanceTemplate_Statics::NewProp_ScalarParameterValues_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UDatasmithMaterialInstanceTemplate_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UDatasmithMaterialInstanceTemplate_Statics::PropPointers),
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UDatasmithMaterialInstanceTemplate_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UDatasmithMaterialInstanceTemplate_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UDatasmithMaterialInstanceTemplate, 2789434734);
