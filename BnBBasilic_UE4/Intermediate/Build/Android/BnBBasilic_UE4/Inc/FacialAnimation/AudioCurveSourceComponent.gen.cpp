...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAudioCurveSourceComponent_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UAudioCurveSourceComponent_Statics::PropPointers),
		ARRAY_COUNT(InterfaceParams),
		0x00B000A4u,
		METADATA_PARAMS(Z_Construct_UClass_UAudioCurveSourceComponent_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UAudioCurveSourceComponent_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UAudioCurveSourceComponent, 2705644866);
