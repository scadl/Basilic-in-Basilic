...
static struct FScriptStruct_EditableMesh_StaticRegisterNativesFAdaptorPolygon2Group
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FAdaptorPolygon2Group_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FAdaptorPolygon2Group_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FAdaptorPolygon2Group_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FAdaptorPolygon2Group_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FAdaptorPolygon2Group_Hash() { return 2909870570U; }
...
static struct FScriptStruct_EditableMesh_StaticRegisterNativesFAdaptorPolygon
{
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FAdaptorPolygon_Statics::NewProp_TriangulatedPolygonTriangleIndices = { "TriangulatedPolygonTriangleIndices", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAdaptorPolygon, TriangulatedPolygonTriangleIndices), METADATA_PARAMS(Z_Construct_UScriptStruct_FAdaptorPolygon_Statics::NewProp_TriangulatedPolygonTriangleIndices_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FAdaptorPolygon_Statics::NewProp_TriangulatedPolygonTriangleIndices_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAdaptorPolygon_Statics::NewProp_PolygonGroupID = { "PolygonGroupID", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAdaptorPolygon, PolygonGroupID), Z_Construct_UScriptStruct_FPolygonGroupID, METADATA_PARAMS(Z_Construct_UScriptStruct_FAdaptorPolygon_Statics::NewProp_PolygonGroupID_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FAdaptorPolygon_Statics::NewProp_PolygonGroupID_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FAdaptorPolygon_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FAdaptorPolygon_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FAdaptorPolygon_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FAdaptorPolygon_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FAdaptorPolygon_Hash() { return 234455520U; }
...
static struct FScriptStruct_EditableMesh_StaticRegisterNativesFAdaptorTriangleID
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FAdaptorTriangleID_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FAdaptorTriangleID_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FAdaptorTriangleID_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FAdaptorTriangleID_Hash() { return 1417298898U; }
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UEditableGeometryCollectionAdapter_Statics::NewProp_OriginalGeometryCollection = { "OriginalGeometryCollection", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEditableGeometryCollectionAdapter, OriginalGeometryCollection), Z_Construct_UClass_UGeometryCollection_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UEditableGeometryCollectionAdapter_Statics::NewProp_OriginalGeometryCollection_MetaData, ARRAY_COUNT(Z_Construct_UClass_UEditableGeometryCollectionAdapter_Statics::NewProp_OriginalGeometryCollection_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UEditableGeometryCollectionAdapter_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UEditableGeometryCollectionAdapter_Statics::PropPointers),
		0,
		0x000800A0u,
		METADATA_PARAMS(Z_Construct_UClass_UEditableGeometryCollectionAdapter_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UEditableGeometryCollectionAdapter_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UEditableGeometryCollectionAdapter, 2045492943);
