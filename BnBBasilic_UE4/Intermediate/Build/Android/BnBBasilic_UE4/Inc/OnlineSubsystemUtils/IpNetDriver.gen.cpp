...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UIpNetDriver_Statics::NewProp_NbPacketsBetweenReceiveTimeTest = { "NbPacketsBetweenReceiveTimeTest", nullptr, (EPropertyFlags)0x0040000000004000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UIpNetDriver, NbPacketsBetweenReceiveTimeTest), METADATA_PARAMS(Z_Construct_UClass_UIpNetDriver_Statics::NewProp_NbPacketsBetweenReceiveTimeTest_MetaData, ARRAY_COUNT(Z_Construct_UClass_UIpNetDriver_Statics::NewProp_NbPacketsBetweenReceiveTimeTest_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FDoublePropertyParams Z_Construct_UClass_UIpNetDriver_Statics::NewProp_MaxSecondsInReceive = { "MaxSecondsInReceive", nullptr, (EPropertyFlags)0x0040000000004000, UE4CodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UIpNetDriver, MaxSecondsInReceive), METADATA_PARAMS(Z_Construct_UClass_UIpNetDriver_Statics::NewProp_MaxSecondsInReceive_MetaData, ARRAY_COUNT(Z_Construct_UClass_UIpNetDriver_Statics::NewProp_MaxSecondsInReceive_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FUInt32PropertyParams Z_Construct_UClass_UIpNetDriver_Statics::NewProp_ClientDesiredSocketSendBufferBytes = { "ClientDesiredSocketSendBufferBytes", nullptr, (EPropertyFlags)0x0040000000004000, UE4CodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UIpNetDriver, ClientDesiredSocketSendBufferBytes), METADATA_PARAMS(Z_Construct_UClass_UIpNetDriver_Statics::NewProp_ClientDesiredSocketSendBufferBytes_MetaData, ARRAY_COUNT(Z_Construct_UClass_UIpNetDriver_Statics::NewProp_ClientDesiredSocketSendBufferBytes_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FUInt32PropertyParams Z_Construct_UClass_UIpNetDriver_Statics::NewProp_ServerDesiredSocketSendBufferBytes = { "ServerDesiredSocketSendBufferBytes", nullptr, (EPropertyFlags)0x0040000000004000, UE4CodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UIpNetDriver, ServerDesiredSocketSendBufferBytes), METADATA_PARAMS(Z_Construct_UClass_UIpNetDriver_Statics::NewProp_ServerDesiredSocketSendBufferBytes_MetaData, ARRAY_COUNT(Z_Construct_UClass_UIpNetDriver_Statics::NewProp_ServerDesiredSocketSendBufferBytes_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FUInt32PropertyParams Z_Construct_UClass_UIpNetDriver_Statics::NewProp_ServerDesiredSocketReceiveBufferBytes = { "ServerDesiredSocketReceiveBufferBytes", nullptr, (EPropertyFlags)0x0040000000004000, UE4CodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UIpNetDriver, ServerDesiredSocketReceiveBufferBytes), METADATA_PARAMS(Z_Construct_UClass_UIpNetDriver_Statics::NewProp_ServerDesiredSocketReceiveBufferBytes_MetaData, ARRAY_COUNT(Z_Construct_UClass_UIpNetDriver_Statics::NewProp_ServerDesiredSocketReceiveBufferBytes_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FUInt32PropertyParams Z_Construct_UClass_UIpNetDriver_Statics::NewProp_MaxPortCountToTry = { "MaxPortCountToTry", nullptr, (EPropertyFlags)0x0010000000004000, UE4CodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UIpNetDriver, MaxPortCountToTry), METADATA_PARAMS(Z_Construct_UClass_UIpNetDriver_Statics::NewProp_MaxPortCountToTry_MetaData, ARRAY_COUNT(Z_Construct_UClass_UIpNetDriver_Statics::NewProp_MaxPortCountToTry_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UIpNetDriver_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UIpNetDriver_Statics::PropPointers),
		0,
		0x001000ACu,
		METADATA_PARAMS(Z_Construct_UClass_UIpNetDriver_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UIpNetDriver_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UIpNetDriver, 3950516521);
