...
// Cross Module References
	...
	ONLINESUBSYSTEMUTILS_API UFunction* Z_Construct_UFunction_AOnlineBeaconClient_ClientOnConnected();
...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_OnlineSubsystemUtils_EBeaconConnectionState_Hash() { return 1774403799U; }
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AOnlineBeaconClient_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AOnlineBeaconClient_ClientOnConnected, "ClientOnConnected" }, // 467328778
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_AOnlineBeaconClient_Statics::NewProp_ConnectionState = { "ConnectionState", nullptr, (EPropertyFlags)0x0020080000000000, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AOnlineBeaconClient, ConnectionState), Z_Construct_UEnum_OnlineSubsystemUtils_EBeaconConnectionState, METADATA_PARAMS(Z_Construct_UClass_AOnlineBeaconClient_Statics::NewProp_ConnectionState_MetaData, ARRAY_COUNT(Z_Construct_UClass_AOnlineBeaconClient_Statics::NewProp_ConnectionState_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AOnlineBeaconClient_Statics::ClassParams = {
		...
		ARRAY_COUNT(Z_Construct_UClass_AOnlineBeaconClient_Statics::PropPointers),
		0,
		0x009002ACu,
		METADATA_PARAMS(Z_Construct_UClass_AOnlineBeaconClient_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_AOnlineBeaconClient_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(AOnlineBeaconClient, 1854506763);
