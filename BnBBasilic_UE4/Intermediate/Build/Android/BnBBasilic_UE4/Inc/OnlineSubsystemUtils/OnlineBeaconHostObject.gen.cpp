...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AOnlineBeaconHostObject_Statics::NewProp_ClientActors = { "ClientActors", nullptr, (EPropertyFlags)0x0020080000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AOnlineBeaconHostObject, ClientActors), METADATA_PARAMS(Z_Construct_UClass_AOnlineBeaconHostObject_Statics::NewProp_ClientActors_MetaData, ARRAY_COUNT(Z_Construct_UClass_AOnlineBeaconHostObject_Statics::NewProp_ClientActors_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_AOnlineBeaconHostObject_Statics::NewProp_BeaconTypeName = { "BeaconTypeName", nullptr, (EPropertyFlags)0x0020080000002000, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AOnlineBeaconHostObject, BeaconTypeName), METADATA_PARAMS(Z_Construct_UClass_AOnlineBeaconHostObject_Statics::NewProp_BeaconTypeName_MetaData, ARRAY_COUNT(Z_Construct_UClass_AOnlineBeaconHostObject_Statics::NewProp_BeaconTypeName_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AOnlineBeaconHostObject_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_AOnlineBeaconHostObject_Statics::PropPointers),
		0,
		0x009002A8u,
		METADATA_PARAMS(Z_Construct_UClass_AOnlineBeaconHostObject_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_AOnlineBeaconHostObject_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(AOnlineBeaconHostObject, 102385501);
