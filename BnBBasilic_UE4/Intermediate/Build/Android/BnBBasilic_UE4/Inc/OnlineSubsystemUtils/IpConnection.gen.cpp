...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UIpConnection_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UIpConnection_Statics::PropPointers),
		0,
		0x001000ACu,
		METADATA_PARAMS(Z_Construct_UClass_UIpConnection_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UIpConnection_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UIpConnection, 3525330938);
