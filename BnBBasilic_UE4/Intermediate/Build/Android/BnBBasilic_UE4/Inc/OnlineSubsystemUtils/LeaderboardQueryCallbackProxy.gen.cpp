...
// Cross Module References
	...
	ONLINESUBSYSTEMUTILS_API UFunction* Z_Construct_UFunction_ULeaderboardQueryCallbackProxy_CreateProxyObjectForIntQuery();
...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ULeaderboardQueryCallbackProxy_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ULeaderboardQueryCallbackProxy_CreateProxyObjectForIntQuery, "CreateProxyObjectForIntQuery" }, // 4032018091
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_ULeaderboardQueryCallbackProxy_Statics::NewProp_OnSuccess = { "OnSuccess", nullptr, (EPropertyFlags)0x0010000010080000, UE4CodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULeaderboardQueryCallbackProxy, OnSuccess), Z_Construct_UDelegateFunction_OnlineSubsystemUtils_LeaderboardQueryResult__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_ULeaderboardQueryCallbackProxy_Statics::NewProp_OnSuccess_MetaData, ARRAY_COUNT(Z_Construct_UClass_ULeaderboardQueryCallbackProxy_Statics::NewProp_OnSuccess_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ULeaderboardQueryCallbackProxy_Statics::ClassParams = {
		...
		ARRAY_COUNT(Z_Construct_UClass_ULeaderboardQueryCallbackProxy_Statics::PropPointers),
		0,
		0x008800A0u,
		METADATA_PARAMS(Z_Construct_UClass_ULeaderboardQueryCallbackProxy_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_ULeaderboardQueryCallbackProxy_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(ULeaderboardQueryCallbackProxy, 1121693708);
