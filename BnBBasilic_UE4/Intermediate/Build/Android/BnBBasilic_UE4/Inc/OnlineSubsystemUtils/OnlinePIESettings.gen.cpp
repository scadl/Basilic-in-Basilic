...
static struct FScriptStruct_OnlineSubsystemUtils_StaticRegisterNativesFPIELoginSettingsInternal
{
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FPIELoginSettingsInternal_Statics::NewProp_TokenBytes = { "TokenBytes", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPIELoginSettingsInternal, TokenBytes), METADATA_PARAMS(Z_Construct_UScriptStruct_FPIELoginSettingsInternal_Statics::NewProp_TokenBytes_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FPIELoginSettingsInternal_Statics::NewProp_TokenBytes_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FPIELoginSettingsInternal_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FPIELoginSettingsInternal_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FPIELoginSettingsInternal_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FPIELoginSettingsInternal_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FPIELoginSettingsInternal_Hash() { return 2794693342U; }
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UOnlinePIESettings_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UOnlinePIESettings_Statics::PropPointers),
		0,
		0x000000A4u,
		METADATA_PARAMS(Z_Construct_UClass_UOnlinePIESettings_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UOnlinePIESettings_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UOnlinePIESettings, 1772179521);
