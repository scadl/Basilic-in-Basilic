...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ASpectatorBeaconHost_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_ASpectatorBeaconHost_Statics::PropPointers),
		0,
		0x009002ACu,
		METADATA_PARAMS(Z_Construct_UClass_ASpectatorBeaconHost_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_ASpectatorBeaconHost_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(ASpectatorBeaconHost, 3756846151);
