...
// Cross Module References
	...
	ONLINESUBSYSTEMUTILS_API UFunction* Z_Construct_UFunction_ASpectatorBeaconClient_ClientCancelReservationResponse();
	ONLINESUBSYSTEMUTILS_API UEnum* Z_Construct_UEnum_OnlineSubsystemUtils_ESpectatorReservationResult();
	ONLINESUBSYSTEMUTILS_API UFunction* Z_Construct_UFunction_ASpectatorBeaconClient_ClientReservationResponse();
	ONLINESUBSYSTEMUTILS_API UFunction* Z_Construct_UFunction_ASpectatorBeaconClient_ClientSendReservationFull();
	ONLINESUBSYSTEMUTILS_API UFunction* Z_Construct_UFunction_ASpectatorBeaconClient_ClientSendReservationUpdates();
	ONLINESUBSYSTEMUTILS_API UFunction* Z_Construct_UFunction_ASpectatorBeaconClient_ServerCancelReservationRequest();
	ENGINE_API UScriptStruct* Z_Construct_UScriptStruct_FUniqueNetIdRepl();
	ONLINESUBSYSTEMUTILS_API UFunction* Z_Construct_UFunction_ASpectatorBeaconClient_ServerReservationRequest();
...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_OnlineSubsystemUtils_ESpectatorClientRequestType_Hash() { return 1322280453U; }
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ASpectatorBeaconClient_ServerCancelReservationRequest_Statics::NewProp_Spectator = { "Spectator", nullptr, (EPropertyFlags)0x0010000008000082, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SpectatorBeaconClient_eventServerCancelReservationRequest_Parms, Spectator), Z_Construct_UScriptStruct_FUniqueNetIdRepl, METADATA_PARAMS(Z_Construct_UFunction_ASpectatorBeaconClient_ServerCancelReservationRequest_Statics::NewProp_Spectator_MetaData, ARRAY_COUNT(Z_Construct_UFunction_ASpectatorBeaconClient_ServerCancelReservationRequest_Statics::NewProp_Spectator_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ASpectatorBeaconClient_ServerReservationRequest_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ASpectatorBeaconClient, nullptr, "ServerReservationRequest", nullptr, nullptr, sizeof(SpectatorBeaconClient_eventServerReservationRequest_Parms), Z_Construct_UFunction_ASpectatorBeaconClient_ServerReservationRequest_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_ASpectatorBeaconClient_ServerReservationRequest_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x80280CC0, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ASpectatorBeaconClient_ServerReservationRequest_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_ASpectatorBeaconClient_ServerReservationRequest_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ASpectatorBeaconClient_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ASpectatorBeaconClient_ClientCancelReservationResponse, "ClientCancelReservationResponse" }, // 3411167154
		{ &Z_Construct_UFunction_ASpectatorBeaconClient_ClientReservationResponse, "ClientReservationResponse" }, // 1063060932
		{ &Z_Construct_UFunction_ASpectatorBeaconClient_ClientSendReservationFull, "ClientSendReservationFull" }, // 1410957870
		{ &Z_Construct_UFunction_ASpectatorBeaconClient_ClientSendReservationUpdates, "ClientSendReservationUpdates" }, // 1539114288
		{ &Z_Construct_UFunction_ASpectatorBeaconClient_ServerCancelReservationRequest, "ServerCancelReservationRequest" }, // 1134194643
		{ &Z_Construct_UFunction_ASpectatorBeaconClient_ServerReservationRequest, "ServerReservationRequest" }, // 1635350408
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ASpectatorBeaconClient_Statics::ClassParams = {
		...
		ARRAY_COUNT(Z_Construct_UClass_ASpectatorBeaconClient_Statics::PropPointers),
		0,
		0x009002ACu,
		METADATA_PARAMS(Z_Construct_UClass_ASpectatorBeaconClient_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_ASpectatorBeaconClient_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(ASpectatorBeaconClient, 4067267767);
