...
// Cross Module References
	...
	VARIANTMANAGERCONTENT_API UFunction* Z_Construct_UFunction_ALevelVariantSetsActor_GetLevelVariantSets();
	VARIANTMANAGERCONTENT_API UClass* Z_Construct_UClass_ULevelVariantSets_NoRegister();
	VARIANTMANAGERCONTENT_API UFunction* Z_Construct_UFunction_ALevelVariantSetsActor_SetLevelVariantSets();
	VARIANTMANAGERCONTENT_API UFunction* Z_Construct_UFunction_ALevelVariantSetsActor_SwitchOnVariantByIndex();
	VARIANTMANAGERCONTENT_API UFunction* Z_Construct_UFunction_ALevelVariantSetsActor_SwitchOnVariantByName();
...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ALevelVariantSetsActor_GetLevelVariantSets_Statics::NewProp_ReturnValue_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ALevelVariantSetsActor_GetLevelVariantSets_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000080588, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(LevelVariantSetsActor_eventGetLevelVariantSets_Parms, ReturnValue), Z_Construct_UClass_ULevelVariantSets_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_ALevelVariantSetsActor_GetLevelVariantSets_Statics::NewProp_ReturnValue_MetaData, ARRAY_COUNT(Z_Construct_UFunction_ALevelVariantSetsActor_GetLevelVariantSets_Statics::NewProp_ReturnValue_MetaData)) };
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_InVariantSets_MetaData[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ALevelVariantSetsActor_SetLevelVariantSets_Statics::NewProp_InVariantSets_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ALevelVariantSetsActor_SetLevelVariantSets_Statics::NewProp_InVariantSets = { "InVariantSets", nullptr, (EPropertyFlags)0x0010000000080080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(LevelVariantSetsActor_eventSetLevelVariantSets_Parms, InVariantSets), Z_Construct_UClass_ULevelVariantSets_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_ALevelVariantSetsActor_SetLevelVariantSets_Statics::NewProp_InVariantSets_MetaData, ARRAY_COUNT(Z_Construct_UFunction_ALevelVariantSetsActor_SetLevelVariantSets_Statics::NewProp_InVariantSets_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ALevelVariantSetsActor_SwitchOnVariantByName_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ALevelVariantSetsActor, nullptr, "SwitchOnVariantByName", nullptr, nullptr, sizeof(LevelVariantSetsActor_eventSwitchOnVariantByName_Parms), Z_Construct_UFunction_ALevelVariantSetsActor_SwitchOnVariantByName_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_ALevelVariantSetsActor_SwitchOnVariantByName_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ALevelVariantSetsActor_SwitchOnVariantByName_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_ALevelVariantSetsActor_SwitchOnVariantByName_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ALevelVariantSetsActor_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ALevelVariantSetsActor_GetLevelVariantSets, "GetLevelVariantSets" }, // 3475546305
		{ &Z_Construct_UFunction_ALevelVariantSetsActor_SetLevelVariantSets, "SetLevelVariantSets" }, // 3313599919
		{ &Z_Construct_UFunction_ALevelVariantSetsActor_SwitchOnVariantByIndex, "SwitchOnVariantByIndex" }, // 2582052995
		{ &Z_Construct_UFunction_ALevelVariantSetsActor_SwitchOnVariantByName, "SwitchOnVariantByName" }, // 1314706190
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ALevelVariantSetsActor_Statics::ClassParams = {
		...
		ARRAY_COUNT(Z_Construct_UClass_ALevelVariantSetsActor_Statics::PropPointers),
		0,
		0x009000A0u,
		METADATA_PARAMS(Z_Construct_UClass_ALevelVariantSetsActor_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_ALevelVariantSetsActor_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(ALevelVariantSetsActor, 2663034547);
