...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_APaperGroupedSpriteActor_Statics::NewProp_RenderComponent = { "RenderComponent", nullptr, (EPropertyFlags)0x00400000000a001d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(APaperGroupedSpriteActor, RenderComponent), Z_Construct_UClass_UPaperGroupedSpriteComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_APaperGroupedSpriteActor_Statics::NewProp_RenderComponent_MetaData, ARRAY_COUNT(Z_Construct_UClass_APaperGroupedSpriteActor_Statics::NewProp_RenderComponent_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_APaperGroupedSpriteActor_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_APaperGroupedSpriteActor_Statics::PropPointers),
		0,
		0x009000A0u,
		METADATA_PARAMS(Z_Construct_UClass_APaperGroupedSpriteActor_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_APaperGroupedSpriteActor_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(APaperGroupedSpriteActor, 893633946);
