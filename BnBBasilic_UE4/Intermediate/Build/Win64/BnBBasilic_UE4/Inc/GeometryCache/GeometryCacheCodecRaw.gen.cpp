...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UGeometryCacheCodecRaw_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UGeometryCacheCodecRaw_Statics::PropPointers),
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UGeometryCacheCodecRaw_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UGeometryCacheCodecRaw_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UGeometryCacheCodecRaw, 1115215273);
