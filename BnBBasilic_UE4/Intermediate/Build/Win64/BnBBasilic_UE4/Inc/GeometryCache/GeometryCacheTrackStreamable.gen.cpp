...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UGeometryCacheTrackStreamable_Statics::NewProp_Codec = { "Codec", nullptr, (EPropertyFlags)0x0010000000020001, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGeometryCacheTrackStreamable, Codec), Z_Construct_UClass_UGeometryCacheCodecBase_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UGeometryCacheTrackStreamable_Statics::NewProp_Codec_MetaData, ARRAY_COUNT(Z_Construct_UClass_UGeometryCacheTrackStreamable_Statics::NewProp_Codec_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UGeometryCacheTrackStreamable_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UGeometryCacheTrackStreamable_Statics::PropPointers),
		0,
		0x001020A0u,
		METADATA_PARAMS(Z_Construct_UClass_UGeometryCacheTrackStreamable_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UGeometryCacheTrackStreamable_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UGeometryCacheTrackStreamable, 2991153932);
