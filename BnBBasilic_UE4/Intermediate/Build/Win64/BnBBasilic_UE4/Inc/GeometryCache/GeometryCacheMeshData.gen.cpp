...
static struct FScriptStruct_GeometryCache_StaticRegisterNativesFGeometryCacheMeshData
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FGeometryCacheMeshData_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(Z_Construct_UScriptStruct_FGeometryCacheMeshData_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FGeometryCacheMeshData_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FGeometryCacheMeshData_Hash() { return 2650274477U; }
...
static struct FScriptStruct_GeometryCache_StaticRegisterNativesFGeometryCacheVertexInfo
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FGeometryCacheVertexInfo_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(Z_Construct_UScriptStruct_FGeometryCacheVertexInfo_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FGeometryCacheVertexInfo_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FGeometryCacheVertexInfo_Hash() { return 3628108650U; }
...
static struct FScriptStruct_GeometryCache_StaticRegisterNativesFGeometryCacheMeshBatchInfo
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FGeometryCacheMeshBatchInfo_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FGeometryCacheMeshBatchInfo_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FGeometryCacheMeshBatchInfo_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FGeometryCacheMeshBatchInfo_Hash() { return 2407704263U; }
