...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UGeometryCache_Statics::NewProp_EndFrame = { "EndFrame", nullptr, (EPropertyFlags)0x0020080000000014, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGeometryCache, EndFrame), METADATA_PARAMS(Z_Construct_UClass_UGeometryCache_Statics::NewProp_EndFrame_MetaData, ARRAY_COUNT(Z_Construct_UClass_UGeometryCache_Statics::NewProp_EndFrame_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UGeometryCache_Statics::NewProp_StartFrame = { "StartFrame", nullptr, (EPropertyFlags)0x0020080000000014, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGeometryCache, StartFrame), METADATA_PARAMS(Z_Construct_UClass_UGeometryCache_Statics::NewProp_StartFrame_MetaData, ARRAY_COUNT(Z_Construct_UClass_UGeometryCache_Statics::NewProp_StartFrame_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UGeometryCache_Statics::NewProp_Tracks = { "Tracks", nullptr, (EPropertyFlags)0x0010000000020001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGeometryCache, Tracks), METADATA_PARAMS(Z_Construct_UClass_UGeometryCache_Statics::NewProp_Tracks_MetaData, ARRAY_COUNT(Z_Construct_UClass_UGeometryCache_Statics::NewProp_Tracks_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UGeometryCache_Statics::NewProp_Materials = { "Materials", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGeometryCache, Materials), METADATA_PARAMS(Z_Construct_UClass_UGeometryCache_Statics::NewProp_Materials_MetaData, ARRAY_COUNT(Z_Construct_UClass_UGeometryCache_Statics::NewProp_Materials_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UGeometryCache_Statics::NewProp_ThumbnailInfo = { "ThumbnailInfo", nullptr, (EPropertyFlags)0x00120008000a0009, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGeometryCache, ThumbnailInfo), Z_Construct_UClass_UThumbnailInfo_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UGeometryCache_Statics::NewProp_ThumbnailInfo_MetaData, ARRAY_COUNT(Z_Construct_UClass_UGeometryCache_Statics::NewProp_ThumbnailInfo_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UGeometryCache_Statics::NewProp_AssetImportData = { "AssetImportData", nullptr, (EPropertyFlags)0x00120008000a0009, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGeometryCache, AssetImportData), Z_Construct_UClass_UAssetImportData_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UGeometryCache_Statics::NewProp_AssetImportData_MetaData, ARRAY_COUNT(Z_Construct_UClass_UGeometryCache_Statics::NewProp_AssetImportData_MetaData)) };
#endif // WITH_EDITORONLY_DATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UGeometryCache_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UGeometryCache_Statics::PropPointers),
		ARRAY_COUNT(InterfaceParams),
		0x009000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UGeometryCache_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UGeometryCache_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UGeometryCache, 2464750264);
