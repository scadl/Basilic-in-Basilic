...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UGeometryCacheTrack_Statics::NewProp_Duration = { "Duration", nullptr, (EPropertyFlags)0x0020080000020001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGeometryCacheTrack, Duration), METADATA_PARAMS(Z_Construct_UClass_UGeometryCacheTrack_Statics::NewProp_Duration_MetaData, ARRAY_COUNT(Z_Construct_UClass_UGeometryCacheTrack_Statics::NewProp_Duration_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UGeometryCacheTrack_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UGeometryCacheTrack_Statics::PropPointers),
		0,
		0x000020A0u,
		METADATA_PARAMS(Z_Construct_UClass_UGeometryCacheTrack_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UGeometryCacheTrack_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UGeometryCacheTrack, 3474108912);
