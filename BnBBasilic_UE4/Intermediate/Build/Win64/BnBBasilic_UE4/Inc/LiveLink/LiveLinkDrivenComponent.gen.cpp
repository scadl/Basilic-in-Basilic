...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UDEPRECATED_LiveLinkDrivenComponent_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_LiveLinkDrivenComponent_Statics::PropPointers),
		0,
		0x02B002A4u,
		METADATA_PARAMS(Z_Construct_UClass_UDEPRECATED_LiveLinkDrivenComponent_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_LiveLinkDrivenComponent_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UDEPRECATED_LiveLinkDrivenComponent, 1481932029);
