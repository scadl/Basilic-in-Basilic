...
// Cross Module References
	...
	LIVELINK_API UFunction* Z_Construct_UFunction_ULiveLinkMessageBusFinder_ConnectToProvider();
	LIVELINKINTERFACE_API UScriptStruct* Z_Construct_UScriptStruct_FLiveLinkSourceHandle();
	LIVELINK_API UFunction* Z_Construct_UFunction_ULiveLinkMessageBusFinder_ConstructMessageBusFinder();
	LIVELINK_API UFunction* Z_Construct_UFunction_ULiveLinkMessageBusFinder_GetAvailableProviders();
...
static struct FScriptStruct_LiveLink_StaticRegisterNativesFProviderPollResult
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("ProviderPollResult")),new UScriptStruct::TCppStructOps<FProviderPollResult>);
	}
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FProviderPollResult_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FProviderPollResult, Name), METADATA_PARAMS(Z_Construct_UScriptStruct_FProviderPollResult_Statics::NewProp_Name_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FProviderPollResult_Statics::NewProp_Name_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FProviderPollResult_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FProviderPollResult_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FProviderPollResult_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FProviderPollResult_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FProviderPollResult_Hash() { return 2154885126U; }
	...
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_ULiveLinkMessageBusFinder_GetAvailableProviders_Statics::NewProp_AvailableProviders = { "AvailableProviders", nullptr, (EPropertyFlags)0x0010000000000180, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(LiveLinkMessageBusFinder_eventGetAvailableProviders_Parms, AvailableProviders), METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ULiveLinkMessageBusFinder_GetAvailableProviders_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULiveLinkMessageBusFinder, nullptr, "GetAvailableProviders", nullptr, nullptr, sizeof(LiveLinkMessageBusFinder_eventGetAvailableProviders_Parms), Z_Construct_UFunction_ULiveLinkMessageBusFinder_GetAvailableProviders_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_ULiveLinkMessageBusFinder_GetAvailableProviders_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ULiveLinkMessageBusFinder_GetAvailableProviders_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_ULiveLinkMessageBusFinder_GetAvailableProviders_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ULiveLinkMessageBusFinder_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ULiveLinkMessageBusFinder_ConnectToProvider, "ConnectToProvider" }, // 3617894537
		{ &Z_Construct_UFunction_ULiveLinkMessageBusFinder_ConstructMessageBusFinder, "ConstructMessageBusFinder" }, // 2873101481
		{ &Z_Construct_UFunction_ULiveLinkMessageBusFinder_GetAvailableProviders, "GetAvailableProviders" }, // 4216746275
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ULiveLinkMessageBusFinder_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_ULiveLinkMessageBusFinder_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_ULiveLinkMessageBusFinder_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(ULiveLinkMessageBusFinder, 855004041);
