...
static struct FScriptStruct_LiveLink_StaticRegisterNativesFLiveLinkRetargetAssetReference
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("LiveLinkRetargetAssetReference")),new UScriptStruct::TCppStructOps<FLiveLinkRetargetAssetReference>);
	}
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FLiveLinkRetargetAssetReference_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(Z_Construct_UScriptStruct_FLiveLinkRetargetAssetReference_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FLiveLinkRetargetAssetReference_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FLiveLinkRetargetAssetReference_Hash() { return 3335621547U; }
