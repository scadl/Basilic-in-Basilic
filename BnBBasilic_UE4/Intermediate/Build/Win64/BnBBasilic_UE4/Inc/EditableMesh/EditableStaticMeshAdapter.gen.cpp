...
// Cross Module References
	...
	EDITABLEMESH_API UScriptStruct* Z_Construct_UScriptStruct_FTriangleID();
...
static struct FScriptStruct_EditableMesh_StaticRegisterNativesFRenderingPolygonGroup
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FRenderingPolygonGroup_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FRenderingPolygonGroup_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FRenderingPolygonGroup_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FRenderingPolygonGroup_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FRenderingPolygonGroup_Hash() { return 2299729372U; }
...
static struct FScriptStruct_EditableMesh_StaticRegisterNativesFRenderingPolygon
{
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FRenderingPolygon_Statics::NewProp_TriangulatedPolygonTriangleIndices = { "TriangulatedPolygonTriangleIndices", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRenderingPolygon, TriangulatedPolygonTriangleIndices), METADATA_PARAMS(Z_Construct_UScriptStruct_FRenderingPolygon_Statics::NewProp_TriangulatedPolygonTriangleIndices_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FRenderingPolygon_Statics::NewProp_TriangulatedPolygonTriangleIndices_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FRenderingPolygon_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FRenderingPolygon_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FRenderingPolygon_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FRenderingPolygon_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FRenderingPolygon_Hash() { return 2796334439U; }
class UScriptStruct* FTriangleID::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern EDITABLEMESH_API uint32 Get_Z_Construct_UScriptStruct_FTriangleID_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FTriangleID, Z_Construct_UPackage__Script_EditableMesh(), TEXT("TriangleID"), sizeof(FTriangleID), Get_Z_Construct_UScriptStruct_FTriangleID_Hash());
	}
	return Singleton;
}
template<> EDITABLEMESH_API UScriptStruct* StaticStruct<FTriangleID>()
{
	return FTriangleID::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FTriangleID(FTriangleID::StaticStruct, TEXT("/Script/EditableMesh"), TEXT("TriangleID"), false, nullptr, nullptr);
static struct FScriptStruct_EditableMesh_StaticRegisterNativesFTriangleID
{
	FScriptStruct_EditableMesh_StaticRegisterNativesFTriangleID()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("TriangleID")),new UScriptStruct::TCppStructOps<FTriangleID>);
	}
} ScriptStruct_EditableMesh_StaticRegisterNativesFTriangleID;
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FTriangleID_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FTriangleID_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FTriangleID_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FTriangleID_Hash() { return 222332249U; }
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UEditableStaticMeshAdapter_Statics::NewProp_StaticMesh = { "StaticMesh", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEditableStaticMeshAdapter, StaticMesh), Z_Construct_UClass_UStaticMesh_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UEditableStaticMeshAdapter_Statics::NewProp_StaticMesh_MetaData, ARRAY_COUNT(Z_Construct_UClass_UEditableStaticMeshAdapter_Statics::NewProp_StaticMesh_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UEditableStaticMeshAdapter_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UEditableStaticMeshAdapter_Statics::PropPointers),
		0,
		0x000800A0u,
		METADATA_PARAMS(Z_Construct_UClass_UEditableStaticMeshAdapter_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UEditableStaticMeshAdapter_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UEditableStaticMeshAdapter, 4243743111);
