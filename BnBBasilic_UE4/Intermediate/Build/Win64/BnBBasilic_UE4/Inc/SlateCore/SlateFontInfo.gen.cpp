...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_SlateCore_EFontFallback_Hash() { return 1617859063U; }
	UEnum* Z_Construct_UEnum_SlateCore_EFontFallback()
	{
		...
		if (!ReturnEnum)
		{
			...
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "FF_LastResortFallback.Comment", "/** Fallback to last resort font set */" },
				{ "FF_LastResortFallback.Name", "EFontFallback::FF_LastResortFallback" },
				{ "FF_LastResortFallback.ToolTip", "Fallback to last resort font set" },
				{ "FF_LocalizedFallback.Comment", "/** Fallback to localized font set */" },
				{ "FF_LocalizedFallback.Name", "EFontFallback::FF_LocalizedFallback" },
				{ "FF_LocalizedFallback.ToolTip", "Fallback to localized font set" },
				{ "FF_Max.Comment", "/** Tries all fallbacks */" },
				{ "FF_Max.Name", "EFontFallback::FF_Max" },
				{ "FF_Max.ToolTip", "Tries all fallbacks" },
				{ "FF_NoFallback.Comment", "/** No fallback font */" },
				{ "FF_NoFallback.Name", "EFontFallback::FF_NoFallback" },
...
static struct FScriptStruct_SlateCore_StaticRegisterNativesFSlateFontInfo
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FSlateFontInfo_Hash() { return 1053738511U; }
...
static struct FScriptStruct_SlateCore_StaticRegisterNativesFFontOutlineSettings
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FFontOutlineSettings_Hash() { return 181626777U; }
