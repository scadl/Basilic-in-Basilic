...
static struct FScriptStruct_ChaosSolverEngine_StaticRegisterNativesFChaosHandlerSet
{
...
#endif
	const UE4CodeGen_Private::FSetPropertyParams Z_Construct_UScriptStruct_FChaosHandlerSet_Statics::NewProp_ChaosHandlers = { "ChaosHandlers", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Set, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FChaosHandlerSet, ChaosHandlers), METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosHandlerSet_Statics::NewProp_ChaosHandlers_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosHandlerSet_Statics::NewProp_ChaosHandlers_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FChaosHandlerSet_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosHandlerSet_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosHandlerSet_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosHandlerSet_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FChaosHandlerSet_Hash() { return 1010857647U; }
...
static struct FScriptStruct_ChaosSolverEngine_StaticRegisterNativesFBreakEventCallbackWrapper
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FBreakEventCallbackWrapper_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(Z_Construct_UScriptStruct_FBreakEventCallbackWrapper_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FBreakEventCallbackWrapper_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FBreakEventCallbackWrapper_Hash() { return 319696492U; }
...
static struct FScriptStruct_ChaosSolverEngine_StaticRegisterNativesFChaosBreakEvent
{
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FChaosBreakEvent_Statics::NewProp_Velocity = { "Velocity", nullptr, (EPropertyFlags)0x0010000000000014, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FChaosBreakEvent, Velocity), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosBreakEvent_Statics::NewProp_Velocity_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosBreakEvent_Statics::NewProp_Velocity_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FChaosBreakEvent_Statics::NewProp_Location = { "Location", nullptr, (EPropertyFlags)0x0010000000000014, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FChaosBreakEvent, Location), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosBreakEvent_Statics::NewProp_Location_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosBreakEvent_Statics::NewProp_Location_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FChaosBreakEvent_Statics::NewProp_Component = { "Component", nullptr, (EPropertyFlags)0x001000000008001c, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FChaosBreakEvent, Component), Z_Construct_UClass_UPrimitiveComponent_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosBreakEvent_Statics::NewProp_Component_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosBreakEvent_Statics::NewProp_Component_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FChaosBreakEvent_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosBreakEvent_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000205),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosBreakEvent_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosBreakEvent_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FChaosBreakEvent_Hash() { return 1764821493U; }
...
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UClass_UChaosGameplayEventDispatcher_Statics::NewProp_BreakEventRegistrations = { "BreakEventRegistrations", nullptr, (EPropertyFlags)0x0040008000000000, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UChaosGameplayEventDispatcher, BreakEventRegistrations), METADATA_PARAMS(Z_Construct_UClass_UChaosGameplayEventDispatcher_Statics::NewProp_BreakEventRegistrations_MetaData, ARRAY_COUNT(Z_Construct_UClass_UChaosGameplayEventDispatcher_Statics::NewProp_BreakEventRegistrations_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UClass_UChaosGameplayEventDispatcher_Statics::NewProp_CollisionEventRegistrations = { "CollisionEventRegistrations", nullptr, (EPropertyFlags)0x0040008000000000, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UChaosGameplayEventDispatcher, CollisionEventRegistrations), METADATA_PARAMS(Z_Construct_UClass_UChaosGameplayEventDispatcher_Statics::NewProp_CollisionEventRegistrations_MetaData, ARRAY_COUNT(Z_Construct_UClass_UChaosGameplayEventDispatcher_Statics::NewProp_CollisionEventRegistrations_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UChaosGameplayEventDispatcher_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UChaosGameplayEventDispatcher_Statics::PropPointers),
		0,
		0x00B000A4u,
		METADATA_PARAMS(Z_Construct_UClass_UChaosGameplayEventDispatcher_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UChaosGameplayEventDispatcher_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UChaosGameplayEventDispatcher, 90541797);
