...
// Cross Module References
	...
	CHAOSSOLVERENGINE_API UFunction* Z_Construct_UFunction_AChaosSolverActor_SetAsCurrentWorldSolver();
	CHAOSSOLVERENGINE_API UFunction* Z_Construct_UFunction_AChaosSolverActor_SetSolverActive();
...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_ChaosSolverEngine_EClusterConnectionTypeEnum_Hash() { return 2088159712U; }
...
static struct FScriptStruct_ChaosSolverEngine_StaticRegisterNativesFChaosDebugSubstepControl
{
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FChaosDebugSubstepControl_Statics::NewProp_bStep = { "bStep", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FChaosDebugSubstepControl), &Z_Construct_UScriptStruct_FChaosDebugSubstepControl_Statics::NewProp_bStep_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosDebugSubstepControl_Statics::NewProp_bStep_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosDebugSubstepControl_Statics::NewProp_bStep_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FChaosDebugSubstepControl_Statics::NewProp_bSubstep = { "bSubstep", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FChaosDebugSubstepControl), &Z_Construct_UScriptStruct_FChaosDebugSubstepControl_Statics::NewProp_bSubstep_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosDebugSubstepControl_Statics::NewProp_bSubstep_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosDebugSubstepControl_Statics::NewProp_bSubstep_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FChaosDebugSubstepControl_Statics::NewProp_bPause = { "bPause", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FChaosDebugSubstepControl), &Z_Construct_UScriptStruct_FChaosDebugSubstepControl_Statics::NewProp_bPause_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosDebugSubstepControl_Statics::NewProp_bPause_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosDebugSubstepControl_Statics::NewProp_bPause_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FChaosDebugSubstepControl_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosDebugSubstepControl_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosDebugSubstepControl_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosDebugSubstepControl_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FChaosDebugSubstepControl_Hash() { return 916971029U; }
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AChaosSolverActor_SetSolverActive_Statics::Function_MetaDataParams[] = {
		{ "Category", "ChaosPhysics" },
		{ "Comment", "/** Controles whether the solver is able to simulate particles it controls */" },
		{ "ModuleRelativePath", "Public/Chaos/ChaosSolverActor.h" },
		{ "ToolTip", "Controles whether the solver is able to simulate particles it controls" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AChaosSolverActor_SetSolverActive_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AChaosSolverActor, nullptr, "SetSolverActive", nullptr, nullptr, sizeof(ChaosSolverActor_eventSetSolverActive_Parms), Z_Construct_UFunction_AChaosSolverActor_SetSolverActive_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AChaosSolverActor_SetSolverActive_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020400, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AChaosSolverActor_SetSolverActive_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AChaosSolverActor_SetSolverActive_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AChaosSolverActor_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AChaosSolverActor_SetAsCurrentWorldSolver, "SetAsCurrentWorldSolver" }, // 3308820940
		{ &Z_Construct_UFunction_AChaosSolverActor_SetSolverActive, "SetSolverActive" }, // 4257910205
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_AChaosSolverActor_Statics::NewProp_TrailingFilterSettings = { "TrailingFilterSettings", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AChaosSolverActor, TrailingFilterSettings), Z_Construct_UScriptStruct_FSolverTrailingFilterSettings, METADATA_PARAMS(Z_Construct_UClass_AChaosSolverActor_Statics::NewProp_TrailingFilterSettings_MetaData, ARRAY_COUNT(Z_Construct_UClass_AChaosSolverActor_Statics::NewProp_TrailingFilterSettings_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AChaosSolverActor_Statics::NewProp_DoGenerateTrailingData = { "DoGenerateTrailingData", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AChaosSolverActor), &Z_Construct_UClass_AChaosSolverActor_Statics::NewProp_DoGenerateTrailingData_SetBit, METADATA_PARAMS(Z_Construct_UClass_AChaosSolverActor_Statics::NewProp_DoGenerateTrailingData_MetaData, ARRAY_COUNT(Z_Construct_UClass_AChaosSolverActor_Statics::NewProp_DoGenerateTrailingData_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AChaosSolverActor_Statics::NewProp_DoGenerateCollisionData = { "DoGenerateCollisionData", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AChaosSolverActor), &Z_Construct_UClass_AChaosSolverActor_Statics::NewProp_DoGenerateCollisionData_SetBit, METADATA_PARAMS(Z_Construct_UClass_AChaosSolverActor_Statics::NewProp_DoGenerateCollisionData_MetaData, ARRAY_COUNT(Z_Construct_UClass_AChaosSolverActor_Statics::NewProp_DoGenerateCollisionData_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_AChaosSolverActor_Statics::NewProp_ClusterUnionConnectionType = { "ClusterUnionConnectionType", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AChaosSolverActor, ClusterUnionConnectionType), Z_Construct_UEnum_ChaosSolverEngine_EClusterConnectionTypeEnum, METADATA_PARAMS(Z_Construct_UClass_AChaosSolverActor_Statics::NewProp_ClusterUnionConnectionType_MetaData, ARRAY_COUNT(Z_Construct_UClass_AChaosSolverActor_Statics::NewProp_ClusterUnionConnectionType_MetaData)) };
	...
	IMPLEMENT_CLASS(AChaosSolverActor, 240480397);
