...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UActorSequence_Statics::NewProp_ObjectReferences = { "ObjectReferences", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UActorSequence, ObjectReferences), Z_Construct_UScriptStruct_FActorSequenceObjectReferenceMap, METADATA_PARAMS(Z_Construct_UClass_UActorSequence_Statics::NewProp_ObjectReferences_MetaData, ARRAY_COUNT(Z_Construct_UClass_UActorSequence_Statics::NewProp_ObjectReferences_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UActorSequence_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UActorSequence_Statics::PropPointers),
		0,
		0x00B000A4u,
		METADATA_PARAMS(Z_Construct_UClass_UActorSequence_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UActorSequence_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UActorSequence, 2920408327);
