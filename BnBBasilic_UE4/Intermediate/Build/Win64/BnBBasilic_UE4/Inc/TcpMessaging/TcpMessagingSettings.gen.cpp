...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_ConnectionRetryDelay = { "ConnectionRetryDelay", nullptr, (EPropertyFlags)0x0040000000004001, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UTcpMessagingSettings, ConnectionRetryDelay), METADATA_PARAMS(Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_ConnectionRetryDelay_MetaData, ARRAY_COUNT(Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_ConnectionRetryDelay_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_ConnectToEndpoints = { "ConnectToEndpoints", nullptr, (EPropertyFlags)0x0040000000004001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UTcpMessagingSettings, ConnectToEndpoints), METADATA_PARAMS(Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_ConnectToEndpoints_MetaData, ARRAY_COUNT(Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_ConnectToEndpoints_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_ListenEndpoint = { "ListenEndpoint", nullptr, (EPropertyFlags)0x0040000000004001, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UTcpMessagingSettings, ListenEndpoint), METADATA_PARAMS(Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_ListenEndpoint_MetaData, ARRAY_COUNT(Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_ListenEndpoint_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UTcpMessagingSettings_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UTcpMessagingSettings_Statics::PropPointers),
		0,
		0x000000A4u,
		METADATA_PARAMS(Z_Construct_UClass_UTcpMessagingSettings_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UTcpMessagingSettings_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UTcpMessagingSettings, 883129405);
