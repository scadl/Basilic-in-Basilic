...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAnimationSharingSetup_Statics::NewProp_ScalabilitySettings = { "ScalabilitySettings", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimationSharingSetup, ScalabilitySettings), Z_Construct_UScriptStruct_FAnimationSharingScalability, METADATA_PARAMS(Z_Construct_UClass_UAnimationSharingSetup_Statics::NewProp_ScalabilitySettings_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAnimationSharingSetup_Statics::NewProp_ScalabilitySettings_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAnimationSharingSetup_Statics::NewProp_SkeletonSetups = { "SkeletonSetups", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimationSharingSetup, SkeletonSetups), METADATA_PARAMS(Z_Construct_UClass_UAnimationSharingSetup_Statics::NewProp_SkeletonSetups_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAnimationSharingSetup_Statics::NewProp_SkeletonSetups_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAnimationSharingSetup_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UAnimationSharingSetup_Statics::PropPointers),
		0,
		0x001000A4u,
	...
	IMPLEMENT_CLASS(UAnimationSharingSetup, 1774258066);
