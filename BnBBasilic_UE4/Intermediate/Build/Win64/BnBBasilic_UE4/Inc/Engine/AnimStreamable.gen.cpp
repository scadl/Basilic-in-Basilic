...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAnimStreamable_Statics::NewProp_AnimationTrackNames = { "AnimationTrackNames", nullptr, (EPropertyFlags)0x0010000800000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimStreamable, AnimationTrackNames), METADATA_PARAMS(Z_Construct_UClass_UAnimStreamable_Statics::NewProp_AnimationTrackNames_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAnimStreamable_Statics::NewProp_AnimationTrackNames_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAnimStreamable_Statics::NewProp_TrackToSkeletonMapTable = { "TrackToSkeletonMapTable", nullptr, (EPropertyFlags)0x0010000800000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimStreamable, TrackToSkeletonMapTable), METADATA_PARAMS(Z_Construct_UClass_UAnimStreamable_Statics::NewProp_TrackToSkeletonMapTable_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAnimStreamable_Statics::NewProp_TrackToSkeletonMapTable_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAnimStreamable_Statics::NewProp_RawAnimationData = { "RawAnimationData", nullptr, (EPropertyFlags)0x0010000800000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimStreamable, RawAnimationData), METADATA_PARAMS(Z_Construct_UClass_UAnimStreamable_Statics::NewProp_RawAnimationData_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAnimStreamable_Statics::NewProp_RawAnimationData_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAnimStreamable_Statics::NewProp_RawDataGuid = { "RawDataGuid", nullptr, (EPropertyFlags)0x0010000800000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimStreamable, RawDataGuid), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(Z_Construct_UClass_UAnimStreamable_Statics::NewProp_RawDataGuid_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAnimStreamable_Statics::NewProp_RawDataGuid_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAnimStreamable_Statics::NewProp_CompressionScheme_MetaData[] = {
		{ "Category", "Compression" },
		{ "Comment", "/**\n\x09 * The compression scheme that was most recently used to compress this animation.\n\x09 */" },
		{ "ModuleRelativePath", "Classes/Animation/AnimStreamable.h" },
		{ "ToolTip", "The compression scheme that was most recently used to compress this animation." },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UAnimStreamable_Statics::NewProp_CompressionScheme = { "CompressionScheme", nullptr, (EPropertyFlags)0x0010000800020001, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimStreamable, CompressionScheme), Z_Construct_UClass_UAnimCompress_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UAnimStreamable_Statics::NewProp_CompressionScheme_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAnimStreamable_Statics::NewProp_CompressionScheme_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UAnimStreamable_Statics::NewProp_SourceSequence = { "SourceSequence", nullptr, (EPropertyFlags)0x0010000800000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimStreamable, SourceSequence), Z_Construct_UClass_UAnimSequence_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UAnimStreamable_Statics::NewProp_SourceSequence_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAnimStreamable_Statics::NewProp_SourceSequence_MetaData)) };
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UClass_UAnimStreamable_Statics::NewProp_RetargetSource = { "RetargetSource", nullptr, (EPropertyFlags)0x0010010000000001, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimStreamable, RetargetSource), METADATA_PARAMS(Z_Construct_UClass_UAnimStreamable_Statics::NewProp_RetargetSource_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAnimStreamable_Statics::NewProp_RetargetSource_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UAnimStreamable_Statics::NewProp_NumFrames = { "NumFrames", nullptr, (EPropertyFlags)0x0010010000000000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimStreamable, NumFrames), METADATA_PARAMS(Z_Construct_UClass_UAnimStreamable_Statics::NewProp_NumFrames_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAnimStreamable_Statics::NewProp_NumFrames_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UAnimStreamable_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAnimStreamable_Statics::NewProp_CompressionScheme,
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAnimStreamable_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UAnimStreamable_Statics::PropPointers),
		0,
		0x008800A0u,
		METADATA_PARAMS(Z_Construct_UClass_UAnimStreamable_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UAnimStreamable_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UAnimStreamable, 3871985518);
