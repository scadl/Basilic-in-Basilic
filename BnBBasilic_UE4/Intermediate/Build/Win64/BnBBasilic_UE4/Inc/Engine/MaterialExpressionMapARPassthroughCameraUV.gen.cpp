...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMaterialExpressionMapARPassthroughCameraUV_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionMapARPassthroughCameraUV_Statics::PropPointers),
		0,
		0x000020A0u,
		METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionMapARPassthroughCameraUV_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionMapARPassthroughCameraUV_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UMaterialExpressionMapARPassthroughCameraUV, 3566639632);
