...
static struct FScriptStruct_Engine_StaticRegisterNativesFStreamingTextureBuildInfo
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FStreamingTextureBuildInfo_Hash() { return 1553458239U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFStreamingRenderAssetPrimitiveInfo
{
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FStreamingRenderAssetPrimitiveInfo_Statics::NewProp_bAllowInvalidTexelFactorWhenUnregistered = { "bAllowInvalidTexelFactorWhenUnregistered", nullptr, (EPropertyFlags)0x0010000000002000, UE4CodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(FStreamingRenderAssetPrimitiveInfo), &Z_Construct_UScriptStruct_FStreamingRenderAssetPrimitiveInfo_Statics::NewProp_bAllowInvalidTexelFactorWhenUnregistered_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FStreamingRenderAssetPrimitiveInfo_Statics::NewProp_bAllowInvalidTexelFactorWhenUnregistered_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FStreamingRenderAssetPrimitiveInfo_Statics::NewProp_bAllowInvalidTexelFactorWhenUnregistered_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FStreamingRenderAssetPrimitiveInfo_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FStreamingRenderAssetPrimitiveInfo_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FStreamingRenderAssetPrimitiveInfo_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FStreamingRenderAssetPrimitiveInfo_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FStreamingRenderAssetPrimitiveInfo_Hash() { return 3943499969U; }
