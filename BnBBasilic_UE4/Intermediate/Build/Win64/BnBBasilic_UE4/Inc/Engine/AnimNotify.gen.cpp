...
static struct FScriptStruct_Engine_StaticRegisterNativesFBranchingPointNotifyPayload
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAnimNotify_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAnimNotify_GetNotifyName, "GetNotifyName" }, // 3584998169
		{ &Z_Construct_UFunction_UAnimNotify_Received_Notify, "Received_Notify" }, // 3159456339
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UAnimNotify, 2451551739);
