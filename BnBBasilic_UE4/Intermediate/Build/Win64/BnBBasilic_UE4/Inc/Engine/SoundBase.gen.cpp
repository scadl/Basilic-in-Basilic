...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_EVirtualizationMode_Hash() { return 3368520437U; }
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USoundBase_Statics::NewProp_SoundSubmixObject_MetaData[] = {
		{ "Category", "Effects" },
		{ "Comment", "/** Sound submix this sound belongs to.\n\x09  * Audio will play here and traverse through the submix graph.\n\x09  * A null entry will make the sound obey the default master effects graph.\n\x09  */" },
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_USoundBase_Statics::NewProp_Modulation = { "Modulation", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USoundBase, Modulation), Z_Construct_UScriptStruct_FSoundModulation, METADATA_PARAMS(Z_Construct_UClass_USoundBase_Statics::NewProp_Modulation_MetaData, ARRAY_COUNT(Z_Construct_UClass_USoundBase_Statics::NewProp_Modulation_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_USoundBase_Statics::NewProp_VirtualizationMode = { "VirtualizationMode", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USoundBase, VirtualizationMode), Z_Construct_UEnum_Engine_EVirtualizationMode, METADATA_PARAMS(Z_Construct_UClass_USoundBase_Statics::NewProp_VirtualizationMode_MetaData, ARRAY_COUNT(Z_Construct_UClass_USoundBase_Statics::NewProp_VirtualizationMode_MetaData)) };
	...
	IMPLEMENT_CLASS(USoundBase, 2372980223);
