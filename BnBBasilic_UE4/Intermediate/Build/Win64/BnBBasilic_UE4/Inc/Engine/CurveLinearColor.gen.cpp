...
static struct FScriptStruct_Engine_StaticRegisterNativesFRuntimeCurveLinearColor
{
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UCurveLinearColor_GetLinearColorValue_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCurveLinearColor, nullptr, "GetLinearColorValue", nullptr, nullptr, sizeof(CurveLinearColor_eventGetLinearColorValue_Parms), Z_Construct_UFunction_UCurveLinearColor_GetLinearColorValue_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UCurveLinearColor_GetLinearColorValue_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54820400, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UCurveLinearColor_GetLinearColorValue_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UCurveLinearColor_GetLinearColorValue_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCurveLinearColor_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UCurveLinearColor_GetClampedLinearColorValue, "GetClampedLinearColorValue" }, // 3425366911
		{ &Z_Construct_UFunction_UCurveLinearColor_GetLinearColorValue, "GetLinearColorValue" }, // 1901366484
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UCurveLinearColor, 3440142241);
