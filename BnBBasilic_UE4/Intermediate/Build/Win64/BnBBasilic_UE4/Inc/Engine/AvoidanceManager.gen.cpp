...
static struct FScriptStruct_Engine_StaticRegisterNativesFNavAvoidanceData
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAvoidanceManager_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAvoidanceManager_GetAvoidanceVelocityForComponent, "GetAvoidanceVelocityForComponent" }, // 603901629
		{ &Z_Construct_UFunction_UAvoidanceManager_GetNewAvoidanceUID, "GetNewAvoidanceUID" }, // 3657048169
		{ &Z_Construct_UFunction_UAvoidanceManager_GetObjectCount, "GetObjectCount" }, // 1189635951
		{ &Z_Construct_UFunction_UAvoidanceManager_RegisterMovementComponent, "RegisterMovementComponent" }, // 509093003
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UAvoidanceManager, 4069773395);
