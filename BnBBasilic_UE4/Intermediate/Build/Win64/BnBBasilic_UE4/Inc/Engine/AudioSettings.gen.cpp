...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_EMonoChannelUpmixMethod_Hash() { return 1814527413U; }
	...
	uint32 Get_Z_Construct_UEnum_Engine_EPanningMethod_Hash() { return 340929881U; }
	...
	uint32 Get_Z_Construct_UEnum_Engine_EVoiceSampleRate_Hash() { return 1558217982U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFAudioQualitySettings
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FAudioQualitySettings_Hash() { return 1586454284U; }
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bEnableLegacyReverb_MetaData[];
#endif
		static void NewProp_bEnableLegacyReverb_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bEnableLegacyReverb;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAudioSettings_Statics::NewProp_bEnableLegacyReverb_MetaData[] = {
		{ "Category", "Audio" },
		{ "Comment", "/** Enables legacy version of reverb. The legacy reverb runs more slowly, but by most other measures is functionally equivalent. It has a slight perceptual difference. */" },
		{ "ModuleRelativePath", "Classes/Sound/AudioSettings.h" },
		{ "ToolTip", "Enables legacy version of reverb. The legacy reverb runs more slowly, but by most other measures is functionally equivalent. It has a slight perceptual difference." },
	};
#endif
	void Z_Construct_UClass_UAudioSettings_Statics::NewProp_bEnableLegacyReverb_SetBit(void* Obj)
	{
		((UAudioSettings*)Obj)->bEnableLegacyReverb = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAudioSettings_Statics::NewProp_bEnableLegacyReverb = { "bEnableLegacyReverb", nullptr, (EPropertyFlags)0x0010040000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UAudioSettings), &Z_Construct_UClass_UAudioSettings_Statics::NewProp_bEnableLegacyReverb_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAudioSettings_Statics::NewProp_bEnableLegacyReverb_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAudioSettings_Statics::NewProp_bEnableLegacyReverb_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAudioSettings_Statics::NewProp_VoipBufferingDelay_MetaData[] = {
		...
		{ "ClampMax", "3.000000" },
		{ "ClampMin", "0.050000" },
		{ "Comment", "/** The amount of time to buffer incoming voice audio for ahead of time. Increasing this value can help avoid jitter on slower network connections. */" },
		{ "ModuleRelativePath", "Classes/Sound/AudioSettings.h" },
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UAudioSettings_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAudioSettings_Statics::NewProp_bEnableLegacyReverb,
	...
	IMPLEMENT_CLASS(UAudioSettings, 3026670615);
	...
	IMPLEMENT_FSTRUCTUREDARCHIVE_SERIALIZER(UAudioSettings)
