...
static struct FScriptStruct_Engine_StaticRegisterNativesFDebugCameraControllerSettingsViewModeIndex
{
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FDebugCameraControllerSettingsViewModeIndex_Statics::NewProp_ViewModeIndex = { "ViewModeIndex", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FDebugCameraControllerSettingsViewModeIndex, ViewModeIndex), Z_Construct_UEnum_Engine_EViewModeIndex, METADATA_PARAMS(Z_Construct_UScriptStruct_FDebugCameraControllerSettingsViewModeIndex_Statics::NewProp_ViewModeIndex_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FDebugCameraControllerSettingsViewModeIndex_Statics::NewProp_ViewModeIndex_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDebugCameraControllerSettingsViewModeIndex_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FDebugCameraControllerSettingsViewModeIndex_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FDebugCameraControllerSettingsViewModeIndex_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FDebugCameraControllerSettingsViewModeIndex_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FDebugCameraControllerSettingsViewModeIndex_Hash() { return 292814341U; }
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UDebugCameraControllerSettings_Statics::NewProp_CycleViewModes = { "CycleViewModes", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDebugCameraControllerSettings, CycleViewModes), METADATA_PARAMS(Z_Construct_UClass_UDebugCameraControllerSettings_Statics::NewProp_CycleViewModes_MetaData, ARRAY_COUNT(Z_Construct_UClass_UDebugCameraControllerSettings_Statics::NewProp_CycleViewModes_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UDebugCameraControllerSettings_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UDebugCameraControllerSettings_Statics::PropPointers),
		0,
		0x001000A6u,
		METADATA_PARAMS(Z_Construct_UClass_UDebugCameraControllerSettings_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UDebugCameraControllerSettings_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UDebugCameraControllerSettings, 3004798368);
