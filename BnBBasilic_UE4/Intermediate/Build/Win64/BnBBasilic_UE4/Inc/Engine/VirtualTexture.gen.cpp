...
// End Cross Module References
	...
	IMPLEMENT_CLASS(UVirtualTexture, 1761218578);
	...
	IMPLEMENT_CLASS(ULightMapVirtualTexture, 1108566744);
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ULightMapVirtualTexture2D_Statics::NewProp_TypeToLayer = { "TypeToLayer", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULightMapVirtualTexture2D, TypeToLayer), METADATA_PARAMS(Z_Construct_UClass_ULightMapVirtualTexture2D_Statics::NewProp_TypeToLayer_MetaData, ARRAY_COUNT(Z_Construct_UClass_ULightMapVirtualTexture2D_Statics::NewProp_TypeToLayer_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ULightMapVirtualTexture2D_Statics::ClassParams = {
		...
		ARRAY_COUNT(DependentSingletons),
		0,
		ARRAY_COUNT(Z_Construct_UClass_ULightMapVirtualTexture2D_Statics::PropPointers),
		0,
		0x009000A0u,
		METADATA_PARAMS(Z_Construct_UClass_ULightMapVirtualTexture2D_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_ULightMapVirtualTexture2D_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(ULightMapVirtualTexture2D, 2702349820);
