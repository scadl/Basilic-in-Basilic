...
// Cross Module References
	...
	STEAMVR_API UFunction* Z_Construct_UFunction_USteamVRFunctionLibrary_GetHandPositionAndOrientation();
	COREUOBJECT_API UScriptStruct* Z_Construct_UScriptStruct_FRotator();
	COREUOBJECT_API UScriptStruct* Z_Construct_UScriptStruct_FVector();
	INPUTCORE_API UEnum* Z_Construct_UEnum_InputCore_EControllerHand();
	STEAMVR_API UFunction* Z_Construct_UFunction_USteamVRFunctionLibrary_GetTrackedDevicePositionAndOrientation();
	STEAMVR_API UFunction* Z_Construct_UFunction_USteamVRFunctionLibrary_GetValidTrackedDeviceIds();
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_SteamVR_ESteamVRTrackedDeviceType_Hash() { return 2523874363U; }
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_USteamVRFunctionLibrary_GetTrackedDevicePositionAndOrientation_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USteamVRFunctionLibrary, nullptr, "GetTrackedDevicePositionAndOrientation", nullptr, nullptr, sizeof(SteamVRFunctionLibrary_eventGetTrackedDevicePositionAndOrientation_Parms), Z_Construct_UFunction_USteamVRFunctionLibrary_GetTrackedDevicePositionAndOrientation_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_USteamVRFunctionLibrary_GetTrackedDevicePositionAndOrientation_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14C22401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_USteamVRFunctionLibrary_GetTrackedDevicePositionAndOrientation_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_USteamVRFunctionLibrary_GetTrackedDevicePositionAndOrientation_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USteamVRFunctionLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USteamVRFunctionLibrary_GetHandPositionAndOrientation, "GetHandPositionAndOrientation" }, // 2562363041
		{ &Z_Construct_UFunction_USteamVRFunctionLibrary_GetTrackedDevicePositionAndOrientation, "GetTrackedDevicePositionAndOrientation" }, // 671935154
		{ &Z_Construct_UFunction_USteamVRFunctionLibrary_GetValidTrackedDeviceIds, "GetValidTrackedDeviceIds" }, // 3285128141
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_USteamVRFunctionLibrary_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_USteamVRFunctionLibrary_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_USteamVRFunctionLibrary_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(USteamVRFunctionLibrary, 2870340057);
