...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UEnvQueryTest_Volume_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UEnvQueryTest_Volume_Statics::PropPointers),
		0,
		0x008800A0u,
		METADATA_PARAMS(Z_Construct_UClass_UEnvQueryTest_Volume_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UEnvQueryTest_Volume_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UEnvQueryTest_Volume, 1212399501);
