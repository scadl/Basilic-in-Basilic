...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_OculusMR_EOculusMR_BoundaryType_Hash() { return 3130332255U; }
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UOculusMR_BoundaryMeshComponent_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UOculusMR_BoundaryMeshComponent_Statics::PropPointers),
		0,
		0x00A012A4u,
		METADATA_PARAMS(Z_Construct_UClass_UOculusMR_BoundaryMeshComponent_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UOculusMR_BoundaryMeshComponent_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UOculusMR_BoundaryMeshComponent, 2204214785);
