...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AOculusMR_BoundaryActor_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_AOculusMR_BoundaryActor_Statics::PropPointers),
		0,
		0x008002A0u,
		METADATA_PARAMS(Z_Construct_UClass_AOculusMR_BoundaryActor_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_AOculusMR_BoundaryActor_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(AOculusMR_BoundaryActor, 2960331312);
