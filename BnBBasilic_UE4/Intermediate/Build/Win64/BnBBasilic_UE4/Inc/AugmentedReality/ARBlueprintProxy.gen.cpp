...
// End Cross Module References
	...
	IMPLEMENT_CLASS(UARBaseAsyncTaskBlueprintProxy, 1287281328);
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UARSaveWorldAsyncTaskBlueprintProxy_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UARSaveWorldAsyncTaskBlueprintProxy_ARSaveWorld, "ARSaveWorld" }, // 5962125
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UARSaveWorldAsyncTaskBlueprintProxy_Statics::NewProp_OnSuccess = { "OnSuccess", nullptr, (EPropertyFlags)0x0010000010080000, UE4CodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UARSaveWorldAsyncTaskBlueprintProxy, OnSuccess), Z_Construct_UDelegateFunction_AugmentedReality_ARSaveWorldPin__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UARSaveWorldAsyncTaskBlueprintProxy_Statics::NewProp_OnSuccess_MetaData, ARRAY_COUNT(Z_Construct_UClass_UARSaveWorldAsyncTaskBlueprintProxy_Statics::NewProp_OnSuccess_MetaData)) };
	...
	IMPLEMENT_CLASS(UARSaveWorldAsyncTaskBlueprintProxy, 641883389);
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UARGetCandidateObjectAsyncTaskBlueprintProxy_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UARGetCandidateObjectAsyncTaskBlueprintProxy_ARGetCandidateObject, "ARGetCandidateObject" }, // 238802668
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UARGetCandidateObjectAsyncTaskBlueprintProxy, 2755186079);
