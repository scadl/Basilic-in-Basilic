...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_GeometryCollectionEngine_EChaosCollisionSortMethod_Hash() { return 1872711444U; }
...
static struct FScriptStruct_GeometryCollectionEngine_StaticRegisterNativesFChaosCollisionEventRequestSettings
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FChaosCollisionEventRequestSettings_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosCollisionEventRequestSettings_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosCollisionEventRequestSettings_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosCollisionEventRequestSettings_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FChaosCollisionEventRequestSettings_Hash() { return 1462755882U; }
...
static struct FScriptStruct_GeometryCollectionEngine_StaticRegisterNativesFChaosCollisionEventData
{
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FChaosCollisionEventData_Statics::NewProp_LevelsetIndex_MetaData[] = {
		{ "Category", "Data" },
		{ "Comment", "// The level set index of the collision event\n" },
		{ "ModuleRelativePath", "Public/ChaosCollisionEventFilter.h" },
		{ "ToolTip", "The level set index of the collision event" },
	};
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FChaosCollisionEventData_Statics::NewProp_LevelsetIndex = { "LevelsetIndex", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FChaosCollisionEventData, LevelsetIndex), METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosCollisionEventData_Statics::NewProp_LevelsetIndex_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosCollisionEventData_Statics::NewProp_LevelsetIndex_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FChaosCollisionEventData_Statics::NewProp_ParticleIndex_MetaData[] = {
		{ "Category", "Data" },
		{ "Comment", "// The particle index of the collision event\n" },
		{ "ModuleRelativePath", "Public/ChaosCollisionEventFilter.h" },
		{ "ToolTip", "The particle index of the collision event" },
	};
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FChaosCollisionEventData_Statics::NewProp_ParticleIndex = { "ParticleIndex", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FChaosCollisionEventData, ParticleIndex), METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosCollisionEventData_Statics::NewProp_ParticleIndex_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosCollisionEventData_Statics::NewProp_ParticleIndex_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FChaosCollisionEventData_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FChaosCollisionEventData_Statics::NewProp_LevelsetIndex,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FChaosCollisionEventData_Statics::NewProp_ParticleIndex,
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FChaosCollisionEventData_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosCollisionEventData_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosCollisionEventData_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosCollisionEventData_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FChaosCollisionEventData_Hash() { return 567929971U; }
