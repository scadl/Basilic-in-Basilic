...
static struct FScriptStruct_OnlineSubsystem_StaticRegisterNativesFNamedInterfaceDef
{
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FNamedInterfaceDef_Statics::NewProp_InterfaceClassName = { "InterfaceClassName", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNamedInterfaceDef, InterfaceClassName), METADATA_PARAMS(Z_Construct_UScriptStruct_FNamedInterfaceDef_Statics::NewProp_InterfaceClassName_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FNamedInterfaceDef_Statics::NewProp_InterfaceClassName_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FNamedInterfaceDef_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FNamedInterfaceDef_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FNamedInterfaceDef_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FNamedInterfaceDef_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FNamedInterfaceDef_Hash() { return 2800122979U; }
...
static struct FScriptStruct_OnlineSubsystem_StaticRegisterNativesFNamedInterface
{
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FNamedInterface_Statics::NewProp_InterfaceName = { "InterfaceName", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNamedInterface, InterfaceName), METADATA_PARAMS(Z_Construct_UScriptStruct_FNamedInterface_Statics::NewProp_InterfaceName_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FNamedInterface_Statics::NewProp_InterfaceName_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FNamedInterface_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FNamedInterface_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FNamedInterface_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FNamedInterface_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FNamedInterface_Hash() { return 2341272237U; }
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UNamedInterfaces_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UNamedInterfaces_Statics::PropPointers),
		0,
		0x000000ACu,
		METADATA_PARAMS(Z_Construct_UClass_UNamedInterfaces_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UNamedInterfaces_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UNamedInterfaces, 1754902435);
