...
static struct FScriptStruct_LiveLinkComponents_StaticRegisterNativesFLiveLinkTransformControllerData
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("LiveLinkTransformControllerData")),new UScriptStruct::TCppStructOps<FLiveLinkTransformControllerData>);
	}
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FLiveLinkTransformControllerData_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FLiveLinkTransformControllerData_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FLiveLinkTransformControllerData_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FLiveLinkTransformControllerData_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FLiveLinkTransformControllerData_Hash() { return 2401756197U; }
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_ULiveLinkTransformController_Statics::NewProp_ComponentToControl = { "ComponentToControl", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULiveLinkTransformController, ComponentToControl), Z_Construct_UScriptStruct_FComponentReference, METADATA_PARAMS(Z_Construct_UClass_ULiveLinkTransformController_Statics::NewProp_ComponentToControl_MetaData, ARRAY_COUNT(Z_Construct_UClass_ULiveLinkTransformController_Statics::NewProp_ComponentToControl_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ULiveLinkTransformController_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_ULiveLinkTransformController_Statics::PropPointers),
		0,
		0x001010A0u,
		METADATA_PARAMS(Z_Construct_UClass_ULiveLinkTransformController_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_ULiveLinkTransformController_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(ULiveLinkTransformController, 2779482471);
