...
static struct FScriptStruct_VariantManagerContent_StaticRegisterNativesFFunctionCaller
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FFunctionCaller_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FFunctionCaller_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FFunctionCaller_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FFunctionCaller_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FFunctionCaller_Hash() { return 1388042204U; }
