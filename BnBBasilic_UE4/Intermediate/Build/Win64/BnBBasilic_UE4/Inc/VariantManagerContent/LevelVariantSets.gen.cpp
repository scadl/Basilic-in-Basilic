...
// Cross Module References
	...
	VARIANTMANAGERCONTENT_API UFunction* Z_Construct_UFunction_ULevelVariantSets_GetNumVariantSets();
	VARIANTMANAGERCONTENT_API UFunction* Z_Construct_UFunction_ULevelVariantSets_GetVariantSet();
	VARIANTMANAGERCONTENT_API UClass* Z_Construct_UClass_UVariantSet_NoRegister();
	VARIANTMANAGERCONTENT_API UFunction* Z_Construct_UFunction_ULevelVariantSets_GetVariantSetByName();
...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ULevelVariantSets_GetVariantSetByName_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULevelVariantSets, nullptr, "GetVariantSetByName", nullptr, nullptr, sizeof(LevelVariantSets_eventGetVariantSetByName_Parms), Z_Construct_UFunction_ULevelVariantSets_GetVariantSetByName_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_ULevelVariantSets_GetVariantSetByName_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ULevelVariantSets_GetVariantSetByName_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_ULevelVariantSets_GetVariantSetByName_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ULevelVariantSets_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ULevelVariantSets_GetNumVariantSets, "GetNumVariantSets" }, // 2756750587
		{ &Z_Construct_UFunction_ULevelVariantSets_GetVariantSet, "GetVariantSet" }, // 3133996407
		{ &Z_Construct_UFunction_ULevelVariantSets_GetVariantSetByName, "GetVariantSetByName" }, // 667624220
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ULevelVariantSets_Statics::NewProp_VariantSets = { "VariantSets", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULevelVariantSets, VariantSets), METADATA_PARAMS(Z_Construct_UClass_ULevelVariantSets_Statics::NewProp_VariantSets_MetaData, ARRAY_COUNT(Z_Construct_UClass_ULevelVariantSets_Statics::NewProp_VariantSets_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ULevelVariantSets_Statics::ClassParams = {
		...
		ARRAY_COUNT(Z_Construct_UClass_ULevelVariantSets_Statics::PropPointers),
		0,
		0x003000A0u,
		METADATA_PARAMS(Z_Construct_UClass_ULevelVariantSets_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_ULevelVariantSets_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(ULevelVariantSets, 209481639);
