...
// Cross Module References
	...
	VARIANTMANAGERCONTENT_API UFunction* Z_Construct_UFunction_UVariantSet_GetDisplayText();
	VARIANTMANAGERCONTENT_API UFunction* Z_Construct_UFunction_UVariantSet_GetNumVariants();
	VARIANTMANAGERCONTENT_API UFunction* Z_Construct_UFunction_UVariantSet_GetVariant();
	VARIANTMANAGERCONTENT_API UClass* Z_Construct_UClass_UVariant_NoRegister();
	VARIANTMANAGERCONTENT_API UFunction* Z_Construct_UFunction_UVariantSet_GetVariantByName();
	VARIANTMANAGERCONTENT_API UFunction* Z_Construct_UFunction_UVariantSet_SetDisplayText();
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UVariantSet_GetNumVariants_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVariantSet, nullptr, "GetNumVariants", nullptr, nullptr, sizeof(VariantSet_eventGetNumVariants_Parms), Z_Construct_UFunction_UVariantSet_GetNumVariants_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UVariantSet_GetNumVariants_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UVariantSet_GetNumVariants_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UVariantSet_GetNumVariants_Statics::Function_MetaDataParams)) };
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UVariantSet_GetVariant_Statics::NewProp_ReturnValue_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UVariantSet_GetVariant_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000080588, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(VariantSet_eventGetVariant_Parms, ReturnValue), Z_Construct_UClass_UVariant_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UVariantSet_GetVariant_Statics::NewProp_ReturnValue_MetaData, ARRAY_COUNT(Z_Construct_UFunction_UVariantSet_GetVariant_Statics::NewProp_ReturnValue_MetaData)) };
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UVariantSet_GetVariantByName_Statics::NewProp_ReturnValue_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UVariantSet_GetVariantByName_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000080588, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(VariantSet_eventGetVariantByName_Parms, ReturnValue), Z_Construct_UClass_UVariant_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UVariantSet_GetVariantByName_Statics::NewProp_ReturnValue_MetaData, ARRAY_COUNT(Z_Construct_UFunction_UVariantSet_GetVariantByName_Statics::NewProp_ReturnValue_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UVariantSet_GetVariantByName_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVariantSet, nullptr, "GetVariantByName", nullptr, nullptr, sizeof(VariantSet_eventGetVariantByName_Parms), Z_Construct_UFunction_UVariantSet_GetVariantByName_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UVariantSet_GetVariantByName_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UVariantSet_GetVariantByName_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UVariantSet_GetVariantByName_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UVariantSet_SetDisplayText_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVariantSet, nullptr, "SetDisplayText", nullptr, nullptr, sizeof(VariantSet_eventSetDisplayText_Parms), Z_Construct_UFunction_UVariantSet_SetDisplayText_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UVariantSet_SetDisplayText_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UVariantSet_SetDisplayText_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UVariantSet_SetDisplayText_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UVariantSet_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UVariantSet_GetDisplayText, "GetDisplayText" }, // 293264687
		{ &Z_Construct_UFunction_UVariantSet_GetNumVariants, "GetNumVariants" }, // 910342131
		{ &Z_Construct_UFunction_UVariantSet_GetVariant, "GetVariant" }, // 2771700440
		{ &Z_Construct_UFunction_UVariantSet_GetVariantByName, "GetVariantByName" }, // 3799317731
		{ &Z_Construct_UFunction_UVariantSet_SetDisplayText, "SetDisplayText" }, // 3982545543
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UVariantSet_Statics::NewProp_Variants = { "Variants", nullptr, (EPropertyFlags)0x0040008000000008, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UVariantSet, Variants), METADATA_PARAMS(Z_Construct_UClass_UVariantSet_Statics::NewProp_Variants_MetaData, ARRAY_COUNT(Z_Construct_UClass_UVariantSet_Statics::NewProp_Variants_MetaData)) };
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UVariantSet_Statics::NewProp_Variants_Inner = { "Variants", nullptr, (EPropertyFlags)0x0000000000080008, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UVariant_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UVariantSet_Statics::NewProp_bExpanded = { "bExpanded", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UVariantSet), &Z_Construct_UClass_UVariantSet_Statics::NewProp_bExpanded_SetBit, METADATA_PARAMS(Z_Construct_UClass_UVariantSet_Statics::NewProp_bExpanded_MetaData, ARRAY_COUNT(Z_Construct_UClass_UVariantSet_Statics::NewProp_bExpanded_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UVariantSet_Statics::ClassParams = {
		...
		ARRAY_COUNT(Z_Construct_UClass_UVariantSet_Statics::PropPointers),
		0,
		0x009000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UVariantSet_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UVariantSet_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UVariantSet, 2156651713);
