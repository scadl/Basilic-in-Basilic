...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UVariantObjectBinding_Statics::NewProp_FunctionCallers = { "FunctionCallers", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UVariantObjectBinding, FunctionCallers), METADATA_PARAMS(Z_Construct_UClass_UVariantObjectBinding_Statics::NewProp_FunctionCallers_MetaData, ARRAY_COUNT(Z_Construct_UClass_UVariantObjectBinding_Statics::NewProp_FunctionCallers_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UVariantObjectBinding_Statics::NewProp_CapturedProperties = { "CapturedProperties", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UVariantObjectBinding, CapturedProperties), METADATA_PARAMS(Z_Construct_UClass_UVariantObjectBinding_Statics::NewProp_CapturedProperties_MetaData, ARRAY_COUNT(Z_Construct_UClass_UVariantObjectBinding_Statics::NewProp_CapturedProperties_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FLazyObjectPropertyParams Z_Construct_UClass_UVariantObjectBinding_Statics::NewProp_LazyObjectPtr = { "LazyObjectPtr", nullptr, (EPropertyFlags)0x0044000000000000, UE4CodeGen_Private::EPropertyGenFlags::LazyObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UVariantObjectBinding, LazyObjectPtr), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UVariantObjectBinding_Statics::NewProp_LazyObjectPtr_MetaData, ARRAY_COUNT(Z_Construct_UClass_UVariantObjectBinding_Statics::NewProp_LazyObjectPtr_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UVariantObjectBinding_Statics::NewProp_ObjectPtr_MetaData[] = {
		{ "ModuleRelativePath", "Public/VariantObjectBinding.h" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UVariantObjectBinding_Statics::NewProp_ObjectPtr = { "ObjectPtr", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UVariantObjectBinding, ObjectPtr), Z_Construct_UScriptStruct_FSoftObjectPath, METADATA_PARAMS(Z_Construct_UClass_UVariantObjectBinding_Statics::NewProp_ObjectPtr_MetaData, ARRAY_COUNT(Z_Construct_UClass_UVariantObjectBinding_Statics::NewProp_ObjectPtr_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UVariantObjectBinding_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UVariantObjectBinding_Statics::PropPointers),
		0,
		0x003000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UVariantObjectBinding_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UVariantObjectBinding_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UVariantObjectBinding, 1096411388);
