...
static struct FScriptStruct_UMG_StaticRegisterNativesFUserWidgetPool
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FUserWidgetPool_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FUserWidgetPool_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000205),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FUserWidgetPool_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FUserWidgetPool_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FUserWidgetPool_Hash() { return 2727734239U; }
