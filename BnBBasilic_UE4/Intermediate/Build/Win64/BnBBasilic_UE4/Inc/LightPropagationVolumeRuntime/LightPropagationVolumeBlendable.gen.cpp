...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ULightPropagationVolumeBlendable_Statics::NewProp_BlendWeight = { "BlendWeight", nullptr, (EPropertyFlags)0x0010000200000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULightPropagationVolumeBlendable, BlendWeight), METADATA_PARAMS(Z_Construct_UClass_ULightPropagationVolumeBlendable_Statics::NewProp_BlendWeight_MetaData, ARRAY_COUNT(Z_Construct_UClass_ULightPropagationVolumeBlendable_Statics::NewProp_BlendWeight_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ULightPropagationVolumeBlendable_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_ULightPropagationVolumeBlendable_Statics::PropPointers),
		ARRAY_COUNT(InterfaceParams),
		0x000800A0u,
		METADATA_PARAMS(Z_Construct_UClass_ULightPropagationVolumeBlendable_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_ULightPropagationVolumeBlendable_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(ULightPropagationVolumeBlendable, 2656308489);
