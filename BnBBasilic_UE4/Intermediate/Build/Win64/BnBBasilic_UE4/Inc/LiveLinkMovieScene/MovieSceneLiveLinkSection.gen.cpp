...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UClass_UMovieSceneLiveLinkSection_Statics::NewProp_SubjectName = { "SubjectName", nullptr, (EPropertyFlags)0x0010000020000000, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneLiveLinkSection, SubjectName_DEPRECATED), METADATA_PARAMS(Z_Construct_UClass_UMovieSceneLiveLinkSection_Statics::NewProp_SubjectName_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMovieSceneLiveLinkSection_Statics::NewProp_SubjectName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMovieSceneLiveLinkSection_Statics::NewProp_SubSections = { "SubSections", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneLiveLinkSection, SubSections), METADATA_PARAMS(Z_Construct_UClass_UMovieSceneLiveLinkSection_Statics::NewProp_SubSections_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMovieSceneLiveLinkSection_Statics::NewProp_SubSections_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMovieSceneLiveLinkSection_Statics::NewProp_ChannelMask = { "ChannelMask", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneLiveLinkSection, ChannelMask), METADATA_PARAMS(Z_Construct_UClass_UMovieSceneLiveLinkSection_Statics::NewProp_ChannelMask_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMovieSceneLiveLinkSection_Statics::NewProp_ChannelMask_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneLiveLinkSection_Statics::NewProp_SubjectPreset = { "SubjectPreset", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneLiveLinkSection, SubjectPreset), Z_Construct_UScriptStruct_FLiveLinkSubjectPreset, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneLiveLinkSection_Statics::NewProp_SubjectPreset_MetaData, ARRAY_COUNT(Z_Construct_UClass_UMovieSceneLiveLinkSection_Statics::NewProp_SubjectPreset_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneLiveLinkSection_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UMovieSceneLiveLinkSection_Statics::PropPointers),
		0,
		0x003000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UMovieSceneLiveLinkSection_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UMovieSceneLiveLinkSection_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UMovieSceneLiveLinkSection, 2065792159);
