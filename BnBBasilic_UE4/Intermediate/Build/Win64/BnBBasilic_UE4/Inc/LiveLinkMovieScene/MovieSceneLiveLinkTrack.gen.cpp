...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneLiveLinkTrack_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UMovieSceneLiveLinkTrack_Statics::PropPointers),
		0,
		0x00A800A0u,
		METADATA_PARAMS(Z_Construct_UClass_UMovieSceneLiveLinkTrack_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UMovieSceneLiveLinkTrack_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UMovieSceneLiveLinkTrack, 2309109383);
