...
static struct FScriptStruct_LiveLinkMovieScene_StaticRegisterNativesFMovieSceneLiveLinkSectionTemplate
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("MovieSceneLiveLinkSectionTemplate")),new UScriptStruct::TCppStructOps<FMovieSceneLiveLinkSectionTemplate>);
	}
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMovieSceneLiveLinkSectionTemplate_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneLiveLinkSectionTemplate_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000005),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneLiveLinkSectionTemplate_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneLiveLinkSectionTemplate_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneLiveLinkSectionTemplate_Hash() { return 652591834U; }
