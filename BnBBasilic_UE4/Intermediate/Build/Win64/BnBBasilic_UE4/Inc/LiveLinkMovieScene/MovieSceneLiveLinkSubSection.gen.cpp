...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneLiveLinkSubSection_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UMovieSceneLiveLinkSubSection_Statics::PropPointers),
		0,
		0x001000A1u,
		METADATA_PARAMS(Z_Construct_UClass_UMovieSceneLiveLinkSubSection_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UMovieSceneLiveLinkSubSection_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UMovieSceneLiveLinkSubSection, 4130922644);
