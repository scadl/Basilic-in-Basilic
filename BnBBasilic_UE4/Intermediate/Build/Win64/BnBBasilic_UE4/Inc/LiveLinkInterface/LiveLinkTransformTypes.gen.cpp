...
static struct FScriptStruct_LiveLinkInterface_StaticRegisterNativesFLiveLinkTransformBlueprintData
{
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FLiveLinkTransformBlueprintData_Statics::NewProp_FrameData = { "FrameData", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FLiveLinkTransformBlueprintData, FrameData), Z_Construct_UScriptStruct_FLiveLinkTransformFrameData, METADATA_PARAMS(Z_Construct_UScriptStruct_FLiveLinkTransformBlueprintData_Statics::NewProp_FrameData_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FLiveLinkTransformBlueprintData_Statics::NewProp_FrameData_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FLiveLinkTransformBlueprintData_Statics::NewProp_StaticData = { "StaticData", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FLiveLinkTransformBlueprintData, StaticData), Z_Construct_UScriptStruct_FLiveLinkTransformStaticData, METADATA_PARAMS(Z_Construct_UScriptStruct_FLiveLinkTransformBlueprintData_Statics::NewProp_StaticData_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FLiveLinkTransformBlueprintData_Statics::NewProp_StaticData_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FLiveLinkTransformBlueprintData_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FLiveLinkTransformBlueprintData_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FLiveLinkTransformBlueprintData_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FLiveLinkTransformBlueprintData_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FLiveLinkTransformBlueprintData_Hash() { return 505012914U; }
...
static struct FScriptStruct_LiveLinkInterface_StaticRegisterNativesFLiveLinkTransformFrameData
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FLiveLinkTransformFrameData_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FLiveLinkTransformFrameData_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FLiveLinkTransformFrameData_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FLiveLinkTransformFrameData_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FLiveLinkTransformFrameData_Hash() { return 3964361274U; }
...
static struct FScriptStruct_LiveLinkInterface_StaticRegisterNativesFLiveLinkTransformStaticData
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FLiveLinkTransformStaticData_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FLiveLinkTransformStaticData_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FLiveLinkTransformStaticData_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FLiveLinkTransformStaticData_Hash() { return 1691804339U; }
