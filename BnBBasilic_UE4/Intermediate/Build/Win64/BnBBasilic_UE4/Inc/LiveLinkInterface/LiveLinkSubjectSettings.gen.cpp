...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ULiveLinkSubjectSettings_Statics::NewProp_Translators = { "Translators", nullptr, (EPropertyFlags)0x0010008000000009, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULiveLinkSubjectSettings, Translators), METADATA_PARAMS(Z_Construct_UClass_ULiveLinkSubjectSettings_Statics::NewProp_Translators_MetaData, ARRAY_COUNT(Z_Construct_UClass_ULiveLinkSubjectSettings_Statics::NewProp_Translators_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ULiveLinkSubjectSettings_Statics::NewProp_PreProcessors = { "PreProcessors", nullptr, (EPropertyFlags)0x0010008000000009, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULiveLinkSubjectSettings, PreProcessors), METADATA_PARAMS(Z_Construct_UClass_ULiveLinkSubjectSettings_Statics::NewProp_PreProcessors_MetaData, ARRAY_COUNT(Z_Construct_UClass_ULiveLinkSubjectSettings_Statics::NewProp_PreProcessors_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ULiveLinkSubjectSettings_Statics::NewProp_PreProcessors_Inner = { "PreProcessors", nullptr, (EPropertyFlags)0x0002000000080008, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_ULiveLinkFramePreProcessor_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ULiveLinkSubjectSettings_Statics::NewProp_PreProcessors_Inner_MetaData, ARRAY_COUNT(Z_Construct_UClass_ULiveLinkSubjectSettings_Statics::NewProp_PreProcessors_Inner_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ULiveLinkSubjectSettings_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_ULiveLinkSubjectSettings_Statics::PropPointers),
		0,
		0x009000A0u,
		METADATA_PARAMS(Z_Construct_UClass_ULiveLinkSubjectSettings_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_ULiveLinkSubjectSettings_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(ULiveLinkSubjectSettings, 1521065601);
