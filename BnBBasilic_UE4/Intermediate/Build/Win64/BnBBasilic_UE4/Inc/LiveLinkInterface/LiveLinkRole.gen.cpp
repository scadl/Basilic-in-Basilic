...
static struct FScriptStruct_LiveLinkInterface_StaticRegisterNativesFLiveLinkSubjectRepresentation
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FLiveLinkSubjectRepresentation_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FLiveLinkSubjectRepresentation_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FLiveLinkSubjectRepresentation_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FLiveLinkSubjectRepresentation_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FLiveLinkSubjectRepresentation_Hash() { return 909953287U; }
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ULiveLinkRole_Statics::ClassParams = {
		...
		0,
		0x001000A1u,
		METADATA_PARAMS(Z_Construct_UClass_ULiveLinkRole_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_ULiveLinkRole_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(ULiveLinkRole, 484604353);
