...
static struct FScriptStruct_LiveLinkInterface_StaticRegisterNativesFLiveLinkSubjectPreset
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FLiveLinkSubjectPreset_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FLiveLinkSubjectPreset_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FLiveLinkSubjectPreset_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FLiveLinkSubjectPreset_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FLiveLinkSubjectPreset_Hash() { return 679868273U; }
...
static struct FScriptStruct_LiveLinkInterface_StaticRegisterNativesFLiveLinkSourcePreset
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FLiveLinkSourcePreset_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FLiveLinkSourcePreset_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FLiveLinkSourcePreset_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FLiveLinkSourcePreset_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FLiveLinkSourcePreset_Hash() { return 2139389103U; }
