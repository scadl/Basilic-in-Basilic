...
static struct FScriptStruct_LiveLinkInterface_StaticRegisterNativesFSubjectFrameHandle
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FSubjectFrameHandle_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(Z_Construct_UScriptStruct_FSubjectFrameHandle_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FSubjectFrameHandle_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FSubjectFrameHandle_Hash() { return 4024300925U; }
...
static struct FScriptStruct_LiveLinkInterface_StaticRegisterNativesFLiveLinkTransform
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FLiveLinkTransform_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FLiveLinkTransform_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FLiveLinkTransform_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FLiveLinkTransform_Hash() { return 3663440547U; }
...
static struct FScriptStruct_LiveLinkInterface_StaticRegisterNativesFCachedSubjectFrame
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FCachedSubjectFrame_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(Z_Construct_UScriptStruct_FCachedSubjectFrame_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FCachedSubjectFrame_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FCachedSubjectFrame_Hash() { return 3104939602U; }
...
static struct FScriptStruct_LiveLinkInterface_StaticRegisterNativesFSubjectMetadata
{
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSubjectMetadata_Statics::NewProp_SceneFramerate = { "SceneFramerate", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSubjectMetadata, SceneFramerate), Z_Construct_UScriptStruct_FFrameRate, METADATA_PARAMS(Z_Construct_UScriptStruct_FSubjectMetadata_Statics::NewProp_SceneFramerate_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FSubjectMetadata_Statics::NewProp_SceneFramerate_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSubjectMetadata_Statics::NewProp_SceneTimecode = { "SceneTimecode", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSubjectMetadata, SceneTimecode), Z_Construct_UScriptStruct_FTimecode, METADATA_PARAMS(Z_Construct_UScriptStruct_FSubjectMetadata_Statics::NewProp_SceneTimecode_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FSubjectMetadata_Statics::NewProp_SceneTimecode_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UScriptStruct_FSubjectMetadata_Statics::NewProp_StringMetadata = { "StringMetadata", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSubjectMetadata, StringMetadata), METADATA_PARAMS(Z_Construct_UScriptStruct_FSubjectMetadata_Statics::NewProp_StringMetadata_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FSubjectMetadata_Statics::NewProp_StringMetadata_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FSubjectMetadata_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FSubjectMetadata_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FSubjectMetadata_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FSubjectMetadata_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FSubjectMetadata_Hash() { return 3385883718U; }
