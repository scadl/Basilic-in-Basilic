...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ULiveLinkVirtualSubject_Statics::NewProp_FrameTranslators = { "FrameTranslators", nullptr, (EPropertyFlags)0x0020088000000009, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULiveLinkVirtualSubject, FrameTranslators), METADATA_PARAMS(Z_Construct_UClass_ULiveLinkVirtualSubject_Statics::NewProp_FrameTranslators_MetaData, ARRAY_COUNT(Z_Construct_UClass_ULiveLinkVirtualSubject_Statics::NewProp_FrameTranslators_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ULiveLinkVirtualSubject_Statics::NewProp_Subjects = { "Subjects", nullptr, (EPropertyFlags)0x0020080000000001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULiveLinkVirtualSubject, Subjects), METADATA_PARAMS(Z_Construct_UClass_ULiveLinkVirtualSubject_Statics::NewProp_Subjects_MetaData, ARRAY_COUNT(Z_Construct_UClass_ULiveLinkVirtualSubject_Statics::NewProp_Subjects_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ULiveLinkVirtualSubject_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_ULiveLinkVirtualSubject_Statics::PropPointers),
		0,
		0x009000A1u,
		METADATA_PARAMS(Z_Construct_UClass_ULiveLinkVirtualSubject_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_ULiveLinkVirtualSubject_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(ULiveLinkVirtualSubject, 4137379952);
