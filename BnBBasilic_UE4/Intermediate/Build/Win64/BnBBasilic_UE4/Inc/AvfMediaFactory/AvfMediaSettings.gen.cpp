...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAvfMediaSettings_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UAvfMediaSettings_Statics::PropPointers),
		0,
		0x001000A4u,
		METADATA_PARAMS(Z_Construct_UClass_UAvfMediaSettings_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UAvfMediaSettings_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UAvfMediaSettings, 1035856325);
