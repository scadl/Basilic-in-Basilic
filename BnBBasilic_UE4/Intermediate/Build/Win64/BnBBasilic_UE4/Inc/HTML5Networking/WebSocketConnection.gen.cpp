...
#include "HTML5Networking/Classes/WebSocketConnection.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UWebSocketConnection_Statics::Class_MetaDataParams[] = {
		...
		{ "ModuleRelativePath", "Classes/WebSocketConnection.h" },
	};
#endif
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UWebSocketConnection_Statics::ClassParams = {
		...
		0,
		0x001000ACu,
		METADATA_PARAMS(Z_Construct_UClass_UWebSocketConnection_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UWebSocketConnection_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UWebSocketConnection, 4287212325);
	template<> HTML5NETWORKING_API UClass* StaticClass<UWebSocketConnection>()
	{
		return UWebSocketConnection::StaticClass();
	}
