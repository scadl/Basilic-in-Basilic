...
static struct FScriptStruct_DatasmithContent_StaticRegisterNativesFDatasmithPostProcessSettingsTemplate
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDatasmithPostProcessSettingsTemplate_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FDatasmithPostProcessSettingsTemplate_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FDatasmithPostProcessSettingsTemplate_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FDatasmithPostProcessSettingsTemplate_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FDatasmithPostProcessSettingsTemplate_Hash() { return 1284090730U; }
...
static struct FScriptStruct_DatasmithContent_StaticRegisterNativesFDatasmithCameraFocusSettingsTemplate
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDatasmithCameraFocusSettingsTemplate_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FDatasmithCameraFocusSettingsTemplate_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FDatasmithCameraFocusSettingsTemplate_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FDatasmithCameraFocusSettingsTemplate_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FDatasmithCameraFocusSettingsTemplate_Hash() { return 1609660447U; }
...
static struct FScriptStruct_DatasmithContent_StaticRegisterNativesFDatasmithCameraLensSettingsTemplate
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDatasmithCameraLensSettingsTemplate_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FDatasmithCameraLensSettingsTemplate_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FDatasmithCameraLensSettingsTemplate_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FDatasmithCameraLensSettingsTemplate_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FDatasmithCameraLensSettingsTemplate_Hash() { return 1554881756U; }
...
static struct FScriptStruct_DatasmithContent_StaticRegisterNativesFDatasmithCameraFilmbackSettingsTemplate
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDatasmithCameraFilmbackSettingsTemplate_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FDatasmithCameraFilmbackSettingsTemplate_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FDatasmithCameraFilmbackSettingsTemplate_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FDatasmithCameraFilmbackSettingsTemplate_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FDatasmithCameraFilmbackSettingsTemplate_Hash() { return 2689618555U; }
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UDatasmithCineCameraComponentTemplate_Statics::NewProp_CurrentAperture = { "CurrentAperture", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDatasmithCineCameraComponentTemplate, CurrentAperture), METADATA_PARAMS(Z_Construct_UClass_UDatasmithCineCameraComponentTemplate_Statics::NewProp_CurrentAperture_MetaData, ARRAY_COUNT(Z_Construct_UClass_UDatasmithCineCameraComponentTemplate_Statics::NewProp_CurrentAperture_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UDatasmithCineCameraComponentTemplate_Statics::NewProp_CurrentFocalLength = { "CurrentFocalLength", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDatasmithCineCameraComponentTemplate, CurrentFocalLength), METADATA_PARAMS(Z_Construct_UClass_UDatasmithCineCameraComponentTemplate_Statics::NewProp_CurrentFocalLength_MetaData, ARRAY_COUNT(Z_Construct_UClass_UDatasmithCineCameraComponentTemplate_Statics::NewProp_CurrentFocalLength_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDatasmithCineCameraComponentTemplate_Statics::NewProp_LensSettings = { "LensSettings", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDatasmithCineCameraComponentTemplate, LensSettings), Z_Construct_UScriptStruct_FDatasmithCameraLensSettingsTemplate, METADATA_PARAMS(Z_Construct_UClass_UDatasmithCineCameraComponentTemplate_Statics::NewProp_LensSettings_MetaData, ARRAY_COUNT(Z_Construct_UClass_UDatasmithCineCameraComponentTemplate_Statics::NewProp_LensSettings_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UDatasmithCineCameraComponentTemplate_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UDatasmithCineCameraComponentTemplate_Statics::PropPointers),
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UDatasmithCineCameraComponentTemplate_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UDatasmithCineCameraComponentTemplate_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UDatasmithCineCameraComponentTemplate, 3406239084);
