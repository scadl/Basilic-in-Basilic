...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UDatasmithStaticMeshComponentTemplate_Statics::NewProp_OverrideMaterials = { "OverrideMaterials", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDatasmithStaticMeshComponentTemplate, OverrideMaterials), METADATA_PARAMS(Z_Construct_UClass_UDatasmithStaticMeshComponentTemplate_Statics::NewProp_OverrideMaterials_MetaData, ARRAY_COUNT(Z_Construct_UClass_UDatasmithStaticMeshComponentTemplate_Statics::NewProp_OverrideMaterials_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UDatasmithStaticMeshComponentTemplate_Statics::NewProp_StaticMesh = { "StaticMesh", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDatasmithStaticMeshComponentTemplate, StaticMesh), Z_Construct_UClass_UStaticMesh_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UDatasmithStaticMeshComponentTemplate_Statics::NewProp_StaticMesh_MetaData, ARRAY_COUNT(Z_Construct_UClass_UDatasmithStaticMeshComponentTemplate_Statics::NewProp_StaticMesh_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UDatasmithStaticMeshComponentTemplate_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UDatasmithStaticMeshComponentTemplate_Statics::PropPointers),
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UDatasmithStaticMeshComponentTemplate_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UDatasmithStaticMeshComponentTemplate_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UDatasmithStaticMeshComponentTemplate, 3219846325);
