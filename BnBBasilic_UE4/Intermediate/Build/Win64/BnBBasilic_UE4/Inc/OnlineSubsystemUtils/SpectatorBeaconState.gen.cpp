...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_OnlineSubsystemUtils_ESpectatorReservationResult_Hash() { return 3357518716U; }
...
static struct FScriptStruct_OnlineSubsystemUtils_StaticRegisterNativesFSpectatorReservation
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FSpectatorReservation_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FSpectatorReservation_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FSpectatorReservation_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FSpectatorReservation_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FSpectatorReservation_Hash() { return 717880019U; }
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_USpectatorBeaconState_Statics::NewProp_Reservations = { "Reservations", nullptr, (EPropertyFlags)0x0020080000002000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USpectatorBeaconState, Reservations), METADATA_PARAMS(Z_Construct_UClass_USpectatorBeaconState_Statics::NewProp_Reservations_MetaData, ARRAY_COUNT(Z_Construct_UClass_USpectatorBeaconState_Statics::NewProp_Reservations_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_USpectatorBeaconState_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_USpectatorBeaconState_Statics::PropPointers),
		0,
		0x001002ACu,
		METADATA_PARAMS(Z_Construct_UClass_USpectatorBeaconState_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_USpectatorBeaconState_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(USpectatorBeaconState, 1000870022);
