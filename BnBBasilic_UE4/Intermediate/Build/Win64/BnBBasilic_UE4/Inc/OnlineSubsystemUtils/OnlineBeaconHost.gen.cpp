...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AOnlineBeaconHost_Statics::NewProp_ClientActors = { "ClientActors", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AOnlineBeaconHost, ClientActors), METADATA_PARAMS(Z_Construct_UClass_AOnlineBeaconHost_Statics::NewProp_ClientActors_MetaData, ARRAY_COUNT(Z_Construct_UClass_AOnlineBeaconHost_Statics::NewProp_ClientActors_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AOnlineBeaconHost_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_AOnlineBeaconHost_Statics::PropPointers),
		0,
		0x009002ACu,
		METADATA_PARAMS(Z_Construct_UClass_AOnlineBeaconHost_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_AOnlineBeaconHost_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(AOnlineBeaconHost, 2238044631);
