...
static struct FScriptStruct_OnlineSubsystemUtils_StaticRegisterNativesFPlayerReservation
{
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FPlayerReservation_Statics::NewProp_ElapsedTime = { "ElapsedTime", nullptr, (EPropertyFlags)0x0010000000002000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPlayerReservation, ElapsedTime), METADATA_PARAMS(Z_Construct_UScriptStruct_FPlayerReservation_Statics::NewProp_ElapsedTime_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FPlayerReservation_Statics::NewProp_ElapsedTime_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FPlayerReservation_Statics::NewProp_Platform = { "Platform", nullptr, (EPropertyFlags)0x0010000000002000, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPlayerReservation, Platform), METADATA_PARAMS(Z_Construct_UScriptStruct_FPlayerReservation_Statics::NewProp_Platform_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FPlayerReservation_Statics::NewProp_Platform_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FPlayerReservation_Statics::NewProp_ValidationStr = { "ValidationStr", nullptr, (EPropertyFlags)0x0010000000002000, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPlayerReservation, ValidationStr), METADATA_PARAMS(Z_Construct_UScriptStruct_FPlayerReservation_Statics::NewProp_ValidationStr_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FPlayerReservation_Statics::NewProp_ValidationStr_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FPlayerReservation_Statics::NewProp_UniqueId = { "UniqueId", nullptr, (EPropertyFlags)0x0010000000002000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPlayerReservation, UniqueId), Z_Construct_UScriptStruct_FUniqueNetIdRepl, METADATA_PARAMS(Z_Construct_UScriptStruct_FPlayerReservation_Statics::NewProp_UniqueId_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FPlayerReservation_Statics::NewProp_UniqueId_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FPlayerReservation_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FPlayerReservation_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FPlayerReservation_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FPlayerReservation_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FPlayerReservation_Hash() { return 4254286092U; }
