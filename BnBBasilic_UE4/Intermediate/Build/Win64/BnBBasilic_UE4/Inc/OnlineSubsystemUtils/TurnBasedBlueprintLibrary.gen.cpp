...
// Cross Module References
	...
	ONLINESUBSYSTEMUTILS_API UFunction* Z_Construct_UFunction_UTurnBasedBlueprintLibrary_GetIsMyTurn();
	ENGINE_API UClass* Z_Construct_UClass_APlayerController_NoRegister();
	COREUOBJECT_API UClass* Z_Construct_UClass_UObject_NoRegister();
	ONLINESUBSYSTEMUTILS_API UFunction* Z_Construct_UFunction_UTurnBasedBlueprintLibrary_GetMyPlayerIndex();
	ONLINESUBSYSTEMUTILS_API UFunction* Z_Construct_UFunction_UTurnBasedBlueprintLibrary_GetPlayerDisplayName();
	ONLINESUBSYSTEMUTILS_API UFunction* Z_Construct_UFunction_UTurnBasedBlueprintLibrary_RegisterTurnBasedMatchInterfaceObject();
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UTurnBasedBlueprintLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UTurnBasedBlueprintLibrary_GetIsMyTurn, "GetIsMyTurn" }, // 3617033318
		{ &Z_Construct_UFunction_UTurnBasedBlueprintLibrary_GetMyPlayerIndex, "GetMyPlayerIndex" }, // 506254922
		{ &Z_Construct_UFunction_UTurnBasedBlueprintLibrary_GetPlayerDisplayName, "GetPlayerDisplayName" }, // 3899769945
		{ &Z_Construct_UFunction_UTurnBasedBlueprintLibrary_RegisterTurnBasedMatchInterfaceObject, "RegisterTurnBasedMatchInterfaceObject" }, // 315435166
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UTurnBasedBlueprintLibrary_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UTurnBasedBlueprintLibrary_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UTurnBasedBlueprintLibrary_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UTurnBasedBlueprintLibrary, 3371130554);
