...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UOnlineSessionClient_Statics::NewProp_bHandlingDisconnect = { "bHandlingDisconnect", nullptr, (EPropertyFlags)0x0020080000002000, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UOnlineSessionClient), &Z_Construct_UClass_UOnlineSessionClient_Statics::NewProp_bHandlingDisconnect_SetBit, METADATA_PARAMS(Z_Construct_UClass_UOnlineSessionClient_Statics::NewProp_bHandlingDisconnect_MetaData, ARRAY_COUNT(Z_Construct_UClass_UOnlineSessionClient_Statics::NewProp_bHandlingDisconnect_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UOnlineSessionClient_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UOnlineSessionClient_Statics::PropPointers),
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UOnlineSessionClient_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UOnlineSessionClient_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UOnlineSessionClient, 4288377619);
