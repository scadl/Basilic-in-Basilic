...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_APartyBeaconHost_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_APartyBeaconHost_Statics::PropPointers),
		0,
		0x009002ACu,
		METADATA_PARAMS(Z_Construct_UClass_APartyBeaconHost_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_APartyBeaconHost_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(APartyBeaconHost, 4036113935);
