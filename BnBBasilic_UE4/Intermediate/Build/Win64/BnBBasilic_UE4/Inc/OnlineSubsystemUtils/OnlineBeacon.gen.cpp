...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AOnlineBeacon_Statics::NewProp_NetDriver = { "NetDriver", nullptr, (EPropertyFlags)0x0020080000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AOnlineBeacon, NetDriver), Z_Construct_UClass_UNetDriver_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AOnlineBeacon_Statics::NewProp_NetDriver_MetaData, ARRAY_COUNT(Z_Construct_UClass_AOnlineBeacon_Statics::NewProp_NetDriver_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AOnlineBeacon_Statics::NewProp_BeaconConnectionTimeout = { "BeaconConnectionTimeout", nullptr, (EPropertyFlags)0x0020080000004000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AOnlineBeacon, BeaconConnectionTimeout), METADATA_PARAMS(Z_Construct_UClass_AOnlineBeacon_Statics::NewProp_BeaconConnectionTimeout_MetaData, ARRAY_COUNT(Z_Construct_UClass_AOnlineBeacon_Statics::NewProp_BeaconConnectionTimeout_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AOnlineBeacon_Statics::NewProp_BeaconConnectionInitialTimeout = { "BeaconConnectionInitialTimeout", nullptr, (EPropertyFlags)0x0020080000004000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AOnlineBeacon, BeaconConnectionInitialTimeout), METADATA_PARAMS(Z_Construct_UClass_AOnlineBeacon_Statics::NewProp_BeaconConnectionInitialTimeout_MetaData, ARRAY_COUNT(Z_Construct_UClass_AOnlineBeacon_Statics::NewProp_BeaconConnectionInitialTimeout_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AOnlineBeacon_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_AOnlineBeacon_Statics::PropPointers),
		0,
		0x009002ACu,
		METADATA_PARAMS(Z_Construct_UClass_AOnlineBeacon_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_AOnlineBeacon_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(AOnlineBeacon, 3809287422);
