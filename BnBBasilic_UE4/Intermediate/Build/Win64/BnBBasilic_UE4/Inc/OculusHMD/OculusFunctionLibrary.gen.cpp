...
// Cross Module References
	...
	OCULUSHMD_API UEnum* Z_Construct_UEnum_OculusHMD_ETiledMultiResLevel();
	...
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_AddLoadingSplashScreen();
	COREUOBJECT_API UScriptStruct* Z_Construct_UScriptStruct_FRotator();
	ENGINE_API UClass* Z_Construct_UClass_UTexture2D_NoRegister();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_ClearLoadingSplashScreens();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_EnableAutoLoadingSplashScreen();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_EnableOrientationTracking();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_EnablePositionTracking();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_GetAvailableDisplayFrequencies();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_GetBaseRotationAndBaseOffsetInMeters();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_GetBaseRotationAndPositionOffset();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_GetCurrentDisplayFrequency();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_GetDeviceName();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_GetGPUFrameTime();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_GetGPUUtilization();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_GetGuardianDimensions();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_GetGuardianPoints();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_GetLoadingSplashParams();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_GetNodeGuardianIntersection();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_GetPlayAreaTransform();
	COREUOBJECT_API UScriptStruct* Z_Construct_UScriptStruct_FTransform();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_GetPointGuardianIntersection();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_GetPose();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_GetRawSensorData();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_GetTiledMultiresLevel();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_GetUserProfile();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_HasInputFocus();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_HasSystemOverlayPresent();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_HideLoadingIcon();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_HideLoadingSplashScreen();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_IsAutoLoadingSplashScreenEnabled();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_IsDeviceTracked();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_IsGuardianConfigured();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_IsGuardianDisplayed();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_IsLoadingIconEnabled();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_SetBaseRotationAndBaseOffsetInMeters();
	HEADMOUNTEDDISPLAY_API UEnum* Z_Construct_UEnum_HeadMountedDisplay_EOrientPositionSelector();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_SetBaseRotationAndPositionOffset();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_SetColorScaleAndOffset();
	COREUOBJECT_API UScriptStruct* Z_Construct_UScriptStruct_FLinearColor();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_SetCPUAndGPULevels();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_SetDisplayFrequency();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_SetGuardianVisibility();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_SetLoadingSplashParams();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_SetPositionScale3D();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_SetReorientHMDOnControllerRecenter();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_SetTiledMultiresLevel();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_ShowLoadingIcon();
	OCULUSHMD_API UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_ShowLoadingSplashScreen();
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_OculusHMD_EBoundaryType_Hash() { return 3603244226U; }
	...
	static UEnum* ETiledMultiResLevel_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_OculusHMD_ETiledMultiResLevel, Z_Construct_UPackage__Script_OculusHMD(), TEXT("ETiledMultiResLevel"));
		}
		return Singleton;
	}
	template<> OCULUSHMD_API UEnum* StaticEnum<ETiledMultiResLevel>()
	{
		return ETiledMultiResLevel_StaticEnum();
	}
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ETiledMultiResLevel(ETiledMultiResLevel_StaticEnum, TEXT("/Script/OculusHMD"), TEXT("ETiledMultiResLevel"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_OculusHMD_ETiledMultiResLevel_Hash() { return 2026718905U; }
	UEnum* Z_Construct_UEnum_OculusHMD_ETiledMultiResLevel()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_OculusHMD();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("ETiledMultiResLevel"), 0, Get_Z_Construct_UEnum_OculusHMD_ETiledMultiResLevel_Hash(), false);
#else
		static UEnum* ReturnEnum = nullptr;
#endif // WITH_HOT_RELOAD
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				...
				{ "ETiledMultiResLevel::ETiledMultiResLevel_LMSHighTop", (int64)ETiledMultiResLevel::ETiledMultiResLevel_LMSHighTop },
			};
#if WITH_METADATA
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				{ "BlueprintType", "true" },
				{ "ETiledMultiResLevel_LMSHigh.Name", "ETiledMultiResLevel::ETiledMultiResLevel_LMSHigh" },
				{ "ETiledMultiResLevel_LMSHighTop.Comment", "// High foveation setting with more detail toward the bottom of the view and more foveation near the top (Same as High on Oculus Go)\n" },
				{ "ETiledMultiResLevel_LMSHighTop.Name", "ETiledMultiResLevel::ETiledMultiResLevel_LMSHighTop" },
				{ "ETiledMultiResLevel_LMSHighTop.ToolTip", "High foveation setting with more detail toward the bottom of the view and more foveation near the top (Same as High on Oculus Go)" },
				{ "ETiledMultiResLevel_LMSLow.Name", "ETiledMultiResLevel::ETiledMultiResLevel_LMSLow" },
				{ "ETiledMultiResLevel_LMSMedium.Name", "ETiledMultiResLevel::ETiledMultiResLevel_LMSMedium" },
				{ "ETiledMultiResLevel_Off.Name", "ETiledMultiResLevel::ETiledMultiResLevel_Off" },
				{ "ModuleRelativePath", "Public/OculusFunctionLibrary.h" },
			};
#endif
			static const UE4CodeGen_Private::FEnumParams EnumParams = {
	...
	uint32 Get_Z_Construct_UEnum_OculusHMD_ETrackedDeviceType_Hash() { return 2972671357U; }
...
static struct FScriptStruct_OculusHMD_StaticRegisterNativesFGuardianTestResult
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FGuardianTestResult_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FGuardianTestResult_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
	...
	uint32 Get_Z_Construct_UScriptStruct_FGuardianTestResult_Hash() { return 218895385U; }
...
static struct FScriptStruct_OculusHMD_StaticRegisterNativesFHmdUserProfile
{
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FHmdUserProfile_Statics::NewProp_ExtraFields = { "ExtraFields", nullptr, (EPropertyFlags)0x0010000000000004, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FHmdUserProfile, ExtraFields), METADATA_PARAMS(Z_Construct_UScriptStruct_FHmdUserProfile_Statics::NewProp_ExtraFields_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FHmdUserProfile_Statics::NewProp_ExtraFields_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FHmdUserProfile_Statics::NewProp_IPD = { "IPD", nullptr, (EPropertyFlags)0x0010000000000004, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FHmdUserProfile, IPD), METADATA_PARAMS(Z_Construct_UScriptStruct_FHmdUserProfile_Statics::NewProp_IPD_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FHmdUserProfile_Statics::NewProp_IPD_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FHmdUserProfile_Statics::NewProp_EyeHeight = { "EyeHeight", nullptr, (EPropertyFlags)0x0010000000000004, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FHmdUserProfile, EyeHeight), METADATA_PARAMS(Z_Construct_UScriptStruct_FHmdUserProfile_Statics::NewProp_EyeHeight_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FHmdUserProfile_Statics::NewProp_EyeHeight_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FHmdUserProfile_Statics::NewProp_PlayerHeight = { "PlayerHeight", nullptr, (EPropertyFlags)0x0010000000000004, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FHmdUserProfile, PlayerHeight), METADATA_PARAMS(Z_Construct_UScriptStruct_FHmdUserProfile_Statics::NewProp_PlayerHeight_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FHmdUserProfile_Statics::NewProp_PlayerHeight_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FHmdUserProfile_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000004, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FHmdUserProfile, Name), METADATA_PARAMS(Z_Construct_UScriptStruct_FHmdUserProfile_Statics::NewProp_Name_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FHmdUserProfile_Statics::NewProp_Name_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FHmdUserProfile_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FHmdUserProfile_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
	...
	uint32 Get_Z_Construct_UScriptStruct_FHmdUserProfile_Hash() { return 2029860090U; }
...
static struct FScriptStruct_OculusHMD_StaticRegisterNativesFHmdUserProfileField
{
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FHmdUserProfileField_Statics::NewProp_FieldName = { "FieldName", nullptr, (EPropertyFlags)0x0010000000000004, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FHmdUserProfileField, FieldName), METADATA_PARAMS(Z_Construct_UScriptStruct_FHmdUserProfileField_Statics::NewProp_FieldName_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FHmdUserProfileField_Statics::NewProp_FieldName_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FHmdUserProfileField_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FHmdUserProfileField_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
	...
	uint32 Get_Z_Construct_UScriptStruct_FHmdUserProfileField_Hash() { return 2940557682U; }
	void UOculusFunctionLibrary::StaticRegisterNativesUOculusFunctionLibrary()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "GetTiledMultiresLevel", &UOculusFunctionLibrary::execGetTiledMultiresLevel },
			...
			{ "SetTiledMultiresLevel", &UOculusFunctionLibrary::execSetTiledMultiresLevel },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UOculusFunctionLibrary_EnablePositionTracking_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOculusFunctionLibrary, nullptr, "EnablePositionTracking", nullptr, nullptr, sizeof(OculusFunctionLibrary_eventEnablePositionTracking_Parms), Z_Construct_UFunction_UOculusFunctionLibrary_EnablePositionTracking_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_EnablePositionTracking_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UOculusFunctionLibrary_EnablePositionTracking_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_EnablePositionTracking_Statics::Function_MetaDataParams)) };
	...
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UOculusFunctionLibrary_GetAvailableDisplayFrequencies_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(OculusFunctionLibrary_eventGetAvailableDisplayFrequencies_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UOculusFunctionLibrary_GetBaseRotationAndBaseOffsetInMeters_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOculusFunctionLibrary, nullptr, "GetBaseRotationAndBaseOffsetInMeters", nullptr, nullptr, sizeof(OculusFunctionLibrary_eventGetBaseRotationAndBaseOffsetInMeters_Parms), Z_Construct_UFunction_UOculusFunctionLibrary_GetBaseRotationAndBaseOffsetInMeters_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_GetBaseRotationAndBaseOffsetInMeters_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14C22401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UOculusFunctionLibrary_GetBaseRotationAndBaseOffsetInMeters_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_GetBaseRotationAndBaseOffsetInMeters_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UOculusFunctionLibrary_GetBaseRotationAndPositionOffset_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOculusFunctionLibrary, nullptr, "GetBaseRotationAndPositionOffset", nullptr, nullptr, sizeof(OculusFunctionLibrary_eventGetBaseRotationAndPositionOffset_Parms), Z_Construct_UFunction_UOculusFunctionLibrary_GetBaseRotationAndPositionOffset_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_GetBaseRotationAndPositionOffset_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04C22401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UOculusFunctionLibrary_GetBaseRotationAndPositionOffset_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_GetBaseRotationAndPositionOffset_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UOculusFunctionLibrary_GetCurrentDisplayFrequency_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOculusFunctionLibrary, nullptr, "GetCurrentDisplayFrequency", nullptr, nullptr, sizeof(OculusFunctionLibrary_eventGetCurrentDisplayFrequency_Parms), Z_Construct_UFunction_UOculusFunctionLibrary_GetCurrentDisplayFrequency_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_GetCurrentDisplayFrequency_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UOculusFunctionLibrary_GetCurrentDisplayFrequency_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_GetCurrentDisplayFrequency_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UOculusFunctionLibrary_GetGPUFrameTime_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOculusFunctionLibrary, nullptr, "GetGPUFrameTime", nullptr, nullptr, sizeof(OculusFunctionLibrary_eventGetGPUFrameTime_Parms), Z_Construct_UFunction_UOculusFunctionLibrary_GetGPUFrameTime_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_GetGPUFrameTime_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UOculusFunctionLibrary_GetGPUFrameTime_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_GetGPUFrameTime_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UOculusFunctionLibrary_GetGuardianPoints_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOculusFunctionLibrary, nullptr, "GetGuardianPoints", nullptr, nullptr, sizeof(OculusFunctionLibrary_eventGetGuardianPoints_Parms), Z_Construct_UFunction_UOculusFunctionLibrary_GetGuardianPoints_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_GetGuardianPoints_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UOculusFunctionLibrary_GetGuardianPoints_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_GetGuardianPoints_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UOculusFunctionLibrary_GetNodeGuardianIntersection_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOculusFunctionLibrary, nullptr, "GetNodeGuardianIntersection", nullptr, nullptr, sizeof(OculusFunctionLibrary_eventGetNodeGuardianIntersection_Parms), Z_Construct_UFunction_UOculusFunctionLibrary_GetNodeGuardianIntersection_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_GetNodeGuardianIntersection_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UOculusFunctionLibrary_GetNodeGuardianIntersection_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_GetNodeGuardianIntersection_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UOculusFunctionLibrary_GetPose_Statics::NewProp_PositionScale = { "PositionScale", nullptr, (EPropertyFlags)0x0010000000000082, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(OculusFunctionLibrary_eventGetPose_Parms, PositionScale), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UFunction_UOculusFunctionLibrary_GetPose_Statics::NewProp_PositionScale_MetaData, ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_GetPose_Statics::NewProp_PositionScale_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UOculusFunctionLibrary_GetRawSensorData_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOculusFunctionLibrary, nullptr, "GetRawSensorData", nullptr, nullptr, sizeof(OculusFunctionLibrary_eventGetRawSensorData_Parms), Z_Construct_UFunction_UOculusFunctionLibrary_GetRawSensorData_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_GetRawSensorData_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14C22401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UOculusFunctionLibrary_GetRawSensorData_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_GetRawSensorData_Statics::Function_MetaDataParams)) };
	...
	struct Z_Construct_UFunction_UOculusFunctionLibrary_GetTiledMultiresLevel_Statics
	{
		struct OculusFunctionLibrary_eventGetTiledMultiresLevel_Parms
		{
	...
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UOculusFunctionLibrary_GetTiledMultiresLevel_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(OculusFunctionLibrary_eventGetTiledMultiresLevel_Parms, ReturnValue), Z_Construct_UEnum_OculusHMD_ETiledMultiResLevel, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UOculusFunctionLibrary_GetTiledMultiresLevel_Statics::NewProp_ReturnValue_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UOculusFunctionLibrary_GetTiledMultiresLevel_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UOculusFunctionLibrary_GetTiledMultiresLevel_Statics::NewProp_ReturnValue,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UOculusFunctionLibrary_GetTiledMultiresLevel_Statics::NewProp_ReturnValue_Underlying,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UOculusFunctionLibrary_GetTiledMultiresLevel_Statics::Function_MetaDataParams[] = {
		{ "Category", "OculusLibrary" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UOculusFunctionLibrary_GetTiledMultiresLevel_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOculusFunctionLibrary, nullptr, "GetTiledMultiresLevel", nullptr, nullptr, sizeof(OculusFunctionLibrary_eventGetTiledMultiresLevel_Parms), Z_Construct_UFunction_UOculusFunctionLibrary_GetTiledMultiresLevel_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_GetTiledMultiresLevel_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UOculusFunctionLibrary_GetTiledMultiresLevel_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_GetTiledMultiresLevel_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_GetTiledMultiresLevel()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UOculusFunctionLibrary_GetTiledMultiresLevel_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UOculusFunctionLibrary_IsGuardianDisplayed_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOculusFunctionLibrary, nullptr, "IsGuardianDisplayed", nullptr, nullptr, sizeof(OculusFunctionLibrary_eventIsGuardianDisplayed_Parms), Z_Construct_UFunction_UOculusFunctionLibrary_IsGuardianDisplayed_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_IsGuardianDisplayed_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UOculusFunctionLibrary_IsGuardianDisplayed_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_IsGuardianDisplayed_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UOculusFunctionLibrary_IsLoadingIconEnabled_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOculusFunctionLibrary, nullptr, "IsLoadingIconEnabled", nullptr, nullptr, sizeof(OculusFunctionLibrary_eventIsLoadingIconEnabled_Parms), Z_Construct_UFunction_UOculusFunctionLibrary_IsLoadingIconEnabled_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_IsLoadingIconEnabled_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UOculusFunctionLibrary_IsLoadingIconEnabled_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_IsLoadingIconEnabled_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UOculusFunctionLibrary_SetPositionScale3D_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOculusFunctionLibrary, nullptr, "SetPositionScale3D", nullptr, nullptr, sizeof(OculusFunctionLibrary_eventSetPositionScale3D_Parms), Z_Construct_UFunction_UOculusFunctionLibrary_SetPositionScale3D_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_SetPositionScale3D_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04822401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UOculusFunctionLibrary_SetPositionScale3D_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_SetPositionScale3D_Statics::Function_MetaDataParams)) };
	...
	struct Z_Construct_UFunction_UOculusFunctionLibrary_SetTiledMultiresLevel_Statics
	{
		struct OculusFunctionLibrary_eventSetTiledMultiresLevel_Parms
		{
	...
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UOculusFunctionLibrary_SetTiledMultiresLevel_Statics::NewProp_level = { "level", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(OculusFunctionLibrary_eventSetTiledMultiresLevel_Parms, level), Z_Construct_UEnum_OculusHMD_ETiledMultiResLevel, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UOculusFunctionLibrary_SetTiledMultiresLevel_Statics::NewProp_level_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UOculusFunctionLibrary_SetTiledMultiresLevel_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UOculusFunctionLibrary_SetTiledMultiresLevel_Statics::NewProp_level,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UOculusFunctionLibrary_SetTiledMultiresLevel_Statics::NewProp_level_Underlying,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UOculusFunctionLibrary_SetTiledMultiresLevel_Statics::Function_MetaDataParams[] = {
		{ "Category", "OculusLibrary" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UOculusFunctionLibrary_SetTiledMultiresLevel_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOculusFunctionLibrary, nullptr, "SetTiledMultiresLevel", nullptr, nullptr, sizeof(OculusFunctionLibrary_eventSetTiledMultiresLevel_Parms), Z_Construct_UFunction_UOculusFunctionLibrary_SetTiledMultiresLevel_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_SetTiledMultiresLevel_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UOculusFunctionLibrary_SetTiledMultiresLevel_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_SetTiledMultiresLevel_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_SetTiledMultiresLevel()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UOculusFunctionLibrary_SetTiledMultiresLevel_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UOculusFunctionLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_AddLoadingSplashScreen, "AddLoadingSplashScreen" }, // 2744896852
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_ClearLoadingSplashScreens, "ClearLoadingSplashScreens" }, // 2577998921
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_EnableAutoLoadingSplashScreen, "EnableAutoLoadingSplashScreen" }, // 1774313459
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_EnableOrientationTracking, "EnableOrientationTracking" }, // 2460652126
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_EnablePositionTracking, "EnablePositionTracking" }, // 3963536022
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetAvailableDisplayFrequencies, "GetAvailableDisplayFrequencies" }, // 4190983677
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetBaseRotationAndBaseOffsetInMeters, "GetBaseRotationAndBaseOffsetInMeters" }, // 3757146261
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetBaseRotationAndPositionOffset, "GetBaseRotationAndPositionOffset" }, // 2101901760
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetCurrentDisplayFrequency, "GetCurrentDisplayFrequency" }, // 2332913219
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetDeviceName, "GetDeviceName" }, // 2769642125
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetGPUFrameTime, "GetGPUFrameTime" }, // 145066640
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetGPUUtilization, "GetGPUUtilization" }, // 4225683865
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetGuardianDimensions, "GetGuardianDimensions" }, // 3352569051
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetGuardianPoints, "GetGuardianPoints" }, // 2962947341
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetLoadingSplashParams, "GetLoadingSplashParams" }, // 1908509813
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetNodeGuardianIntersection, "GetNodeGuardianIntersection" }, // 2420445774
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetPlayAreaTransform, "GetPlayAreaTransform" }, // 3075459300
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetPointGuardianIntersection, "GetPointGuardianIntersection" }, // 4073221237
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetPose, "GetPose" }, // 301375495
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetRawSensorData, "GetRawSensorData" }, // 2891134438
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetTiledMultiresLevel, "GetTiledMultiresLevel" }, // 819033256
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetUserProfile, "GetUserProfile" }, // 655232079
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_HasInputFocus, "HasInputFocus" }, // 2510205765
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_HasSystemOverlayPresent, "HasSystemOverlayPresent" }, // 803994124
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_HideLoadingIcon, "HideLoadingIcon" }, // 1676931583
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_HideLoadingSplashScreen, "HideLoadingSplashScreen" }, // 3068726623
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_IsAutoLoadingSplashScreenEnabled, "IsAutoLoadingSplashScreenEnabled" }, // 1711391007
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_IsDeviceTracked, "IsDeviceTracked" }, // 3514833982
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_IsGuardianConfigured, "IsGuardianConfigured" }, // 372716105
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_IsGuardianDisplayed, "IsGuardianDisplayed" }, // 3600043147
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_IsLoadingIconEnabled, "IsLoadingIconEnabled" }, // 4034207360
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_SetBaseRotationAndBaseOffsetInMeters, "SetBaseRotationAndBaseOffsetInMeters" }, // 660867797
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_SetBaseRotationAndPositionOffset, "SetBaseRotationAndPositionOffset" }, // 4267691520
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_SetColorScaleAndOffset, "SetColorScaleAndOffset" }, // 619836032
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_SetCPUAndGPULevels, "SetCPUAndGPULevels" }, // 2633013684
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_SetDisplayFrequency, "SetDisplayFrequency" }, // 3972604411
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_SetGuardianVisibility, "SetGuardianVisibility" }, // 2193113316
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_SetLoadingSplashParams, "SetLoadingSplashParams" }, // 186339813
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_SetPositionScale3D, "SetPositionScale3D" }, // 2172867453
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_SetReorientHMDOnControllerRecenter, "SetReorientHMDOnControllerRecenter" }, // 240758465
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_SetTiledMultiresLevel, "SetTiledMultiresLevel" }, // 2675131680
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_ShowLoadingIcon, "ShowLoadingIcon" }, // 548625975
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_ShowLoadingSplashScreen, "ShowLoadingSplashScreen" }, // 3451886261
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UOculusFunctionLibrary_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UOculusFunctionLibrary_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UOculusFunctionLibrary_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UOculusFunctionLibrary, 151869041);
