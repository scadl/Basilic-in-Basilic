...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UOculusSceneCaptureCubemap_Statics::NewProp_CaptureComponents = { "CaptureComponents", nullptr, (EPropertyFlags)0x0040008000000008, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UOculusSceneCaptureCubemap, CaptureComponents), METADATA_PARAMS(Z_Construct_UClass_UOculusSceneCaptureCubemap_Statics::NewProp_CaptureComponents_MetaData, ARRAY_COUNT(Z_Construct_UClass_UOculusSceneCaptureCubemap_Statics::NewProp_CaptureComponents_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UOculusSceneCaptureCubemap_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UOculusSceneCaptureCubemap_Statics::PropPointers),
		0,
		0x008000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UOculusSceneCaptureCubemap_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UOculusSceneCaptureCubemap_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UOculusSceneCaptureCubemap, 3714402583);
