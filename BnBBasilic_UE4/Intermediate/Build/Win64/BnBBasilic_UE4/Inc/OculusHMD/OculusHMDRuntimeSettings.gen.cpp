...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UOculusHMDRuntimeSettings_Statics::NewProp_bChromaCorrection = { "bChromaCorrection", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UOculusHMDRuntimeSettings), &Z_Construct_UClass_UOculusHMDRuntimeSettings_Statics::NewProp_bChromaCorrection_SetBit, METADATA_PARAMS(Z_Construct_UClass_UOculusHMDRuntimeSettings_Statics::NewProp_bChromaCorrection_MetaData, ARRAY_COUNT(Z_Construct_UClass_UOculusHMDRuntimeSettings_Statics::NewProp_bChromaCorrection_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UOculusHMDRuntimeSettings_Statics::NewProp_FFRLevel_MetaData[] = {
		{ "Category", "Mobile" },
		{ "Comment", "/** Default Fixed Foveated Rendering level for Oculus Go! */" },
		{ "ModuleRelativePath", "Public/OculusHMDRuntimeSettings.h" },
		{ "ToolTip", "Default Fixed Foveated Rendering level for Oculus Go!" },
	};
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UOculusHMDRuntimeSettings_Statics::NewProp_FFRLevel = { "FFRLevel", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UOculusHMDRuntimeSettings, FFRLevel), Z_Construct_UEnum_OculusHMD_ETiledMultiResLevel, METADATA_PARAMS(Z_Construct_UClass_UOculusHMDRuntimeSettings_Statics::NewProp_FFRLevel_MetaData, ARRAY_COUNT(Z_Construct_UClass_UOculusHMDRuntimeSettings_Statics::NewProp_FFRLevel_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UClass_UOculusHMDRuntimeSettings_Statics::NewProp_GPULevel = { "GPULevel", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UOculusHMDRuntimeSettings, GPULevel), METADATA_PARAMS(Z_Construct_UClass_UOculusHMDRuntimeSettings_Statics::NewProp_GPULevel_MetaData, ARRAY_COUNT(Z_Construct_UClass_UOculusHMDRuntimeSettings_Statics::NewProp_GPULevel_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UClass_UOculusHMDRuntimeSettings_Statics::NewProp_CPULevel = { "CPULevel", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UOculusHMDRuntimeSettings, CPULevel), METADATA_PARAMS(Z_Construct_UClass_UOculusHMDRuntimeSettings_Statics::NewProp_CPULevel_MetaData, ARRAY_COUNT(Z_Construct_UClass_UOculusHMDRuntimeSettings_Statics::NewProp_CPULevel_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UOculusHMDRuntimeSettings_Statics::NewProp_PixelDensityMin = { "PixelDensityMin", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UOculusHMDRuntimeSettings, PixelDensityMin), METADATA_PARAMS(Z_Construct_UClass_UOculusHMDRuntimeSettings_Statics::NewProp_PixelDensityMin_MetaData, ARRAY_COUNT(Z_Construct_UClass_UOculusHMDRuntimeSettings_Statics::NewProp_PixelDensityMin_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UOculusHMDRuntimeSettings_Statics::NewProp_SplashDescs = { "SplashDescs", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UOculusHMDRuntimeSettings, SplashDescs), METADATA_PARAMS(Z_Construct_UClass_UOculusHMDRuntimeSettings_Statics::NewProp_SplashDescs_MetaData, ARRAY_COUNT(Z_Construct_UClass_UOculusHMDRuntimeSettings_Statics::NewProp_SplashDescs_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UOculusHMDRuntimeSettings_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UOculusHMDRuntimeSettings_Statics::PropPointers),
		0,
		0x001000A6u,
		METADATA_PARAMS(Z_Construct_UClass_UOculusHMDRuntimeSettings_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UOculusHMDRuntimeSettings_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UOculusHMDRuntimeSettings, 1711976943);
