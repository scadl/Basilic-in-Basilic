...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UArchVisCharMovementComponent_Statics::NewProp_WalkingAcceleration = { "WalkingAcceleration", nullptr, (EPropertyFlags)0x0010000000010015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UArchVisCharMovementComponent, WalkingAcceleration), METADATA_PARAMS(Z_Construct_UClass_UArchVisCharMovementComponent_Statics::NewProp_WalkingAcceleration_MetaData, ARRAY_COUNT(Z_Construct_UClass_UArchVisCharMovementComponent_Statics::NewProp_WalkingAcceleration_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UArchVisCharMovementComponent_Statics::NewProp_WalkingSpeed = { "WalkingSpeed", nullptr, (EPropertyFlags)0x0010000000010015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UArchVisCharMovementComponent, WalkingSpeed), METADATA_PARAMS(Z_Construct_UClass_UArchVisCharMovementComponent_Statics::NewProp_WalkingSpeed_MetaData, ARRAY_COUNT(Z_Construct_UClass_UArchVisCharMovementComponent_Statics::NewProp_WalkingSpeed_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UArchVisCharMovementComponent_Statics::NewProp_MaxPitch = { "MaxPitch", nullptr, (EPropertyFlags)0x0010000000010015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UArchVisCharMovementComponent, MaxPitch), METADATA_PARAMS(Z_Construct_UClass_UArchVisCharMovementComponent_Statics::NewProp_MaxPitch_MetaData, ARRAY_COUNT(Z_Construct_UClass_UArchVisCharMovementComponent_Statics::NewProp_MaxPitch_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UArchVisCharMovementComponent_Statics::NewProp_RotationalAcceleration = { "RotationalAcceleration", nullptr, (EPropertyFlags)0x0010000000010015, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UArchVisCharMovementComponent, RotationalAcceleration), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(Z_Construct_UClass_UArchVisCharMovementComponent_Statics::NewProp_RotationalAcceleration_MetaData, ARRAY_COUNT(Z_Construct_UClass_UArchVisCharMovementComponent_Statics::NewProp_RotationalAcceleration_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UArchVisCharMovementComponent_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UArchVisCharMovementComponent_Statics::PropPointers),
		0,
		0x00B000A4u,
		METADATA_PARAMS(Z_Construct_UClass_UArchVisCharMovementComponent_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UArchVisCharMovementComponent_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UArchVisCharMovementComponent, 4172582003);
