...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_USignificanceManager_Statics::NewProp_SignificanceManagerClassName = { "SignificanceManagerClassName", nullptr, (EPropertyFlags)0x0040000002044001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USignificanceManager, SignificanceManagerClassName), Z_Construct_UScriptStruct_FSoftClassPath, METADATA_PARAMS(Z_Construct_UClass_USignificanceManager_Statics::NewProp_SignificanceManagerClassName_MetaData, ARRAY_COUNT(Z_Construct_UClass_USignificanceManager_Statics::NewProp_SignificanceManagerClassName_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_USignificanceManager_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_USignificanceManager_Statics::PropPointers),
		0,
		0x001000A6u,
		METADATA_PARAMS(Z_Construct_UClass_USignificanceManager_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_USignificanceManager_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(USignificanceManager, 1528109845);
