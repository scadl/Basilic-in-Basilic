...
static struct FScriptStruct_MovieSceneTracks_StaticRegisterNativesFMovieSceneEvent
{
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMovieSceneEvent_Statics::NewProp_GraphGuid_MetaData[] = {
		{ "Comment", "/** The UEdGraph::GraphGuid property that relates to the function entry to call. */" },
		{ "ModuleRelativePath", "Public/Channels/MovieSceneEvent.h" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMovieSceneEvent_Statics::NewProp_SoftBlueprintPath_MetaData[] = {
		{ "Comment", "/** Serialized soft pointer to the blueprint that contains the function graph endpoint for this event. Stored as a soft path so that renames of the blueprint don't break this event binding. */" },
		{ "ModuleRelativePath", "Public/Channels/MovieSceneEvent.h" },
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FMovieSceneEvent_Statics::NewProp_FunctionName = { "FunctionName", nullptr, (EPropertyFlags)0x0010000000010001, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneEvent, FunctionName), METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneEvent_Statics::NewProp_FunctionName_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneEvent_Statics::NewProp_FunctionName_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneEvent_Hash() { return 3611646190U; }
