...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Paper2D_ETileMapProjectionMode_Hash() { return 3408868858U; }
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UPaperTileMap_Statics::NewProp_TileLayers = { "TileLayers", nullptr, (EPropertyFlags)0x001000800000001d, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPaperTileMap, TileLayers), METADATA_PARAMS(Z_Construct_UClass_UPaperTileMap_Statics::NewProp_TileLayers_MetaData, ARRAY_COUNT(Z_Construct_UClass_UPaperTileMap_Statics::NewProp_TileLayers_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UPaperTileMap_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UPaperTileMap_Statics::PropPointers),
		0,
		0x009000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UPaperTileMap_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UPaperTileMap_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UPaperTileMap, 3359527780);
