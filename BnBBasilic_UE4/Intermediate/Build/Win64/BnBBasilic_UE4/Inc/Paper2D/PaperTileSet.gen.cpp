...
static struct FScriptStruct_Paper2D_StaticRegisterNativesFPaperTileSetTerrain
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FPaperTileSetTerrain_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FPaperTileSetTerrain_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FPaperTileSetTerrain_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FPaperTileSetTerrain_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FPaperTileSetTerrain_Hash() { return 2453088089U; }
...
static struct FScriptStruct_Paper2D_StaticRegisterNativesFPaperTileMetadata
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FPaperTileMetadata_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FPaperTileMetadata_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FPaperTileMetadata_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FPaperTileMetadata_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FPaperTileMetadata_Hash() { return 3216768617U; }
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UPaperTileSet_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UPaperTileSet_Statics::PropPointers),
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UPaperTileSet_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UPaperTileSet_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UPaperTileSet, 2100109597);
