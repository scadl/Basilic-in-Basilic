...
static struct FScriptStruct_GeometryCacheTracks_StaticRegisterNativesFMovieSceneGeometryCacheSectionTemplate
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMovieSceneGeometryCacheSectionTemplate_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneGeometryCacheSectionTemplate_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000005),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneGeometryCacheSectionTemplate_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneGeometryCacheSectionTemplate_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneGeometryCacheSectionTemplate_Hash() { return 3707429220U; }
...
static struct FScriptStruct_GeometryCacheTracks_StaticRegisterNativesFMovieSceneGeometryCacheSectionTemplateParameters
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMovieSceneGeometryCacheSectionTemplateParameters_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneGeometryCacheSectionTemplateParameters_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneGeometryCacheSectionTemplateParameters_Statics::Struct_MetaDataParams, ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneGeometryCacheSectionTemplateParameters_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneGeometryCacheSectionTemplateParameters_Hash() { return 3975127322U; }
