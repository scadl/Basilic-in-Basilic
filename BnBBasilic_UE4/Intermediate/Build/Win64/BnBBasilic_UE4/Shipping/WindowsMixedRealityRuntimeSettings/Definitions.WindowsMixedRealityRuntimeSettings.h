#undef WINDOWSMIXEDREALITYRUNTIMESETTINGS_API
#undef WINDOWSMIXEDREALITYRUNTIMESETTINGS_VTABLE
#define IS_PROGRAM 0
#define UE_GAME 1
...
#define WINDOWSMIXEDREALITYRUNTIMESETTINGS_VTABLE 
#define WINDOWSMIXEDREALITYRUNTIMESETTINGS_API 
